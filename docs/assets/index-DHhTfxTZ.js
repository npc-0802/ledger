(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const $=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let f=[],w=null;function de(e){w=e}function pe(e){f.length=0,e.forEach(t=>f.push(t))}const yt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[0,"Unwatchable"]];function F(e){if(e>=90&&e===Math.max(...f.map(t=>t.total)))return"No better exists";for(const[t,o]of yt)if(e>=t)return o;return"Unwatchable"}function W(e){let t=0,o=0;for(const i of $)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function ie(){f.forEach(e=>{e.total=W(e.scores)})}function O(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function ne(){if(!w||!w.weights)return;const e=w.weights;$.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),ie()}let A={key:"total",dir:"desc"},ke="grid";const vt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function gt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function ht(){const{key:e,dir:t}=A;return e==="rank"||e==="total"?[...f].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...f].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...f].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function je(e){ke=e,j()}function Pe(e){A.key===e?A.dir=A.dir==="desc"?"asc":"desc":(A.key=e,A.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=A.dir==="desc"?"↓":"↑")}j()}function j(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(f.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=f.length+" films ranked";const i=ht();ke==="grid"?xt(i,e,o,t):bt(i,e,o,t)}function Oe(e){const t=A.key;return`<div class="rankings-toolbar">
    ${ke==="grid"?`
    <div class="sort-pills">
      ${vt.map(i=>`<button class="sort-pill${t===i.key?" active":""}" onclick="sortBy('${i.key}')">${i.label}</button>`).join("")}
    </div>`:"<div></div>"}
  ...
  </div>`}function xt(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Oe("grid"));const n=["total","rank","title"].includes(A.key)?"total":A.key;t.innerHTML=`<div class="film-grid">
    ${e.map((s,a)=>{const l=n==="total"?s.total:s.scores?.[n]??null,p=l!=null?n==="total"?(Math.round(l*10)/10).toFixed(1):l:"—",m=gt(l),r=s.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${s.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${f.indexOf(s)})">
  ...
  </div>`}function bt(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Oe("table"));const n=[...f].sort((a,l)=>l.total-a.total),s=new Map(n.map((a,l)=>[a.title,l+1]));t.innerHTML=e.map(a=>{const l=a.scores,p=s.get(a.title),m=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",r=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${f.indexOf(a)})">
      ...
      ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(d=>`<div class="film-score ${l[d]?O(l[d]):""}">${l[d]??"—"}</div>`).join("")}
      <div class="film-total">${m}</div>
    </div>`}).join("")}const wt=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:j,setViewMode:je,sortBy:Pe},Symbol.toStringTag,{value:"Module"})),$t="modulepreload",kt=function(e){return"/"+e},Te={},T=function(t,o,i){let n=Promise.resolve();if(o&&o.length>0){let m=function(r){return Promise.all(r.map(d=>Promise.resolve(d).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};var a=m;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),p=l?.nonce||l?.getAttribute("nonce");n=m(o.map(r=>{if(r=kt(r),r in Te)return;Te[r]=!0;const d=r.endsWith(".css"),x=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${x}`))return;const v=document.createElement("link");if(v.rel=d?"stylesheet":$t,d||(v.as="script"),v.crossOrigin="",v.href=r,p&&v.setAttribute("nonce",p),document.head.appendChild(v),d)return new Promise((k,S)=>{v.addEventListener("load",k),v.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${r}`)))})}))}function s(l){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=l,window.dispatchEvent(p),!p.defaultPrevented)throw l}return n.then(l=>{for(const p of l||[])p.status==="rejected"&&s(p.reason);return t().catch(s)})},qe="filmRankings_v1";function U(){try{localStorage.setItem(qe,JSON.stringify(f))}catch(e){console.warn("localStorage save failed:",e)}w&&(clearTimeout(U._syncTimer),U._syncTimer=setTimeout(()=>{T(()=>Promise.resolve().then(()=>He),void 0).then(e=>e.syncToSupabase())},2e3))}function Mt(){try{const e=localStorage.getItem(qe);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;pe(t),console.log(`Loaded ${f.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const Et="https://gzuuhjjedrzeqbgxhfip.supabase.co",St="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",me=window.supabase.createClient(Et,St);async function Me(){const e=w;if(!e)return;const{setCloudStatus:t}=await T(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>Q);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await me.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:f,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),se()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function Re(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await T(async()=>{const{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:l}=await Promise.resolve().then(()=>Q);return{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:l}},void 0),{renderRankings:n}=await T(async()=>{const{renderRankings:s}=await Promise.resolve().then(()=>wt);return{renderRankings:s}},void 0);t("syncing");try{const{data:s,error:a}=await me.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;s&&(de({id:s.id,username:s.username,display_name:s.display_name,archetype:s.archetype,archetype_secondary:s.archetype_secondary,weights:s.weights,harmony_sensitivity:s.harmony_sensitivity}),s.movies&&Array.isArray(s.movies)&&s.movies.length>=f.length&&pe(s.movies),se(),ne(),t("synced"),o(),n(),i())}catch(s){console.warn("Supabase load error:",s),t("error")}}function se(){try{localStorage.setItem("ledger_user",JSON.stringify(w))}catch{}}function Ne(){try{const e=localStorage.getItem("ledger_user");e&&de(JSON.parse(e))}catch{}}const He=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:Re,loadUserLocally:Ne,saveUserLocally:se,sb:me,syncToSupabase:Me},Symbol.toStringTag,{value:"Module"})),It=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function ge(e){for(const[t,o]of It)if(e>=t)return o;return"Unwatchable"}let fe=null,P=!1,L={};function Dt(e){fe=e,P=!1,L={},ue()}function ue(){const e=fe,t=f[e],o=[...f].sort((c,u)=>u.total-c.total),i=o.indexOf(t)+1,n=o.filter(c=>c!==t&&Math.abs(c.total-t.total)<6).slice(0,5),s={};$.forEach(c=>{const u=[...f].sort((g,h)=>(h.scores[c.key]||0)-(g.scores[c.key]||0));s[c.key]=u.indexOf(t)+1});const a=(c,u,g)=>`<span class="modal-meta-chip" onclick="exploreEntity('${u}','${g.replace(/'/g,"'")}')">${c}</span>`;function l(c){const u=[];let g=0;for(;g<c.length;)!c[g].includes(" ")&&c[g+1]&&!c[g+1].includes(" ")?(u.push(c[g]+" "+c[g+1]),g+=2):(u.push(c[g]),g++);return u}const p=(t.director||"").split(",").map(c=>c.trim()).filter(Boolean).map(c=>a(c,"director",c)).join(""),m=(t.writer||"").split(",").map(c=>c.trim()).filter(Boolean).map(c=>a(c,"writer",c)).join(""),r=l((t.cast||"").split(",").map(c=>c.trim()).filter(Boolean)).map(c=>a(c,"actor",c)).join(""),d=(t.productionCompanies||"").split(",").map(c=>c.trim()).filter(Boolean).map(c=>a(c,"company",c)).join(""),x=t.poster?`<div style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,v=P?L:t.scores,k=P?W(L):t.total,S=$.map(c=>{const u=v[c.key],g=s[c.key];return P?`<div class="breakdown-row" style="align-items:center;gap:12px">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${O(u||50)}" id="modal-edit-val-${c.key}">${u||50}</div>
          <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${c.key}">${ge(u||50)}</div>
        </div>
      ...
      <div class="breakdown-val ${u?O(u):""}">${u??"—"}</div>
      <div class="breakdown-wt">×${c.weight}</div>
    ...
    <div style="margin-bottom:20px">
      ${P?`<button onclick="modalSaveScores()" style="font-family:'DM Mono',monospace;font-size:11px;letter-spacing:1px;background:var(--blue);color:white;border:none;padding:8px 18px;cursor:pointer;margin-right:8px">Save scores</button>
    ...
    <div>${S}</div>
    ${!P&&n.length>0?`<div class="compare-section">
  ...
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e)}window.modalEnterEdit=function(){const e=f[fe];P=!0,L={...e.scores},ue()};window.modalCancelEdit=function(){P=!1,L={},ue()};window.modalUpdateScore=function(e,t){L[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${O(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=ge(parseInt(t)));const n=W(L),s=document.getElementById("modal-total-display");s&&(s.textContent=n);const a=document.getElementById("modal-total-label");a&&(a.textContent=ge(n))};window.modalSaveScores=function(){const e=f[fe];e.scores={...L},e.total=W(L),P=!1,L={},ie(),U(),j(),Me().catch(t=>console.warn("sync failed",t)),ue()};function Ct(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let re="directors";function _t(e){const t={};return f.forEach(o=>{let i=[];e==="directors"?i=(o.director||"").split(",").map(n=>n.trim()).filter(Boolean):e==="writers"?i=(o.writer||"").split(",").map(n=>n.trim()).filter(Boolean):e==="actors"?i=(o.cast||"").split(",").map(n=>n.trim()).filter(Boolean):e==="companies"&&(i=(o.productionCompanies||"").split(",").map(n=>n.trim()).filter(Boolean)),i.forEach(n=>{t[n]||(t[n]=[]),t[n].push(o)})}),t}function Fe(e){const t=_t(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((n,s)=>n+s.total,0)/i.length).toFixed(1)),catAvgs:$.reduce((n,s)=>{const a=i.filter(l=>l.scores[s.key]!=null).map(l=>l.scores[s.key]);return n[s.key]=a.length?parseFloat((a.reduce((l,p)=>l+p,0)/a.length).toFixed(1)):null,n},{})})).sort((o,i)=>i.avg-o.avg)}function ye(e){e&&(re=e);const t=["directors","writers","actors","companies"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Companies"},i=Fe(re);document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:960px">
      ...
      <div class="explore-tabs">
        ${t.map(n=>`<button class="explore-tab ${n===re?"active":""}" onclick="renderExploreIndex('${n}')">${o[n]}</button>`).join("")}
      </div>
      ...
      ${i.length===0?'<div style="color:var(--dim);font-style:italic;padding:40px 0">Not enough data yet — add more films to see patterns.</div>':`<div class="explore-index">
          ${i.map((n,s)=>`
            <div class="explore-index-card" onclick="exploreEntity('${re.slice(0,-1)}','${n.name.replace(/'/g,"\\'")}')">
  ...
  `}function Bt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(c=>c.classList.remove("active")),document.getElementById("explore").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(c=>c.classList.remove("active")),document.querySelectorAll(".nav-btn")[1].classList.add("active"),window.scrollTo(0,0),document.getElementById("exploreContent").scrollTop=0;const o=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":"companies",i=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":"Company",n=f.filter(c=>e==="director"?(c.director||"").split(",").map(u=>u.trim()).includes(t):e==="writer"?(c.writer||"").split(",").map(u=>u.trim()).includes(t):e==="actor"?(c.cast||"").split(",").map(u=>u.trim()).includes(t):e==="company"?(c.productionCompanies||"").split(",").map(u=>u.trim()).includes(t):!1).sort((c,u)=>u.total-c.total);if(n.length===0){ye();return}const s=Fe(o),a=s.findIndex(c=>c.name===t)+1,l=s.length,p=s.find(c=>c.name===t),m=p?p.avg.toFixed(1):(n.reduce((c,u)=>c+u.total,0)/n.length).toFixed(1),r=n[0],d={};$.forEach(c=>{const u=s.filter(h=>h.catAvgs[c.key]!=null).sort((h,M)=>M.catAvgs[c.key]-h.catAvgs[c.key]),g=u.findIndex(h=>h.name===t)+1;d[c.key]=g>0?{rank:g,total:u.length}:null});const v=$.map(c=>{const u=n.filter(g=>g.scores[c.key]!=null).map(g=>g.scores[c.key]);return{...c,avg:u.length?parseFloat((u.reduce((g,h)=>g+h,0)/u.length).toFixed(1)):null}}).filter(c=>c.avg!=null).sort((c,u)=>u.avg-c.avg),k=v[0],S=v[v.length-1];document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:960px">
      ...
      <div class="explore-stat-row">
        ...
        <div class="explore-stat">
          <div class="explore-stat-val ${O(r.total)}">${r.total}</div>
        ...
        <div class="explore-cat-breakdown">
          ${v.map(c=>{const u=d[c.key];return`
            <div class="explore-cat-cell">
              ...
              <div class="explore-cat-cell-val ${O(c.avg)}">${c.avg.toFixed(1)}</div>
      ...
      ${n.map((c,u)=>{const g=c.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${c.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',h=c.total!=null?(Math.round(c.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${f.indexOf(c)})" style="cursor:pointer">
          ...
          ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(M=>`<div class="film-score ${c.scores[M]?O(c.scores[M]):"}"}">${c.scores[M]??"—"}</div>`).join("")}
          <div class="film-total">${h}</div>
        </div>`}).join("")}
    </div>
  `}function Ue(){const e={},t={},o={};f.forEach(r=>{r.director.split(",").forEach(d=>{d=d.trim(),d&&(e[d]||(e[d]=[]),e[d].push(r.total))}),r.cast.split(",").forEach(d=>{d=d.trim(),d&&(t[d]||(t[d]=[]),t[d].push(r.total))}),r.year&&(o[r.year]||(o[r.year]=[]),o[r.year].push(r.total))});const i=r=>Math.round(r.reduce((d,x)=>d+x,0)/r.length*100)/100,n=Object.entries(e).filter(([,r])=>r.length>=2).map(([r,d])=>({name:r,avg:i(d),count:d.length})).sort((r,d)=>d.avg-r.avg).slice(0,10),s=Object.entries(t).filter(([,r])=>r.length>=2).map(([r,d])=>({name:r,avg:i(d),count:d.length})).sort((r,d)=>d.avg-r.avg).slice(0,10),a=Object.entries(o).filter(([,r])=>r.length>=2).map(([r,d])=>({name:r,avg:i(d),count:d.length})).sort((r,d)=>d.avg-r.avg).slice(0,10),l=$.map(r=>{const d=f.map(x=>x.scores[r.key]).filter(x=>x!=null);return{...r,avg:i(d)}});function p(r){return r>=90?"#C4922A":r>=80?"#1F4A2A":r>=70?"#4A5830":r>=60?"#6B4820":"rgba(12,11,9,0.65)"}function m(r){return r.length?r.map((d,x)=>{const v=p(d.avg);return`
        <div style="display:flex;align-items:center;gap:14px;padding:11px 0;border-bottom:1px solid var(--rule)">
          <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--rule-dark);width:20px;flex-shrink:0;text-align:center">${x+1}</div>
          <div style="flex:1">
    ...
    <div style="max-width:900px">
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px 40px">
          ${l.filter(r=>r.avg!=null&&!isNaN(r.avg)).map(r=>{const d=Math.round(r.avg),x=p(r.avg);return`
            <div style="display:flex;align-items:center;gap:12px;padding:6px 0">
              ...
              <div style="flex:1;height:2px;background:var(--rule);position:relative;overflow:hidden">
                <div style="position:absolute;top:0;left:0;height:100%;background:${x};width:${d}%"></div>
              </div>
  ...
  `}const he="f5a446a5f70a9f6a16a8ddd052c121f2",xe="https://api.themoviedb.org/3",Tt="https://ledger-proxy.noahparikhcott.workers.dev";let Ae=null,V=null,be=null;function We(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",V=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function At(){clearTimeout(Ae),Ae=setTimeout(Ye,500)}async function Ye(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const n=((await(await fetch(`${xe}/search/movie?api_key=${he}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!n.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const s=new Set(f.map(a=>a.title.toLowerCase()));t.innerHTML=n.map(a=>{const l=a.release_date?.slice(0,4)||"",p=a.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${a.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',m=s.has(a.title.toLowerCase());return`<div class="tmdb-result ${m?"opacity-50":""}" onclick="${m?"":`predictSelectFilm(${a.id}, '${a.title.replace(/'/g,"\\'")}', '${l}')`}" style="${m?"opacity:0.4;cursor:default":""}">
        ${p}
    ...
    </div>`;let i={},n={};try{const[d,x]=await Promise.all([fetch(`${xe}/movie/${e}?api_key=${he}`),fetch(`${xe}/movie/${e}/credits?api_key=${he}`)]);i=await d.json(),n=await x.json()}catch{}const s=(n.crew||[]).filter(d=>d.job==="Director").map(d=>d.name).join(", "),a=(n.crew||[]).filter(d=>["Screenplay","Writer","Story"].includes(d.job)).map(d=>d.name).slice(0,2).join(", "),l=(n.cast||[]).slice(0,8).map(d=>d.name).join(", "),p=(i.genres||[]).map(d=>d.name).join(", "),m=i.overview||"",r=i.poster_path||null;V={tmdbId:e,title:t,year:o,director:s,writer:a,cast:l,genres:p,overview:m,poster:r},await Pt(V)}function Lt(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(a=>{const l=f.filter(r=>r.scores[a]!=null).map(r=>r.scores[a]);if(!l.length){t[a]={mean:70,std:10,min:0,max:100};return}const p=l.reduce((r,d)=>r+d,0)/l.length,m=Math.sqrt(l.reduce((r,d)=>r+(d-p)**2,0)/l.length);t[a]={mean:Math.round(p*10)/10,std:Math.round(m*10)/10,min:Math.min(...l),max:Math.max(...l)}});const o=[...f].sort((a,l)=>l.total-a.total),i=o.slice(0,10).map(a=>`${a.title} (${a.total})`).join(", "),n=o.slice(-5).map(a=>`${a.title} (${a.total})`).join(", "),s=$.map(a=>`${a.label}×${a.weight}`).join(", ");return{stats:t,top10:i,bottom5:n,weightStr:s,archetype:w?.archetype,archetypeSecondary:w?.archetype_secondary,totalFilms:f.length}}function jt(e){const t=(e.director||"").split(",").map(i=>i.trim()).filter(Boolean),o=(e.cast||"").split(",").map(i=>i.trim()).filter(Boolean);return f.filter(i=>{const n=(i.director||"").split(",").map(a=>a.trim()),s=(i.cast||"").split(",").map(a=>a.trim());return t.some(a=>n.includes(a))||o.some(a=>s.includes(a))}).sort((i,n)=>n.total-i.total).slice(0,8)}async function Pt(e){const t=Lt(),o=jt(e),i=o.length?o.map(l=>`- ${l.title} (${l.year||""}): total=${l.total}, plot=${l.scores.plot}, execution=${l.scores.execution}, acting=${l.scores.acting}, production=${l.scores.production}, enjoyability=${l.scores.enjoyability}, rewatchability=${l.scores.rewatchability}, ending=${l.scores.ending}, uniqueness=${l.scores.uniqueness}`).join(`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const r=((await(await fetch(Tt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:s,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),d=JSON.parse(r);be=d,Ot(e,d,o)}catch(l){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${l.message}. Check that the proxy is running and your API key is valid.</div>`}}function Ot(e,t,o){let i=0,n=0;$.forEach(m=>{const r=t.predicted_scores[m.key];r!=null&&(i+=r*m.weight,n+=m.weight)});const s=n>0?Math.round(i/n*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,l={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",p={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-film-card">
      ...
      <div style="flex:1">
        ...
        <div style="display:flex;align-items:baseline;gap:8px">
          ...
          <div>
            <div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)">${F(s)}</div>
    ...
    <div class="predict-score-grid">
      ${$.map(m=>{const r=t.predicted_scores[m.key];return`<div class="predict-score-cell">
          ...
          <div class="predict-score-cell-val ${r?O(r):""}">${r??"—"}</div>
        </div>`}).join("")}
    </div>
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(m=>{const r=(s-m.total).toFixed(1),d=r>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${f.indexOf(m)})">
  ...
  `}function qt(){V&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=V.title,T(()=>Promise.resolve().then(()=>io),void 0).then(t=>{be?.predicted_scores&&t.prefillWithPrediction(be.predicted_scores),t.liveSearch(V.title)}))},100))}let X="all",Ve="focused",N=[],C=0,I={},_={},te=[];const Rt={focused:15,thorough:30,deep:50},ze=8;function Nt(e){X=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Ht(e){Ve=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Ft(e,t){const o=[];(e==="all"?$.map(a=>a.key):[e]).forEach(a=>{const l=f.filter(p=>p.scores[a]!=null).sort((p,m)=>p.scores[a]-m.scores[a]);for(let p=0;p<l.length-1;p++)for(let m=p+1;m<l.length;m++){const r=Math.abs(l[p].scores[a]-l[m].scores[a]);if(r<=8)o.push({a:l[p],b:l[m],catKey:a,diff:r});else break}}),o.sort((a,l)=>a.diff-l.diff);const n=new Set,s=[];for(const a of o){const l=[a.a.title,a.b.title,a.catKey].join("|");n.has(l)||(n.add(l),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Ut(){const e=Rt[Ve];if(N=Ft(X,e),N.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}C=0,I={},_={},te=[],f.forEach(t=>{_[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=X==="all"?"All categories":$.find(t=>t.key===X)?.label||X,Ee()}function Ee(){if(C>=N.length){Wt();return}const{a:e,b:t,catKey:o}=N[C],i=N.length,n=Math.round(C/i*100);document.getElementById("cal-progress-label").textContent=`${C+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=$.find(p=>p.key===o)?.label||o;_[e.title]?.[o]??e.scores[o],_[t.title]?.[o]??t.scores[o];function a(p,m){const r=p.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${p.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(te.length===0)return;const e=te.pop();C=e.idx,_=e.tempScores,I=e.deltas,Ee()};window.calChoose=function(e){if(te.push({idx:C,tempScores:JSON.parse(JSON.stringify(_)),deltas:JSON.parse(JSON.stringify(I))}),e!=="skip"){const{a:t,b:o,catKey:i}=N[C],n=_[t.title]?.[i]??t.scores[i],s=_[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),l=1-a,p=e==="a"?1:0,m=1-p,r=Math.round(Math.min(100,Math.max(1,n+ze*(p-a)))),d=Math.round(Math.min(100,Math.max(1,s+ze*(m-l))));if(I[t.title]||(I[t.title]={}),I[o.title]||(I[o.title]={}),r!==n){const k=I[t.title][i]?.old??n;I[t.title][i]={old:k,new:r},_[t.title][i]=r}if(d!==s){const k=I[o.title][i]?.old??s;I[o.title][i]={old:k,new:d},_[o.title][i]=d}const x=document.getElementById(`cal-card-${e}`),v=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);x&&(x.style.opacity="1"),v&&(v.style.opacity="0.35",v.style.transform="scale(0.97)")}C++,setTimeout(()=>Ee(),e==="skip"?0:140)};function Wt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(I).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
      ...
      ${$.map(o=>{const i=t[o.key],n=i.slice(0,3),s=i.length-3,a=i.length>0;return`<div style="padding:14px;background:var(--cream);border-radius:6px;${a?"":"opacity:0.45"}">
          ...
          ${n.map((l,p)=>{const m=l.new>l.old?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;${p<n.length-1?"border-bottom:1px solid var(--rule)":""}">
              <input type="checkbox" id="caldiff_${l.idx}" checked style="flex-shrink:0;accent-color:var(--blue);width:14px;height:14px"
                data-movie-idx="${f.findIndex(r=>r.title===l.title)}" data-cat="${l.catKey}" data-old="${l.old}" data-new="${l.new}">
    ...
    `}else if(b==="reveal"){const t=Gt(G);z=t,z._slug||(z._slug=le.toLowerCase().replace(/[^a-z0-9]/g,"-")+"-"+Math.floor(Math.random()*9e3+1e3));const o=K[t.primary],i=o.palette||"#3d5a80";e.innerHTML=`
    ...
    `,setTimeout(()=>{const n=document.getElementById("ob-reveal-username");n&&(n.textContent=z._slug)},0)}}window.obCheckName=function(){const e=document.getElementById("ob-name-field")?.value?.trim(),t=document.getElementById("ob-name-btn");t&&(t.disabled=!e||e.length<1)};window.obSubmitName=function(){const e=document.getElementById("ob-name-field")?.value?.trim();e&&(le=e,b=0,q())};window.obShowReturning=function(){b="returning",q()};window.obShowImport=function(){b="import",ce=null,q()};window.obHandleImportDrop=function(e){e.preventDefault(),document.getElementById("ob-import-drop").style.borderColor="var(--rule-dark)";const t=e.dataTransfer.files[0];t&&Ge(t)};window.obHandleImportFile=function(e){const t=e.files[0];t&&Ge(t)};function Ge(e){const t=new FileReader;t.onload=o=>{try{const i=JSON.parse(o.target.result);if(!Array.isArray(i)||i.length===0)throw new Error("invalid");if(!i[0].scores||!i[0].title)throw new Error("invalid");ce=i,document.getElementById("ob-import-status").textContent=`✓ ${i.length} films ready to import`,document.getElementById("ob-import-status").style.color="var(--green)",document.getElementById("ob-import-drop").style.borderColor="var(--green)",document.getElementById("ob-import-drop").innerHTML=`<div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--green)">${e.name}</div>`,document.getElementById("ob-import-btn").disabled=!1}catch{document.getElementById("ob-import-status").textContent="That doesn't look like a valid Palate Map JSON file.",document.getElementById("ob-import-status").style.color="var(--red)"}},t.readAsText(e)}window.obConfirmImport=function(){ce&&(pe(ce),b=0,q())};window.obLookupUser=async function(){const e=document.getElementById("ob-returning-btn"),t=document.getElementById("ob-returning-error"),o=document.getElementById("ob-returning-field")?.value?.trim().toLowerCase();if(o){e.disabled=!0,e.textContent="Looking up…",t.style.display="none";try{const{data:i,error:n}=await me.from("ledger_users").select("*").eq("username",o).single();if(n||!i)throw new Error("not found");de({id:i.id,username:i.username,display_name:i.display_name,archetype:i.archetype,archetype_secondary:i.archetype_secondary,weights:i.weights,harmony_sensitivity:i.harmony_sensitivity}),i.movies&&Array.isArray(i.movies)&&i.movies.length>0&&pe(i.movies),se(),U(),ne(),ie(),document.getElementById("onboarding-overlay").style.display="none";const s=await T(()=>Promise.resolve().then(()=>Q),void 0);s.updateMastheadProfile(),s.setCloudStatus("synced"),s.updateStorageStatus(),j()}catch{e.disabled=!1,e.textContent="Restore profile →",t.style.display="block"}}};window.obSelectAnswer=function(e,t,o){G[e]=t,o.closest(".ob-card").querySelectorAll(".ob-option").forEach(n=>n.classList.remove("selected")),o.classList.add("selected");const i=document.getElementById("ob-next-btn");i&&(i.disabled=!1)};window.obBack=function(){b>0?(b--,q()):(b="name",q())};window.obNext=function(){G[b]&&(b<5?(b++,q()):(b="reveal",q()))};window.obFinishFromReveal=function(){if(!z)return;const e=K[z.primary];Jt(z.primary,z.secondary||"",e.weights,z.harmonySensitivity)};function Gt(e){const t={};Object.keys(K).forEach(n=>t[n]=0),e[0]==="A"&&(t.Formalist+=2,t.Sensualist+=1,t.Completionist+=1),e[0]==="C"&&(t.Visceralist+=2,t.Atmospherist+=1),e[0]==="D"&&(t.Revisionist+=3),e[0]==="B"&&(t.Narrativist+=1,t.Humanist+=1),e[1]==="A"&&(t.Absolutist+=3,t.Narrativist+=2),e[1]==="C"&&(t.Visceralist+=2,t.Atmospherist+=2),e[1]==="D"&&(t.Completionist+=1,t.Revisionist+=1),e[1]==="B"&&(t.Humanist+=1,t.Formalist+=1),e[2]==="A"&&(t.Atmospherist+=3),e[2]==="C"&&(t.Formalist+=2,t.Absolutist+=2),e[2]==="D"&&(t.Completionist+=2,t.Revisionist-=1),e[2]==="B"&&(t.Narrativist+=1),e[3]==="A"&&(t.Atmospherist+=2,t.Revisionist+=2),e[3]==="C"&&(t.Completionist+=3),e[3]==="D"&&(t.Atmospherist+=1),e[3]==="B"&&(t.Sensualist+=1),e[4]==="A"&&(t.Humanist+=3,t.Visceralist+=1),e[4]==="D"&&(t.Sensualist+=3),e[4]==="C"&&(t.Formalist+=1,t.Completionist+=1),e[4]==="B"&&(t.Narrativist+=1,t.Absolutist+=1);let o=.3;e[5]==="A"&&(t.Visceralist+=1,o=0),e[5]==="C"&&(t.Absolutist+=1,o=1),e[5]==="B"&&(o=.4);const i=Object.entries(t).sort((n,s)=>s[1]-n[1]);return{primary:i[0][0],secondary:i[1][1]>0?i[1][0]:null,harmonySensitivity:o}}async function Jt(e,t,o,i){const n=crypto.randomUUID(),s=z._slug||le.toLowerCase().replace(/[^a-z0-9]/g,"-")+"-"+Math.floor(Math.random()*9e3+1e3);de({id:n,username:s,display_name:le,archetype:e,archetype_secondary:t,weights:o,harmony_sensitivity:i}),ne(),ie(),document.getElementById("onboarding-overlay").style.display="none";const a=await T(()=>Promise.resolve().then(()=>Q),void 0);a.updateMastheadProfile(),a.updateStorageStatus(),a.setCloudStatus("syncing"),j(),se(),Me().catch(l=>console.warn("Initial sync failed:",l))}const Kt=Object.freeze(Object.defineProperty({__proto__:null,launchOnboarding:ve},Symbol.toStringTag,{value:"Module"})),we="f5a446a5f70a9f6a16a8ddd052c121f2",$e="https://api.themoviedb.org/3";let y={title:"",year:null,director:"",writer:"",cast:"",scores:{}},Z=[],B={},H={};function Je(e){ae(e)}function ae(e){for(let t=1;t<=4;t++){const o=document.getElementById("sn"+t),i=document.getElementById("sl"+t);t<e?(o.className="step-num done",o.textContent="✓"):t===e?(o.className="step-num active",o.textContent=t,i.className="step-label active"):(o.className="step-num",o.textContent=t,i.className="step-label")}document.querySelectorAll(".step-panel").forEach((t,o)=>{t.classList.toggle("active",o+1===e)})}let Le=null;function Ke(e){clearTimeout(Le);const t=document.getElementById("tmdb-results");if(e.trim().length<2){t.innerHTML="";return}document.getElementById("searchSpinner").style.display="inline",Le=setTimeout(async()=>{try{const i=await(await fetch(`${$e}/search/movie?api_key=${we}&query=${encodeURIComponent(e.trim())}&include_adult=false`)).json();if(document.getElementById("searchSpinner").style.display="none",!i.results||i.results.length===0){t.innerHTML='<div class="tmdb-loading">No results yet…</div>';return}const n=i.results.slice(0,6);t.innerHTML=n.map(s=>{const a=s.release_date?s.release_date.slice(0,4):"?",l=s.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${s.poster_path}" alt="">`:'<div class="tmdb-result-poster-placeholder">NO IMG</div>',p=(s.overview||"").slice(0,100)+((s.overview||"").length>100?"…":"");return`<div class="tmdb-result" onclick="tmdbSelect(${s.id}, '${s.title.replace(/'/g,"\\'").replace(/"/g,'\\"')}')">
          ${l}
          <div class="tmdb-result-info">
      ...
      </div>`,document.getElementById("curate-directors").textContent=p.join(", ")||"Unknown",document.getElementById("curate-writers").textContent=m.join(", ")||"Unknown",Xe(d),Qt(x),document.getElementById("tmdb-search-phase").style.display="none",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-curation-phase").style.display="block"}catch{document.getElementById("tmdb-results").innerHTML='<div class="tmdb-error">Failed to load film details. Try again.</div>'}}function Xe(e){const t=document.getElementById("curate-cast");t.innerHTML=`<div class="cast-grid">
  ...
  </div>`}function Ze(e){B[e]&&(B[e].checked=!B[e].checked);const t=document.getElementById("castItem_"+e),o=B[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function et(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,Z.slice(8,20).forEach(i=>{B[i.id]||(B[i.id]={actor:i,checked:!1})});const o=Z.slice(0,20);Xe(o),e.textContent="+ More cast",e.disabled=!1,Z.length<=20&&(e.style.display="none")}function Qt(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
  ...
  </div>`}function tt(e){H[e].checked=!H[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(H[e].checked?"checked":"unchecked")}function ot(){oe=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function it(){const e=y._allDirectors||[],t=y._allWriters||[],o=Object.values(B).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(H).filter(n=>n.checked).map(n=>n.company.name);y.title=y._tmdbDetail.title,y.director=e.join(", "),y.writer=t.join(", "),y.cast=o.join(", "),y.productionCompanies=i.join(", "),eo(),ae(2)}let oe=null;function Xt(e){oe=e}function Zt(e){const t=[...f].filter(s=>s.scores[e]!=null).sort((s,a)=>a.scores[e]-s.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),n=new Set;return i.filter(s=>n.has(s.title)?!1:(n.add(s.title),!0))}function eo(){const e=document.getElementById("calibrationCategories");e.innerHTML=$.map(t=>{const o=Zt(t.key),i=oe?.[t.key]??y.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
    ...
    </div>`}).join(""),$.forEach(t=>{y.scores[t.key]=oe?.[t.key]??y.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(s=>s.classList.remove("selected")),o.classList.add("selected");const i=y.scores[e]??50,n=Math.round((i+t)/2);document.getElementById("slider_"+e).value=n,updateSlider(e,n)};window.updateSlider=function(e,t){t=parseInt(t),y.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=F(t)};function nt(){to(),ae(3)}let R=[],J=0;function to(){R=[],$.forEach(e=>{const t=y.scores[e.key];if(!t)return;f.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,n)=>Math.abs(i.scores[e.key]-t)-Math.abs(n.scores[e.key]-t)).slice(0,1).forEach(i=>R.push({cat:e,film:i}))}),R=R.slice(0,6),J=0,Ie()}function Ie(){const e=document.getElementById("hthContainer");if(R.length===0||J>=R.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
  ...
  `}window.hthChoice=function(e,t,o){const i=y.scores[t];e==="new"&&i<=o?y.scores[t]=o+1:e==="existing"&&i>=o&&(y.scores[t]=o-1),J++,Ie()};window.hthSkip=function(){J++,Ie()};function st(){oo(),ae(4)}function oo(){const e=W(y.scores);y.total=e;const t=[...f,y].sort((i,n)=>n.total-i.total),o=t.indexOf(y)+1;document.getElementById("resultCard").innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
    ...
    <div class="result-grid">
      ${$.map(i=>`
        <div class="result-cat">
          ...
          <div class="result-cat-val ${O(y.scores[i.key]||0)}">${y.scores[i.key]||"—"}</div>
        </div>`).join("")}
    </div>
  ...
  `}function at(){y.total=W(y.scores),f.push({title:y.title,year:y.year,total:y.total,director:y.director,writer:y.writer,cast:y.cast,productionCompanies:y.productionCompanies||"",poster:y._tmdbDetail?.poster_path||null,overview:y._tmdbDetail?.overview||"",scores:{...y.scores}}),U(),T(()=>Promise.resolve().then(()=>Q),void 0).then(e=>e.updateStorageStatus()),y={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},B={},H={},Z=[],oe=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",ae(1),j(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const io=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:it,goToStep:Je,goToStep3:nt,goToStep4:st,liveSearch:Ke,prefillWithPrediction:Xt,resetToSearch:ot,saveFilm:at,showMoreCast:et,tmdbSelect:Qe,toggleCast:Ze,toggleCompany:tt},Symbol.toStringTag,{value:"Module"}));function no(){if(!w){T(()=>Promise.resolve().then(()=>Kt),void 0).then(e=>e.launchOnboarding());return}rt()}function rt(){if(!w)return;const e=w.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function lt(e,t){const o=$.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const s=document.getElementById("awbar_"+n.key);s&&(s.style.width=Math.round(n.val/i*100)+"%")})}function so(){if(!w||!w.archetype)return;const e=K[w.archetype]?.weights;e&&($.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),lt())}function ao(){const e={};$.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),w.weights=e,T(()=>Promise.resolve().then(()=>He),void 0).then(t=>t.saveUserLocally()),ne(),j(),U(),ct()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ct(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const D=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],dt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},ro={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function lo(e,t,o=220){const i=D.length,n=o/2,s=o/2,a=o*.36,l=h=>h/i*Math.PI*2-Math.PI/2,p=(h,M)=>({x:n+a*M*Math.cos(l(h)),y:s+a*M*Math.sin(l(h))}),m=[.25,.5,.75,1].map(h=>`<polygon points="${D.map((E,Y)=>`${p(Y,h).x},${p(Y,h).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),r=D.map((h,M)=>{const E=p(M,1);return`<line x1="${n}" y1="${s}" x2="${E.x}" y2="${E.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),d=Math.max(...D.map(h=>e[h]||1)),v=`<polygon points="${D.map((h,M)=>{const E=p(M,(e[h]||1)/d);return`${E.x},${E.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let k="";if(t){const h=Math.max(...D.map(E=>t[E]||1));k=`<polygon points="${D.map((E,Y)=>{const Be=p(Y,(t[E]||1)/h);return`${Be.x},${Be.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const S=D.map((h,M)=>{const E=p(M,(e[h]||1)/d);return`<circle cx="${E.x}" cy="${E.y}" r="2.5" fill="var(--blue)"/>`}).join(""),c=22,u=D.map((h,M)=>{const E=p(M,1+c/a),Y=E.x<n-5?"end":E.x>n+5?"start":"middle";return`<text x="${E.x}" y="${E.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${Y}" dominant-baseline="middle">${ro[h]}</text>`}).join(""),g=36;return`<svg width="${o+g*2}" height="${o+g*2}" viewBox="${-g} ${-g} ${o+g*2} ${o+g*2}" style="overflow:visible;display:block">
    ${m}${r}${k}${v}${S}${u}
  </svg>`}function co(e){return e.length?D.map(t=>{const o=e.filter(a=>a.scores?.[t]!=null),i=o.length?o.reduce((a,l)=>a+l.scores[t],0)/o.length:null,n=i!=null?i.toFixed(1):"—",s=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);width:88px;flex-shrink:0">${dt[t]}</div>
      <div style="flex:1;height:2px;background:var(--rule);position:relative;overflow:hidden">
      ...
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:white;padding:4px 11px 3px;background:${po(o.total)};border-radius:4px;flex-shrink:0">${s}</div>
      </div>
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function fo(e,t){const o=[...t].sort((s,a)=>a.total-s.total).slice(0,3),i=t.length?(t.reduce((s,a)=>s+a.total,0)/t.length).toFixed(1):"—",n=K[e.archetype]||{};return`
  ...
  `}function De(){const e=document.getElementById("profileContent");if(!e)return;const t=w;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=K[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=f,a=D.map(m=>{const r=s.filter(d=>d.scores?.[m]!=null);return{c:m,avg:r.length?r.reduce((d,x)=>d+x.scores[m],0)/r.length:0}}),l=s.length?[...a].sort((m,r)=>r.avg-m.avg)[0]:null,p=s.length?(s.reduce((m,r)=>m+r.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin-top:24px;border-top:2px solid var(--ink)">
          ...
          ${l?`<div style="padding:16px 0 16px 20px">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:32px;color:var(--blue);line-height:1;letter-spacing:-1px">${dt[l.c]}</div>
          </div>`:""}
        </div>`:""}
      </div>
  ...
  `}function pt(e){document.querySelectorAll(".screen").forEach(t=>t.classList.remove("active")),document.getElementById(e).classList.add("active"),document.querySelectorAll(".nav-btn").forEach(t=>t.classList.remove("active")),event.target.classList.add("active"),e==="analysis"&&Ue(),e==="calibration"&&Se(),e==="explore"&&ye(),e==="predict"&&We(),e==="profile"&&De(),localStorage.setItem("ledger_last_screen",e)}function Ce(){const e=document.getElementById("storageStatus");e&&(f.length>0?(e.textContent=`✓ ${f.length} films · saved`,e.style.color="var(--green)"):(e.textContent="no films yet",e.style.color="var(--dim)"))}function _e(){const e=w;if(!e)return;const t=document.getElementById("mastheadLeft");t.innerHTML=`<span class="profile-chip" onclick="document.getElementById('nav-profile').click()">
    <strong style="color:var(--ink);font-family:'DM Mono',monospace;font-size:11px;letter-spacing:0.5px">${e.display_name}</strong>
  </span>`}function mt(){const e=new Blob([JSON.stringify(f,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="film_rankings.json",t.click()}function ft(){confirm("Clear all your films and start fresh? This cannot be undone.")&&(localStorage.removeItem("filmRankings_v1"),localStorage.removeItem("ledger_user"),location.reload())}function ut(){const e=document.getElementById("cold-landing");e?e.style.display="flex":ve()}window.startFromLanding=function(){const e=document.getElementById("cold-landing");e&&(e.style.display="none"),ve()};async function uo(){Mt(),Ne(),w?(ee("syncing"),_e(),ne(),Re(w.id).catch(()=>ee("error"))):(ee("local"),setTimeout(()=>ut(),400)),j(),Ce();const e=localStorage.getItem("ledger_last_screen");if(e&&e!=="rankings"&&document.getElementById(e)){const t=document.querySelectorAll(".nav-btn");t.forEach(o=>o.classList.remove("active")),document.querySelectorAll(".screen").forEach(o=>o.classList.remove("active")),document.getElementById(e).classList.add("active"),t.forEach(o=>{o.getAttribute("onclick")?.includes(e)&&o.classList.add("active")}),e==="analysis"&&Ue(),e==="explore"&&ye(),e==="profile"&&De()}}function ee(e){const t=document.getElementById("cloudDot"),o=document.getElementById("cloudLabel");t.className="cloud-dot",e==="syncing"?(t.classList.add("syncing"),o.textContent="syncing…"):e==="synced"?(t.classList.add("synced"),o.textContent=w?w.display_name:"synced"):e==="error"?(t.classList.add("error"),o.textContent="offline"):o.textContent="local"}window.__ledger={showScreen:pt,sortBy:Pe,openModal:Dt,closeModal:Ct,exploreEntity:Bt,renderExploreIndex:ye,initPredict:We,predictSearch:Ye,predictSearchDebounce:At,predictSelectFilm:zt,predictAddToList:qt,startCalibration:Ut,selectCalCat:Nt,selectCalInt:Ht,applyCalibration:Yt,resetCalibration:Se,launchOnboarding:ve,liveSearch:Ke,tmdbSelect:Qe,toggleCast:Ze,showMoreCast:et,toggleCompany:tt,resetToSearch:ot,confirmTmdbData:it,goToStep3:nt,goToStep4:st,saveFilm:at,goToStep:Je,renderProfile:De,setViewMode:je,showSyncPanel:no,openArchetypeModal:rt,closeArchetypeModal:ct,previewWeight:lt,resetArchetypeWeights:so,saveArchetypeWeights:ao,exportData:mt,resetStorage:ft,updateStorageStatus:Ce,updateMastheadProfile:_e,setCloudStatus:ee};const yo=["showScreen","sortBy","openModal","closeModal","exploreEntity","renderExploreIndex","initPredict","predictSearch","predictSearchDebounce","predictSelectFilm","predictAddToList","startCalibration","selectCalCat","selectCalInt","applyCalibration","resetCalibration","launchOnboarding","liveSearch","tmdbSelect","toggleCast","showMoreCast","toggleCompany","resetToSearch","confirmTmdbData","goToStep3","goToStep4","saveFilm","goToStep","renderProfile","setViewMode","showSyncPanel","openArchetypeModal","closeArchetypeModal","previewWeight","resetArchetypeWeights","saveArchetypeWeights","exportData","resetStorage"];yo.forEach(e=>{window[e]=window.__ledger[e]});uo();const Q=Object.freeze(Object.defineProperty({__proto__:null,exportData:mt,resetStorage:ft,setCloudStatus:ee,showColdLanding:ut,showScreen:pt,updateMastheadProfile:_e,updateStorageStatus:Ce},Symbol.toStringTag,{value:"Module"}));
