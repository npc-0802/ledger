(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();const M=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],$=null;function ye(e){$=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const wt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function C(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function J(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of wt)if(e>=t)return o;return"Unwatchable"}function Q(e){let t=0,o=0;for(const i of M)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function le(){y.forEach(e=>{e.total=Q(e.scores)})}function K(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function ce(){if(!$||!$.weights)return;const e=$.weights;M.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),le()}let P={key:"total",dir:"desc"},De="grid";const kt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Execution"},{key:"acting",label:"Acting"},{key:"production",label:"Production"},{key:"enjoyability",label:"Enjoyability"},{key:"rewatchability",label:"Rewatchability"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Uniqueness"}];function $t(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function Mt(){const{key:e,dir:t}=P;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Ne(e){De=e,N()}function He(e){P.key===e?P.dir=P.dir==="desc"?"asc":"desc":(P.key=e,P.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=P.dir==="desc"?"↓":"↑")}N()}function N(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=y.length+" films ranked";const i=Mt();De==="grid"?Et(i,e,o,t):St(i,e,o,t)}function Fe(e){const t=P.key;return`<div class="rankings-toolbar">
    ${De==="grid"?`
  ...
  </div>`}function Et(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Fe("grid"));const s=["total","rank","title"].includes(P.key)?"total":P.key,n=[...y].sort((r,c)=>c.total-r.total),a=new Map(n.map((r,c)=>[r.title,c+1]));t.innerHTML=`<div class="film-grid">
    ${e.map(r=>{const c=s==="total"?r.total:r.scores?.[s]??null,l=c!=null?s==="total"?(Math.round(c*10)/10).toFixed(1):c:"—",d=$t(c),p=r.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${r.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${y.indexOf(r)})">
  ...
  </div>`}function St(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Fe("table"));const s=[...y].sort((a,r)=>r.total-a.total),n=new Map(s.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,c=n.get(a.title),l=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",d=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${y.indexOf(a)})">
      ...
      <div class="film-total">${l}</div>
    </div>`}).join("")}const Dt=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:N,setViewMode:Ne,sortBy:He},Symbol.toStringTag,{value:"Module"})),It="modulepreload",Ct=function(e){return"/"+e},je={},_=function(t,o,i){let s=Promise.resolve();if(o&&o.length>0){let c=function(l){return Promise.all(l.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=a?.nonce||a?.getAttribute("nonce");s=c(o.map(l=>{if(l=Ct(l),l in je)return;je[l]=!0;const d=l.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const x=document.createElement("link");if(x.rel=d?"stylesheet":It,d||(x.as="script"),x.crossOrigin="",x.href=l,r&&x.setAttribute("nonce",r),document.head.appendChild(x),d)return new Promise((h,m)=>{x.addEventListener("load",h),x.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return s.then(a=>{for(const r of a||[])r.status==="rejected"&&n(r.reason);return t().catch(n)})},Pe="palate_migrations_v1";function _t(){let e;try{e=JSON.parse(localStorage.getItem(Pe)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;y.forEach(o=>{const i=C((o.cast||"").split(",").map(n=>n.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const s=C((o.productionCompanies||"").split(",").map(n=>n.trim()).filter(Boolean)).join(", ");s!==(o.productionCompanies||"")&&(o.productionCompanies=s,t++)}),t>0&&(Y(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(Pe,JSON.stringify(e))}catch{}}}const Ue="filmRankings_v1";function Y(){try{localStorage.setItem(Ue,JSON.stringify(y))}catch(e){console.warn("localStorage save failed:",e)}$&&(clearTimeout(Y._syncTimer),Y._syncTimer=setTimeout(()=>{_(()=>Promise.resolve().then(()=>Ve),void 0).then(e=>e.syncToSupabase())},2e3))}function Bt(){try{const e=localStorage.getItem(Ue);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;ue(t),console.log(`Loaded ${y.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const zt="https://gzuuhjjedrzeqbgxhfip.supabase.co",Tt="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ge=window.supabase.createClient(zt,Tt);async function Ie(){const e=$;if(!e)return;const{setCloudStatus:t}=await _(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>te);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ge.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:y,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),de()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function We(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await _(async()=>{const{setCloudStatus:n,updateMastheadProfile:a,updateStorageStatus:r}=await Promise.resolve().then(()=>te);return{setCloudStatus:n,updateMastheadProfile:a,updateStorageStatus:r}},void 0),{renderRankings:s}=await _(async()=>{const{renderRankings:n}=await Promise.resolve().then(()=>Dt);return{renderRankings:n}},void 0);t("syncing");try{const{data:n,error:a}=await ge.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;if(n){if(ye({id:n.id,username:n.username,display_name:n.display_name,archetype:n.archetype,archetype_secondary:n.archetype_secondary,weights:n.weights,harmony_sensitivity:n.harmony_sensitivity}),n.movies&&Array.isArray(n.movies)&&n.movies.length>=y.length){const r=n.movies.map(c=>({...c,cast:C((c.cast||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", "),productionCompanies:C((c.productionCompanies||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", ")}));ue(r)}de(),ce(),t("synced"),o(),s(),i()}}catch(n){console.warn("Supabase load error:",n),t("error")}}function de(){try{localStorage.setItem("ledger_user",JSON.stringify($))}catch{}}function Ye(){try{const e=localStorage.getItem("ledger_user");e&&ye(JSON.parse(e))}catch{}}const Ve=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:We,loadUserLocally:Ye,saveUserLocally:de,sb:ge,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),At=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function we(e){for(const[t,o]of At)if(e>=t)return o;return"Unwatchable"}let ve=null,T=!1,R={};function Lt(e){ve=e,T=!1,R={},he()}function he(){const e=ve,t=y[e],o=[...y].sort((u,v)=>v.total-u.total),i=o.indexOf(t)+1;o.filter(u=>u!==t&&Math.abs(u.total-t.total)<6).slice(0,5);const s={};M.forEach(u=>{const v=[...y].sort((g,b)=>(b.scores[u.key]||0)-(g.scores[u.key]||0));s[u.key]=v.indexOf(t)+1});const n=(u,v,g)=>`<span class="modal-meta-chip" onclick="exploreEntity('${v}','${g.replace(/'/g,"'")}')">${u}</span>`,a=C((t.director||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"director",u)).join(""),r=C((t.writer||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"writer",u)).join(""),c=C((t.cast||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"actor",u)).join(""),l=C((t.productionCompanies||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"company",u)).join(""),d=t.poster?`<div class="dark-grid" style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,p=T?R:t.scores,x=T?Q(R):t.total,h=["plot","execution","acting","production"],m=["enjoyability","rewatchability","ending","uniqueness"];function E(u,v){const g=M.filter(S=>v.includes(S.key)),b=`<div style="font-family:'DM Mono',monospace;font-size:9px;letter-spacing:2.5px;text-transform:uppercase;color:var(--dim);opacity:0.6;padding:12px 0 6px;border-bottom:1px solid var(--rule)">${u}</div>`,w=g.map(S=>{const B=p[S.key],bt=s[S.key];return T?`<div class="breakdown-row" style="align-items:center;gap:12px">
          <div class="breakdown-cat">${S.label}</div>
          <div class="breakdown-bar-wrap" style="flex:1">
            <input type="range" min="1" max="100" value="${B||50}"
          ...
          <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
            <div class="breakdown-val ${K(B||50)}" id="modal-edit-val-${S.key}">${B||50}</div>
            <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${S.key}">${we(B||50)}</div>
          </div>
          <div class="breakdown-wt">×${S.weight}</div>
        </div>`:`<div class="breakdown-row">
        <div class="breakdown-cat">${S.label}</div>
        <div class="breakdown-bar-wrap"><div class="breakdown-bar" style="width:${B||0}%"></div><div class="bar-tick" style="left:25%"></div><div class="bar-tick" style="left:50%"></div><div class="bar-tick" style="left:75%"></div></div>
        <div class="breakdown-val ${B?K(B):""}">${B??"—"}</div>
        <div class="breakdown-wt">×${S.weight}</div>
    ...
    <div>${D}</div>
    ${T?"":(()=>{const u=[];for(let v=-2;v<=2;v++){const g=i+v;g<1||g>o.length||u.push({film:o[g-1],slotRank:g})}return u.length?`<div class="compare-section">
        <div class="compare-title">Nearby in the rankings</div>
        ${u.map(({film:v,slotRank:g})=>{const b=v===t,w=(Math.round(v.total*10)/10).toFixed(1);return b?`<div style="display:flex;align-items:center;gap:12px;padding:9px 12px;background:var(--ink);margin:2px 0">
              <span style="font-family:'DM Mono',monospace;font-size:10px;color:rgba(255,255,255,0.45);min-width:20px;text-align:right">${g}</span>
              <span style="font-family:'Playfair Display',serif;font-weight:700;font-style:italic;flex:1;color:white;font-size:14px">${v.title} <span style="font-size:11px;font-weight:400;color:rgba(255,255,255,0.5)">${v.year||""}</span></span>
              <span style="font-family:'DM Mono',monospace;font-size:12px;font-weight:600;color:white">${w}</span>
            </div>`:`<div style="display:flex;align-items:center;gap:12px;padding:8px 12px;border-bottom:1px solid var(--rule);cursor:pointer" onclick="closeModal();openModal(${y.indexOf(v)})">
            <span style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);min-width:20px;text-align:right">${g}</span>
            <span style="font-family:'Playfair Display',serif;font-weight:700;flex:1;color:var(--ink);font-size:14px">${v.title} <span style="font-size:11px;font-weight:400;color:var(--dim)">${v.year||""}</span></span>
            <span style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)">${w}</span>
          </div>`}).join("")}
      </div>`:""})()}
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),T||jt(t)}window.modalEnterEdit=function(){const e=y[ve];T=!0,R={...e.scores},he()};window.modalCancelEdit=function(){T=!1,R={},he()};window.modalUpdateScore=function(e,t){R[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${K(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=we(parseInt(t)));const s=Q(R),n=document.getElementById("modal-total-display");n&&(n.textContent=s);const a=document.getElementById("modal-total-label");a&&(a.textContent=we(s))};window.modalSaveScores=function(){const e=y[ve];e.scores={...R},e.total=Q(R),T=!1,R={},le(),Y(),N(),Ie().catch(t=>console.warn("sync failed",t)),he()};async function jt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await _(async()=>{const{getFilmInsight:s}=await import("./insights-DeFr08mx.js");return{getFilmInsight:s}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function Pt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let H="directors";function U(e){return C((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Ot(e){const t={};return y.forEach(o=>{let i=[];e==="directors"?i=U(o.director):e==="writers"?i=U(o.writer):e==="actors"?i=U(o.cast):e==="companies"?i=U(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(s=>{t[s]||(t[s]=[]),t[s].push(o)})}),t}function Ge(e){const t=Ot(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((s,n)=>s+n.total,0)/i.length).toFixed(1)),catAvgs:M.reduce((s,n)=>{const a=i.filter(r=>r.scores[n.key]!=null).map(r=>r.scores[n.key]);return s[n.key]=a.length?parseFloat((a.reduce((r,c)=>r+c,0)/a.length).toFixed(1)):null,s},{})})).sort((o,i)=>i.avg-o.avg)}function Je(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function Ce(e){e&&(H=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ge(H),s=document.getElementById("explore-section");s&&(s.innerHTML=`
  ...
  `)}function qt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";H=i;const s=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",n=y.filter(m=>e==="director"?U(m.director).includes(t):e==="writer"?U(m.writer).includes(t):e==="actor"?U(m.cast).includes(t):e==="company"?U(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,E)=>E.total-m.total);if(n.length===0){Ce();return}const a=Ge(i),r=a.findIndex(m=>m.name===t)+1,c=a.length,l=a.find(m=>m.name===t),d=l?l.avg.toFixed(1):(n.reduce((m,E)=>m+E.total,0)/n.length).toFixed(1);n[0];const p={};M.forEach(m=>{const E=a.filter(u=>u.catAvgs[m.key]!=null).sort((u,v)=>v.catAvgs[m.key]-u.catAvgs[m.key]),D=E.findIndex(u=>u.name===t)+1;p[m.key]=D>0?{rank:D,total:E.length}:null});const x=M.map(m=>{const E=n.filter(D=>D.scores[m.key]!=null).map(D=>D.scores[m.key]);return{...m,avg:E.length?parseFloat((E.reduce((D,u)=>D+u,0)/E.length).toFixed(1)):null}}),h=x.filter(m=>m.avg!=null).sort((m,E)=>E.avg-m.avg);h[0],h[h.length-1],document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:800px">
      ...
      ${h.length>0?(()=>{const m=["plot","execution","acting","production"],E=["enjoyability","rewatchability","ending","uniqueness"];function D(u,v){const g=x.filter(b=>v.includes(b.key)&&b.avg!=null);return g.length?`<div style="margin-bottom:28px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 40px">
              ${g.map(b=>{const w=p[b.key];return`<div style="border-bottom:1px solid var(--rule);padding:10px 0">
                  ...
                  <div style="height:2px;background:var(--rule);border-radius:1px">
                    <div style="height:2px;width:${b.avg}%;background:${Je(b.avg)};border-radius:1px"></div>
                  </div>
                </div>`}).join("")}
            </div>
      ...
      ${n.map((m,E)=>{const D=m.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${m.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',u=m.total!=null?(Math.round(m.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${y.indexOf(m)})" style="cursor:pointer">
          ...
          ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(v=>`<div class="film-score ${m.scores[v]?K(m.scores[v]):"}"}">${m.scores[v]??"—"}</div>`).join("")}
          <div class="film-total">${u}</div>
        </div>`}).join("")}
    </div>
  `,Rt(e,t,n)}async function Rt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:s}=await _(async()=>{const{getEntityInsight:a}=await import("./insights-DeFr08mx.js");return{getEntityInsight:a}},[]),n=await s(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
...
Respond with this exact JSON structure:
{
  ...
  `}function Gt(){X&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=X.title,_(()=>Promise.resolve().then(()=>fo),void 0).then(t=>{Me?.predicted_scores&&t.prefillWithPrediction(Me.predicted_scores),t.liveSearch(X.title)}))},100))}let oe="all",Xe="focused",V=[],A=0,I={},L={},se=[];const Jt={focused:15,thorough:30,deep:50},qe=8;function Kt(e){oe=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Qt(e){Xe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Xt(e,t){const o=[];(e==="all"?M.map(a=>a.key):[e]).forEach(a=>{const r=y.filter(c=>c.scores[a]!=null).sort((c,l)=>c.scores[a]-l.scores[a]);for(let c=0;c<r.length-1;c++)for(let l=c+1;l<r.length;l++){const d=Math.abs(r[c].scores[a]-r[l].scores[a]);if(d<=8)o.push({a:r[c],b:r[l],catKey:a,diff:d});else break}}),o.sort((a,r)=>a.diff-r.diff);const s=new Set,n=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");s.has(r)||(s.add(r),n.push(a))}return n.sort(()=>Math.random()-.5).slice(0,t)}function Zt(){const e=Jt[Xe];if(V=Xt(oe,e),V.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}A=0,I={},L={},se=[],y.forEach(t=>{L[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=oe==="all"?"All categories":M.find(t=>t.key===oe)?.label||oe,Be()}function Be(){if(A>=V.length){eo();return}const{a:e,b:t,catKey:o}=V[A],i=V.length,s=Math.round(A/i*100);document.getElementById("cal-progress-label").textContent=`${A+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=s+"%";const n=M.find(c=>c.key===o)?.label||o;L[e.title]?.[o]??e.scores[o],L[t.title]?.[o]??t.scores[o];function a(c,l){const d=c.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${c.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(se.length===0)return;const e=se.pop();A=e.idx,L=e.tempScores,I=e.deltas,Be()};window.calChoose=function(e){if(se.push({idx:A,tempScores:JSON.parse(JSON.stringify(L)),deltas:JSON.parse(JSON.stringify(I))}),e!=="skip"){const{a:t,b:o,catKey:i}=V[A],s=L[t.title]?.[i]??t.scores[i],n=L[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(n-s)/40)),r=1-a,c=e==="a"?1:0,l=1-c,d=Math.round(Math.min(100,Math.max(1,s+qe*(c-a)))),p=Math.round(Math.min(100,Math.max(1,n+qe*(l-r))));if(I[t.title]||(I[t.title]={}),I[o.title]||(I[o.title]={}),d!==s){const m=I[t.title][i]?.old??s;I[t.title][i]={old:m,new:d},L[t.title][i]=d}if(p!==n){const m=I[o.title][i]?.old??n;I[o.title][i]={old:m,new:p},L[o.title][i]=p}const x=document.getElementById(`cal-card-${e}`),h=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);x&&(x.style.opacity="1"),h&&(h.style.opacity="0.35",h.style.transform="scale(0.97)")}A++,setTimeout(()=>Be(),e==="skip"?0:140)};function eo(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(I).flatMap(([o,i])=>Object.entries(i).map(([s,{old:n,new:a}])=>({title:o,catKey:s,old:n,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    `;else if(typeof k=="number"){const t=oo[k],o=Math.round(k/6*100),i=k===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;line-height:1.8;color:var(--dim);margin-bottom:28px;font-style:italic">The films you're drawn to reveal something consistent about you — a set of values, sensitivities, and hungers that show up again and again. A few questions to surface them.</div>`:"";e.innerHTML=`
      ...
      ${t.options.map(s=>`
        <div class="ob-option ${Z[k]===s.key?"selected":""}" onclick="obSelectAnswer(${k}, '${s.key}', this)">
      ...
      <div class="ob-nav">
        ...
        <button class="ob-btn-primary" id="ob-next-btn" onclick="obNext()" ${Z[k]?"":"disabled"}>
          ${k===5?"See my archetype →":"Next →"}
        </button>
      </div>
    `}else if(k==="reveal"){const t=io(Z);O=t,O._slug||(O._slug=me.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"user");const o=ee[t.primary],i=o.palette||"#3d5a80";e.innerHTML=`
  ...
  </div>`}function nt(e){j[e]&&(j[e].checked=!j[e].checked);const t=document.getElementById("castItem_"+e),o=j[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function st(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,ie.slice(8,20).forEach(i=>{j[i.id]||(j[i.id]={actor:i,checked:!1})});const o=ie.slice(0,20);it(o),e.textContent="+ More cast",e.disabled=!1,ie.length<=20&&(e.style.display="none")}function ao(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
  ...
  </div>`}function at(e){G[e].checked=!G[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(G[e].checked?"checked":"unchecked")}function rt(){ae=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function lt(){const e=f._allDirectors||[],t=f._allWriters||[],o=Object.values(j).filter(s=>s.checked).map(s=>s.actor.name),i=Object.values(G).filter(s=>s.checked).map(s=>s.company.name);f.title=f._tmdbDetail.title,f.director=e.join(", "),f.writer=t.join(", "),f.cast=o.join(", "),f.productionCompanies=i.join(", "),co(),pe(2)}let ae=null;function ro(e){ae=e}function lo(e){const t=[...y].filter(n=>n.scores[e]!=null).sort((n,a)=>a.scores[e]-n.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),s=new Set;return i.filter(n=>s.has(n.title)?!1:(s.add(n.title),!0))}function co(){const e=document.getElementById("calibrationCategories");e.innerHTML=M.map(t=>{const o=lo(t.key),i=ae?.[t.key]??f.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
    ...
    </div>`}).join(""),M.forEach(t=>{f.scores[t.key]=ae?.[t.key]??f.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(n=>n.classList.remove("selected")),o.classList.add("selected");const i=f.scores[e]??50,s=Math.round((i+t)/2);document.getElementById("slider_"+e).value=s,updateSlider(e,s)};window.updateSlider=function(e,t){t=parseInt(t),f.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=J(t)};function ct(){po(),pe(3)}let W=[],q=0,re=[];function po(){W=[],re=[],M.forEach(e=>{const t=f.scores[e.key];if(!t)return;y.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,s)=>Math.abs(i.scores[e.key]-t)-Math.abs(s.scores[e.key]-t)).slice(0,1).forEach(i=>W.push({cat:e,film:i}))}),W=W.slice(0,6),q=0,be()}function be(){const e=document.getElementById("hthContainer");if(W.length===0||q>=W.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
  ...
  `}window.hthChoice=function(e,t,o){re.push({idx:q,scores:{...f.scores}});const i=f.scores[t];e==="new"&&i<=o?f.scores[t]=o+1:e==="existing"&&i>=o&&(f.scores[t]=o-1),q++,be()};window.hthSkip=function(){re.push({idx:q,scores:{...f.scores}}),q++,be()};window.hthUndo=function(){if(re.length===0)return;const e=re.pop();q=e.idx,f.scores=e.scores,be()};function dt(){mo(),pe(4)}function mo(){const e=Q(f.scores);f.total=e;const t=[...y,f].sort((i,s)=>s.total-i.total),o=t.indexOf(f)+1;document.getElementById("resultCard").innerHTML=`
    ...
    <div style="margin-top:24px;padding-top:16px;border-top:1px solid var(--rule)">
      ...
      ${[-2,-1,0,1,2].map(i=>{const s=o+i;if(s<1||s>t.length)return"";const n=t[s-1],a=n===f,r=a?e:n.total,c=(Math.round(r*10)/10).toFixed(1);return a?`<div style="display:flex;align-items:center;gap:12px;padding:9px 12px;background:var(--ink);margin:2px 0">
  ...
  `}function pt(){f.total=Q(f.scores),y.push({title:f.title,year:f.year,total:f.total,director:f.director,writer:f.writer,cast:f.cast,productionCompanies:f.productionCompanies||"",poster:f._tmdbDetail?.poster_path||null,overview:f._tmdbDetail?.overview||"",scores:{...f.scores}}),Y(),_(()=>Promise.resolve().then(()=>te),void 0).then(e=>e.updateStorageStatus()),f={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},j={},G={},ie=[],ae=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",pe(1),N(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const fo=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:lt,goToStep:et,goToStep3:ct,goToStep4:dt,liveSearch:tt,prefillWithPrediction:ro,resetToSearch:rt,saveFilm:pt,showMoreCast:st,tmdbSelect:ot,toggleCast:nt,toggleCompany:at},Symbol.toStringTag,{value:"Module"}));function yo(){if(!$){_(()=>Promise.resolve().then(()=>so),void 0).then(e=>e.launchOnboarding());return}mt()}function mt(){if(!$)return;const e=$.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function ft(e,t){const o=M.map(s=>({key:s.key,val:parseFloat(document.getElementById("awval_"+s.key)?.value)||1})),i=Math.max(...o.map(s=>s.val));o.forEach(s=>{const n=document.getElementById("awbar_"+s.key);n&&(n.style.width=Math.round(s.val/i*100)+"%")})}function uo(){if(!$||!$.archetype)return;const e=ee[$.archetype]?.weights;e&&(M.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),ft())}function go(){const e={};M.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),$.weights=e,_(()=>Promise.resolve().then(()=>Ve),void 0).then(t=>t.saveUserLocally()),ce(),N(),Y(),yt()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function yt(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const z=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],ut={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},vo={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function ho(e,t,o=220){const i=z.length,s=o/2,n=o/2,a=o*.36,r=g=>g/i*Math.PI*2-Math.PI/2,c=(g,b)=>({x:s+a*b*Math.cos(r(g)),y:n+a*b*Math.sin(r(g))}),l=[.25,.5,.75,1].map(g=>`<polygon points="${z.map((w,S)=>`${c(S,g).x},${c(S,g).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),d=z.map((g,b)=>{const w=c(b,1);return`<line x1="${s}" y1="${n}" x2="${w.x}" y2="${w.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),p=Math.max(...z.map(g=>e[g]||1)),h=`<polygon points="${z.map((g,b)=>{const w=c(b,(e[g]||1)/p);return`${w.x},${w.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let m="";if(t){const g=Math.max(...z.map(w=>t[w]||1));m=`<polygon points="${z.map((w,S)=>{const B=c(S,(t[w]||1)/g);return`${B.x},${B.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const E=z.map((g,b)=>{const w=c(b,(e[g]||1)/p);return`<circle cx="${w.x}" cy="${w.y}" r="2.5" fill="var(--blue)"/>`}).join(""),D=22,u=z.map((g,b)=>{const w=c(b,1+D/a),S=w.x<s-5?"end":w.x>s+5?"start":"middle";return`<text x="${w.x}" y="${w.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${S}" dominant-baseline="middle">${vo[g]}</text>`}).join(""),v=36;return`<svg width="${o+v*2}" height="${o+v*2}" viewBox="${-v} ${-v} ${o+v*2} ${o+v*2}" style="overflow:visible;display:block">
    ${l}${d}${m}${h}${E}${u}
    ...
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function ko(e,t){const o=[...t].sort((n,a)=>a.total-n.total).slice(0,3),i=t.length?(t.reduce((n,a)=>n+a.total,0)/t.length).toFixed(1):"—",s=ee[e.archetype]||{};return`
  ...
  `}function Te(){const e=document.getElementById("profileContent");if(!e)return;const t=$;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=ee[t.archetype]||{},i=t.weights||{},s=o.weights||null,n=y,a=z.map(l=>{const d=n.filter(p=>p.scores?.[l]!=null);return{c:l,avg:d.length?d.reduce((p,x)=>p+x.scores[l],0)/d.length:0}}),r=n.length?[...a].sort((l,d)=>d.avg-l.avg)[0]:null,c=n.length?(n.reduce((l,d)=>l+d.total,0)/n.length).toFixed(1):"—";e.innerHTML=`
  ...
  `}function gt(e){document.querySelectorAll(".screen").forEach(t=>t.classList.remove("active")),document.getElementById(e).classList.add("active"),document.querySelectorAll(".nav-btn").forEach(t=>t.classList.remove("active")),event.target.classList.add("active"),e==="analysis"&&_e(),e==="calibration"&&ze(),e==="predict"&&Ke(),e==="profile"&&Te(),localStorage.setItem("ledger_last_screen",e)}function Ae(){const e=document.getElementById("storageStatus");e&&(y.length>0?(e.textContent=`✓ ${y.length} films · saved`,e.style.color="var(--green)"):(e.textContent="no films yet",e.style.color="var(--dim)"))}function Le(){const e=$;if(!e)return;const t=document.getElementById("mastheadLeft");t.innerHTML=`<span class="profile-chip" onclick="document.getElementById('nav-profile').click()">
    <strong style="color:var(--ink);font-family:'DM Mono',monospace;font-size:11px;letter-spacing:0.5px">${e.display_name}</strong>
  </span>`}function vt(){const e=new Blob([JSON.stringify(y,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="film_rankings.json",t.click()}function ht(){confirm("Clear all your films and start fresh? This cannot be undone.")&&(localStorage.removeItem("filmRankings_v1"),localStorage.removeItem("ledger_user"),location.reload())}function xt(){const e=document.getElementById("cold-landing");e?e.style.display="flex":xe()}window.startFromLanding=function(){const e=document.getElementById("cold-landing");e&&(e.style.display="none"),xe()};async function $o(){Bt(),_t(),Ye(),$?(ne("syncing"),Le(),ce(),We($.id).catch(()=>ne("error"))):(ne("local"),setTimeout(()=>xt(),400)),N(),Ae();const e=localStorage.getItem("ledger_last_screen"),t=e==="explore"?"analysis":e;if(t&&t!=="rankings"&&document.getElementById(t)){const o=document.querySelectorAll(".nav-btn");o.forEach(i=>i.classList.remove("active")),document.querySelectorAll(".screen").forEach(i=>i.classList.remove("active")),document.getElementById(t).classList.add("active"),o.forEach(i=>{i.getAttribute("onclick")?.includes(t)&&i.classList.add("active")}),t==="analysis"&&_e(),t==="profile"&&Te()}}function ne(e){const t=document.getElementById("cloudDot"),o=document.getElementById("cloudLabel");t.className="cloud-dot",e==="syncing"?(t.classList.add("syncing"),o.textContent="syncing…"):e==="synced"?(t.classList.add("synced"),o.textContent=$?$.display_name:"synced"):e==="error"?(t.classList.add("error"),o.textContent="offline"):o.textContent="local"}window.__ledger={showScreen:gt,sortBy:He,openModal:Lt,closeModal:Pt,exploreEntity:qt,renderExploreIndex:Ce,renderAnalysis:_e,initPredict:Ke,predictSearch:Qe,predictSearchDebounce:Ht,predictSelectFilm:Ft,predictAddToList:Gt,startCalibration:Zt,selectCalCat:Kt,selectCalInt:Qt,applyCalibration:to,resetCalibration:ze,launchOnboarding:xe,liveSearch:tt,tmdbSelect:ot,toggleCast:nt,showMoreCast:st,toggleCompany:at,resetToSearch:rt,confirmTmdbData:lt,goToStep3:ct,goToStep4:dt,saveFilm:pt,goToStep:et,renderProfile:Te,setViewMode:Ne,showSyncPanel:yo,openArchetypeModal:mt,closeArchetypeModal:yt,previewWeight:ft,resetArchetypeWeights:uo,saveArchetypeWeights:go,exportData:vt,resetStorage:ht,updateStorageStatus:Ae,updateMastheadProfile:Le,setCloudStatus:ne};const Mo=["showScreen","sortBy","openModal","closeModal","exploreEntity","renderExploreIndex","initPredict","predictSearch","predictSearchDebounce","predictSelectFilm","predictAddToList","startCalibration","selectCalCat","selectCalInt","applyCalibration","resetCalibration","launchOnboarding","liveSearch","tmdbSelect","toggleCast","showMoreCast","toggleCompany","resetToSearch","confirmTmdbData","goToStep3","goToStep4","saveFilm","goToStep","renderProfile","setViewMode","showSyncPanel","openArchetypeModal","closeArchetypeModal","previewWeight","resetArchetypeWeights","saveArchetypeWeights","exportData","resetStorage","renderAnalysis"];Mo.forEach(e=>{window[e]=window.__ledger[e]});$o();const te=Object.freeze(Object.defineProperty({__proto__:null,exportData:vt,resetStorage:ht,setCloudStatus:ne,showColdLanding:xt,showScreen:gt,updateMastheadProfile:Le,updateStorageStatus:Ae},Symbol.toStringTag,{value:"Module"}));export{M as C,y as M,$ as c};
