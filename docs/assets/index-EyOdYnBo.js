(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const w=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let u=[],b=null;function fe(e){b=e}function ye(e){u.length=0,e.forEach(t=>u.push(t))}const wt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function I(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function Y(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of wt)if(e>=t)return o;return"Unwatchable"}function G(e){let t=0,o=0;for(const i of w)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function re(){u.forEach(e=>{e.total=G(e.scores)})}function V(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function le(){if(!b||!b.weights)return;const e=b.weights;w.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),re()}let A={key:"total",dir:"desc"},De="grid";const kt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function $t(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function Mt(){const{key:e,dir:t}=A;return e==="rank"||e==="total"?[...u].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...u].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...u].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Re(e){De=e,O()}function He(e){A.key===e?A.dir=A.dir==="desc"?"asc":"desc":(A.key=e,A.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=A.dir==="desc"?"↓":"↑")}O()}function O(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(u.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=u.length+" films ranked";const i=Mt();De==="grid"?Et(i,e,o,t):St(i,e,o,t)}function Fe(e){const t=A.key;return`<div class="rankings-toolbar">
    ${De==="grid"?`
  ...
  </div>`}function Et(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Fe("grid"));const n=["total","rank","title"].includes(A.key)?"total":A.key;t.innerHTML=`<div class="film-grid">
    ${e.map((s,a)=>{const r=n==="total"?s.total:s.scores?.[n]??null,m=r!=null?n==="total"?(Math.round(r*10)/10).toFixed(1):r:"—",p=$t(r),l=s.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${s.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${u.indexOf(s)})">
        <div class="film-card-poster-wrap">
          ${l}
          <div class="film-card-rank">${a+1}</div>
          <div class="film-card-score ${p}">${m}</div>
        </div>
  ...
  </div>`}function St(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Fe("table"));const n=[...u].sort((a,r)=>r.total-a.total),s=new Map(n.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,m=s.get(a.title),p=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",l=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${u.indexOf(a)})">
      <div class="film-poster-cell">${l}</div>
      <div class="film-rank">${m}</div>
      ...
      ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(c=>`<div class="film-score ${r[c]?V(r[c]):""}">${r[c]??"—"}</div>`).join("")}
      <div class="film-total">${p}</div>
    </div>`}).join("")}const Dt=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:O,setViewMode:Re,sortBy:He},Symbol.toStringTag,{value:"Module"})),It="modulepreload",_t=function(e){return"/"+e},Le={},S=function(t,o,i){let n=Promise.resolve();if(o&&o.length>0){let m=function(p){return Promise.all(p.map(l=>Promise.resolve(l).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=a?.nonce||a?.getAttribute("nonce");n=m(o.map(p=>{if(p=_t(p),p in Le)return;Le[p]=!0;const l=p.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${c}`))return;const v=document.createElement("link");if(v.rel=l?"stylesheet":It,l||(v.as="script"),v.crossOrigin="",v.href=p,r&&v.setAttribute("nonce",r),document.head.appendChild(v),l)return new Promise((d,g)=>{v.addEventListener("load",d),v.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return n.then(a=>{for(const r of a||[])r.status==="rejected"&&s(r.reason);return t().catch(s)})},je="palate_migrations_v1";function Ct(){let e;try{e=JSON.parse(localStorage.getItem(je)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;u.forEach(o=>{const i=I((o.cast||"").split(",").map(s=>s.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const n=I((o.productionCompanies||"").split(",").map(s=>s.trim()).filter(Boolean)).join(", ");n!==(o.productionCompanies||"")&&(o.productionCompanies=n,t++)}),t>0&&(F(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(je,JSON.stringify(e))}catch{}}}const Ue="filmRankings_v1";function F(){try{localStorage.setItem(Ue,JSON.stringify(u))}catch(e){console.warn("localStorage save failed:",e)}b&&(clearTimeout(F._syncTimer),F._syncTimer=setTimeout(()=>{S(()=>Promise.resolve().then(()=>Ve),void 0).then(e=>e.syncToSupabase())},2e3))}function Bt(){try{const e=localStorage.getItem(Ue);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;ye(t),console.log(`Loaded ${u.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const zt="https://gzuuhjjedrzeqbgxhfip.supabase.co",Tt="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ue=window.supabase.createClient(zt,Tt);async function Ie(){const e=b;if(!e)return;const{setCloudStatus:t}=await S(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>ee);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ue.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:u,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),ce()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function We(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await S(async()=>{const{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}=await Promise.resolve().then(()=>ee);return{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}},void 0),{renderRankings:n}=await S(async()=>{const{renderRankings:s}=await Promise.resolve().then(()=>Dt);return{renderRankings:s}},void 0);t("syncing");try{const{data:s,error:a}=await ue.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;s&&(fe({id:s.id,username:s.username,display_name:s.display_name,archetype:s.archetype,archetype_secondary:s.archetype_secondary,weights:s.weights,harmony_sensitivity:s.harmony_sensitivity}),s.movies&&Array.isArray(s.movies)&&s.movies.length>=u.length&&ye(s.movies),ce(),le(),t("synced"),o(),n(),i())}catch(s){console.warn("Supabase load error:",s),t("error")}}function ce(){try{localStorage.setItem("ledger_user",JSON.stringify(b))}catch{}}function Ye(){try{const e=localStorage.getItem("ledger_user");e&&fe(JSON.parse(e))}catch{}}const Ve=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:We,loadUserLocally:Ye,saveUserLocally:ce,sb:ue,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),At=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function we(e){for(const[t,o]of At)if(e>=t)return o;return"Unwatchable"}let ve=null,C=!1,P={};function Lt(e){ve=e,C=!1,P={},ge()}function ge(){const e=ve,t=u[e],o=[...u].sort((f,h)=>h.total-f.total),i=o.indexOf(t)+1,n=o.filter(f=>f!==t&&Math.abs(f.total-t.total)<6).slice(0,5),s={};w.forEach(f=>{const h=[...u].sort((M,N)=>(N.scores[f.key]||0)-(M.scores[f.key]||0));s[f.key]=h.indexOf(t)+1});const a=(f,h,M)=>`<span class="modal-meta-chip" onclick="exploreEntity('${h}','${M.replace(/'/g,"'")}')">${f}</span>`,r=I((t.director||"").split(",").map(f=>f.trim()).filter(Boolean)).map(f=>a(f,"director",f)).join(""),m=I((t.writer||"").split(",").map(f=>f.trim()).filter(Boolean)).map(f=>a(f,"writer",f)).join(""),p=I((t.cast||"").split(",").map(f=>f.trim()).filter(Boolean)).map(f=>a(f,"actor",f)).join(""),l=I((t.productionCompanies||"").split(",").map(f=>f.trim()).filter(Boolean)).map(f=>a(f,"company",f)).join(""),c=t.poster?`<div style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,v=C?P:t.scores,d=C?G(P):t.total,g=w.map(f=>{const h=v[f.key],M=s[f.key];return C?`<div class="breakdown-row" style="align-items:center;gap:12px">
        <div class="breakdown-cat">${f.label}</div>
        <div class="breakdown-bar-wrap" style="flex:1">
          <input type="range" min="1" max="100" value="${h||50}"
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${V(h||50)}" id="modal-edit-val-${f.key}">${h||50}</div>
          <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${f.key}">${we(h||50)}</div>
        </div>
        <div class="breakdown-wt">×${f.weight}</div>
      </div>`:`<div class="breakdown-row">
      <div class="breakdown-cat">${f.label}</div>
      <div class="breakdown-bar-wrap"><div class="breakdown-bar" style="width:${h||0}%"></div></div>
      <div class="breakdown-val ${h?V(h):""}">${h??"—"}</div>
      <div class="breakdown-wt">×${f.weight}</div>
      <div class="modal-cat-rank">#${M}</div>
    </div>`}).join("");document.getElementById("modalContent").innerHTML=`
    ${c}
    ${t.overview?`<div class="modal-overview">${t.overview}</div>`:""}
    <div style="margin-bottom:20px">
      ${r?`<div style="margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);margin-right:8px">Dir.</span>${r}</div>`:""}
      ...
      ${p?`<div style="margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);margin-right:8px">Cast</span><div style="display:inline">${p}</div></div>`:""}
      ${l?`<div style="margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);margin-right:8px">Prod.</span><div style="display:inline">${l}</div></div>`:""}
    </div>
    <div style="display:flex;align-items:baseline;gap:12px;margin-bottom:8px">
      <span style="font-family:'Playfair Display',serif;font-size:52px;font-weight:900;color:var(--blue);letter-spacing:-2px" id="modal-total-display">${d}</span>
      <span style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)" id="modal-total-label">${Y(d)}</span>
    </div>
    ${C?"":`<div id="modal-insight" style="margin-bottom:20px">
    ...
    ${!C&&n.length>0?`<div class="compare-section">
      ...
      ${n.map(f=>{const h=(f.total-t.total).toFixed(2),M=h>0?"+":"";return`<div class="compare-film" style="cursor:pointer" onclick="closeModal();openModal(${u.indexOf(f)})">
          ...
          <div class="compare-diff ${h>0?"diff-pos":"diff-neg"}">${M}${h}</div>
        </div>`}).join("")}
    </div>`:""}
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),C||jt(t)}window.modalEnterEdit=function(){const e=u[ve];C=!0,P={...e.scores},ge()};window.modalCancelEdit=function(){C=!1,P={},ge()};window.modalUpdateScore=function(e,t){P[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${V(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=we(parseInt(t)));const n=G(P),s=document.getElementById("modal-total-display");s&&(s.textContent=n);const a=document.getElementById("modal-total-label");a&&(a.textContent=we(n))};window.modalSaveScores=function(){const e=u[ve];e.scores={...P},e.total=G(P),C=!1,P={},re(),F(),O(),Ie().catch(t=>console.warn("sync failed",t)),ge()};async function jt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await S(async()=>{const{getFilmInsight:n}=await import("./insights-DwhYtSLN.js");return{getFilmInsight:n}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function Pt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let K="directors";function R(e){return I((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Ot(e){const t={};return u.forEach(o=>{let i=[];e==="directors"?i=R(o.director):e==="writers"?i=R(o.writer):e==="actors"?i=R(o.cast):e==="companies"?i=R(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(n=>{t[n]||(t[n]=[]),t[n].push(o)})}),t}function Ge(e){const t=Ot(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((n,s)=>n+s.total,0)/i.length).toFixed(1)),catAvgs:w.reduce((n,s)=>{const a=i.filter(r=>r.scores[s.key]!=null).map(r=>r.scores[s.key]);return n[s.key]=a.length?parseFloat((a.reduce((r,m)=>r+m,0)/a.length).toFixed(1)):null,n},{})})).sort((o,i)=>i.avg-o.avg)}function Je(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function he(e){e&&(K=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ge(K);document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:800px">
      ...
      <div class="explore-tabs">
        ${t.map(n=>`<button class="explore-tab ${n===K?"active":""}" onclick="renderExploreIndex('${n}')">${o[n]}</button>`).join("")}
      </div>

      <div style="height:28px"></div>
      ${i.length===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim);font-style:italic;padding:48px 0">Not enough data yet — add more films to see patterns.</div>`:i.map((n,s)=>{const a=n.name.replace(/'/g,"\\'");return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule);cursor:pointer" onclick="exploreEntity('${K==="companies"?"company":K==="years"?"year":K.slice(0,-1)}','${a}')" onmouseover="this.style.background='var(--cream)'" onmouseout="this.style.background=''">
  ...
  `}function qt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(d=>d.classList.remove("active")),document.getElementById("explore").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(d=>d.classList.remove("active")),document.querySelectorAll(".nav-btn")[1].classList.add("active"),window.scrollTo(0,0),document.getElementById("exploreContent").scrollTop=0;const o=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies",i=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",n=u.filter(d=>e==="director"?R(d.director).includes(t):e==="writer"?R(d.writer).includes(t):e==="actor"?R(d.cast).includes(t):e==="company"?R(d.productionCompanies).includes(t):e==="year"?String(d.year)===t:!1).sort((d,g)=>g.total-d.total);if(n.length===0){he();return}const s=Ge(o),a=s.findIndex(d=>d.name===t)+1,r=s.length,m=s.find(d=>d.name===t),p=m?m.avg.toFixed(1):(n.reduce((d,g)=>d+g.total,0)/n.length).toFixed(1);n[0];const l={};w.forEach(d=>{const g=s.filter(h=>h.catAvgs[d.key]!=null).sort((h,M)=>M.catAvgs[d.key]-h.catAvgs[d.key]),f=g.findIndex(h=>h.name===t)+1;l[d.key]=f>0?{rank:f,total:g.length}:null});const v=w.map(d=>{const g=n.filter(f=>f.scores[d.key]!=null).map(f=>f.scores[d.key]);return{...d,avg:g.length?parseFloat((g.reduce((f,h)=>f+h,0)/g.length).toFixed(1)):null}}).filter(d=>d.avg!=null).sort((d,g)=>g.avg-d.avg);v[0],v[v.length-1],document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:800px">
      ...
      <div style="background:var(--surface-dark);margin:-40px -56px 32px;padding:40px 56px 32px">
        ...
        <div style="display:flex;align-items:baseline;gap:20px;flex-wrap:wrap">
          ...
          <div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--on-dark-dim)">#${a} of ${r} ${o}</div>
      ...
      ${v.length>0?`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 40px;margin-bottom:32px">
          ${v.map(d=>{const g=l[d.key];return`<div style="border-bottom:1px solid var(--rule);padding:10px 0">
              <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:6px">
                <div style="font-family:'DM Mono',monospace;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:var(--dim)">${d.label}</div>
                <div style="display:flex;align-items:baseline;gap:8px">
                  ${g?`<div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim)">#${g.rank}</div>`:""}
                  <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:var(--ink)">${d.avg.toFixed(1)}</div>
                </div>
              </div>
              <div style="height:2px;background:var(--rule);border-radius:1px">
                <div style="height:2px;width:${d.avg}%;background:${Je(d.avg)};border-radius:1px"></div>
              </div>
            </div>`}).join("")}
        </div>
      `:""}
      ...
      ${n.map((d,g)=>{const f=d.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${d.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',h=d.total!=null?(Math.round(d.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${u.indexOf(d)})" style="cursor:pointer">
          <div class="film-poster-cell">${f}</div>
          <div class="film-rank">${g+1}</div>
          <div class="film-title-cell">
            <div class="film-title-main">${d.title}</div>
            <div class="film-title-sub">${d.year||""} · ${d.director||""}</div>
          </div>
          ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(M=>`<div class="film-score ${d.scores[M]?V(d.scores[M]):"}"}">${d.scores[M]??"—"}</div>`).join("")}
          <div class="film-total">${h}</div>
        </div>`}).join("")}
    </div>
  `,Nt(e,t,n)}async function Nt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:n}=await S(async()=>{const{getEntityInsight:a}=await import("./insights-DwhYtSLN.js");return{getEntityInsight:a}},[]),s=await n(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const s=document.getElementById("explore-insight");s&&(s.style.display="none")}}function Pe(e){return I((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Ke(){const e={},t={},o={};u.forEach(l=>{Pe(l.director).forEach(c=>{c&&(e[c]||(e[c]=[]),e[c].push(l.total))}),Pe(l.cast).forEach(c=>{c&&(t[c]||(t[c]=[]),t[c].push(l.total))}),l.year&&(o[l.year]||(o[l.year]=[]),o[l.year].push(l.total))});const i=l=>Math.round(l.reduce((c,v)=>c+v,0)/l.length*100)/100,n=Object.entries(e).filter(([,l])=>l.length>=2).map(([l,c])=>({name:l,avg:i(c),count:c.length})).sort((l,c)=>c.avg-l.avg).slice(0,10),s=Object.entries(t).filter(([,l])=>l.length>=2).map(([l,c])=>({name:l,avg:i(c),count:c.length})).sort((l,c)=>c.avg-l.avg).slice(0,10),a=Object.entries(o).filter(([,l])=>l.length>=2).map(([l,c])=>({name:l,avg:i(c),count:c.length})).sort((l,c)=>c.avg-l.avg).slice(0,10),r=w.map(l=>{const c=u.map(v=>v.scores[l.key]).filter(v=>v!=null);return{...l,avg:i(c)}});function m(l){return l>=90?"#C4922A":l>=80?"#1F4A2A":l>=70?"#4A5830":l>=60?"#6B4820":"rgba(12,11,9,0.65)"}function p(l){return l.length?l.map((c,v)=>{const d=m(c.avg);return`
        <div style="display:flex;align-items:center;gap:14px;padding:11px 0;border-bottom:1px solid var(--rule)">
          <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--rule-dark);width:20px;flex-shrink:0;text-align:center">${v+1}</div>
          <div style="flex:1">
          ...
          <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:17px;color:white;padding:3px 10px 2px;background:${d};border-radius:4px;flex-shrink:0">${c.avg}</div>
    ...
    <div style="max-width:900px">
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px 40px">
          ${r.filter(l=>l.avg!=null&&!isNaN(l.avg)).map(l=>{const c=Math.round(l.avg),v=m(l.avg);return`
            <div style="display:flex;align-items:center;gap:12px;padding:6px 0">
              <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);width:88px;flex-shrink:0">${l.label}</div>
              <div style="flex:1;height:2px;background:var(--rule);position:relative;overflow:hidden">
                <div style="position:absolute;top:0;left:0;height:100%;background:${v};width:${c}%"></div>
              </div>
              <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:var(--ink);width:36px;text-align:right;letter-spacing:-0.5px">${l.avg}</div>
            </div>`}).join("")}
        </div>
      </div>
  ...
  `}const ke="f5a446a5f70a9f6a16a8ddd052c121f2",$e="https://api.themoviedb.org/3",Rt="https://ledger-proxy.noahparikhcott.workers.dev";let Oe=null,Q=null,Me=null;function Qe(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",Q=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function Ht(){clearTimeout(Oe),Oe=setTimeout(Xe,500)}async function Xe(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const n=((await(await fetch(`${$e}/search/movie?api_key=${ke}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!n.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const s=new Set(u.map(a=>a.title.toLowerCase()));t.innerHTML=n.map(a=>{const r=a.release_date?.slice(0,4)||"",m=a.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${a.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',p=s.has(a.title.toLowerCase());return`<div class="tmdb-result ${p?"opacity-50":""}" onclick="${p?"":`predictSelectFilm(${a.id}, '${a.title.replace(/'/g,"\\'")}', '${r}')`}" style="${p?"opacity:0.4;cursor:default":""}">
        ${m}
        <div class="tmdb-result-info">
          <div class="tmdb-result-title">${a.title}</div>
          <div class="tmdb-result-meta">${r}${p?" · already in your list":""}</div>
    ...
    </div>`;let i={},n={};try{const[c,v]=await Promise.all([fetch(`${$e}/movie/${e}?api_key=${ke}`),fetch(`${$e}/movie/${e}/credits?api_key=${ke}`)]);i=await c.json(),n=await v.json()}catch{}const s=(n.crew||[]).filter(c=>c.job==="Director").map(c=>c.name).join(", "),a=(n.crew||[]).filter(c=>["Screenplay","Writer","Story"].includes(c.job)).map(c=>c.name).slice(0,2).join(", "),r=(n.cast||[]).slice(0,8).map(c=>c.name).join(", "),m=(i.genres||[]).map(c=>c.name).join(", "),p=i.overview||"",l=i.poster_path||null;Q={tmdbId:e,title:t,year:o,director:s,writer:a,cast:r,genres:m,overview:p,poster:l},await Yt(Q)}function Ut(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(a=>{const r=u.filter(l=>l.scores[a]!=null).map(l=>l.scores[a]);if(!r.length){t[a]={mean:70,std:10,min:0,max:100};return}const m=r.reduce((l,c)=>l+c,0)/r.length,p=Math.sqrt(r.reduce((l,c)=>l+(c-m)**2,0)/r.length);t[a]={mean:Math.round(m*10)/10,std:Math.round(p*10)/10,min:Math.min(...r),max:Math.max(...r)}});const o=[...u].sort((a,r)=>r.total-a.total),i=o.slice(0,10).map(a=>`${a.title} (${a.total})`).join(", "),n=o.slice(-5).map(a=>`${a.title} (${a.total})`).join(", "),s=w.map(a=>`${a.label}×${a.weight}`).join(", ");return{stats:t,top10:i,bottom5:n,weightStr:s,archetype:b?.archetype,archetypeSecondary:b?.archetype_secondary,totalFilms:u.length}}function Wt(e){const t=I((e.director||"").split(",").map(i=>i.trim()).filter(Boolean)),o=I((e.cast||"").split(",").map(i=>i.trim()).filter(Boolean));return u.filter(i=>{const n=I((i.director||"").split(",").map(a=>a.trim()).filter(Boolean)),s=I((i.cast||"").split(",").map(a=>a.trim()).filter(Boolean));return t.some(a=>n.includes(a))||o.some(a=>s.includes(a))}).sort((i,n)=>n.total-i.total).slice(0,8)}async function Yt(e){const t=Ut(),o=Wt(e),i=o.length?o.map(r=>`- ${r.title} (${r.year||""}): total=${r.total}, plot=${r.scores.plot}, execution=${r.scores.execution}, acting=${r.scores.acting}, production=${r.scores.production}, enjoyability=${r.scores.enjoyability}, rewatchability=${r.scores.rewatchability}, ending=${r.scores.ending}, uniqueness=${r.scores.uniqueness}`).join(`
`):"No direct comparisons found in rated list.",n=Object.entries(t.stats).map(([r,m])=>`${r}: mean=${m.mean}, std=${m.std}, range=${m.min}–${m.max}`).join(`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const l=((await(await fetch(Rt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:s,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),c=JSON.parse(l);Me=c,Vt(e,c,o)}catch(r){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${r.message}. Check that the proxy is running and your API key is valid.</div>`}}function Vt(e,t,o){let i=0,n=0;w.forEach(p=>{const l=t.predicted_scores[p.key];l!=null&&(i+=l*p.weight,n+=p.weight)});const s=n>0?Math.round(i/n*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,r={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",m={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-film-card">
      ...
      <div style="flex:1">
        ...
        <div style="display:flex;align-items:baseline;gap:8px">
          ...
          <div>
            <div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)">${Y(s)}</div>
            <span class="predict-confidence ${r}">${m}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="predict-score-grid">
      ${w.map(p=>{const l=t.predicted_scores[p.key];return`<div class="predict-score-cell">
          <div class="predict-score-cell-label">${p.label}</div>
          <div class="predict-score-cell-val ${l?V(l):""}">${l??"—"}</div>
        </div>`}).join("")}
    </div>
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(p=>{const l=(s-p.total).toFixed(1),c=l>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${u.indexOf(p)})">
          <div class="predict-comp-title">${p.title} <span style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);font-weight:400">${p.year||""}</span></div>
          <div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)">${p.total}</div>
          <div style="font-family:'DM Mono',monospace;font-size:11px;font-weight:600;${parseFloat(l)>0?"color:var(--green)":"color:var(--red)"}">${c}${l} predicted</div>
        </div>`}).join("")}
    `:""}
  ...
  `}function Gt(){Q&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Q.title,S(()=>Promise.resolve().then(()=>fo),void 0).then(t=>{Me?.predicted_scores&&t.prefillWithPrediction(Me.predicted_scores),t.liveSearch(Q.title)}))},100))}let te="all",Ze="focused",U=[],B=0,E={},z={},ne=[];const Jt={focused:15,thorough:30,deep:50},qe=8;function Kt(e){te=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Qt(e){Ze=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Xt(e,t){const o=[];(e==="all"?w.map(a=>a.key):[e]).forEach(a=>{const r=u.filter(m=>m.scores[a]!=null).sort((m,p)=>m.scores[a]-p.scores[a]);for(let m=0;m<r.length-1;m++)for(let p=m+1;p<r.length;p++){const l=Math.abs(r[m].scores[a]-r[p].scores[a]);if(l<=8)o.push({a:r[m],b:r[p],catKey:a,diff:l});else break}}),o.sort((a,r)=>a.diff-r.diff);const n=new Set,s=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");n.has(r)||(n.add(r),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Zt(){const e=Jt[Ze];if(U=Xt(te,e),U.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}B=0,E={},z={},ne=[],u.forEach(t=>{z[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=te==="all"?"All categories":w.find(t=>t.key===te)?.label||te,_e()}function _e(){if(B>=U.length){eo();return}const{a:e,b:t,catKey:o}=U[B],i=U.length,n=Math.round(B/i*100);document.getElementById("cal-progress-label").textContent=`${B+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=w.find(m=>m.key===o)?.label||o;z[e.title]?.[o]??e.scores[o],z[t.title]?.[o]??t.scores[o];function a(m,p){const l=m.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${m.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
      <div class="cal-film-card" id="cal-card-${p}" onclick="calChoose('${p}')">
      ...
      </div>`}const r=o==="uniqueness"?"More unique?":`Better ${s.toLowerCase()}?`;document.getElementById("cal-matchup-card").innerHTML=`
    ...
    <div style="text-align:center;margin-top:24px;display:flex;justify-content:center;align-items:center;gap:24px">
      ${B>0?`<span style="font-family:'DM Mono',monospace;font-size:11px;color:var(--dim);cursor:pointer;text-decoration:underline;text-underline-offset:2px" onclick="undoCalChoice()">← Undo</span>`:""}
  ...
  `}window.undoCalChoice=function(){if(ne.length===0)return;const e=ne.pop();B=e.idx,z=e.tempScores,E=e.deltas,_e()};window.calChoose=function(e){if(ne.push({idx:B,tempScores:JSON.parse(JSON.stringify(z)),deltas:JSON.parse(JSON.stringify(E))}),e!=="skip"){const{a:t,b:o,catKey:i}=U[B],n=z[t.title]?.[i]??t.scores[i],s=z[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),r=1-a,m=e==="a"?1:0,p=1-m,l=Math.round(Math.min(100,Math.max(1,n+qe*(m-a)))),c=Math.round(Math.min(100,Math.max(1,s+qe*(p-r))));if(E[t.title]||(E[t.title]={}),E[o.title]||(E[o.title]={}),l!==n){const g=E[t.title][i]?.old??n;E[t.title][i]={old:g,new:l},z[t.title][i]=l}if(c!==s){const g=E[o.title][i]?.old??s;E[o.title][i]={old:g,new:c},z[o.title][i]=c}const v=document.getElementById(`cal-card-${e}`),d=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);v&&(v.style.opacity="1"),d&&(d.style.opacity="0.35",d.style.transform="scale(0.97)")}B++,setTimeout(()=>_e(),e==="skip"?0:140)};function eo(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(E).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ${w.map(o=>{const i=t[o.key],n=i.slice(0,3),s=i.length-3,a=i.length>0;return`<div style="padding:14px;background:var(--cream);border-radius:6px;${a?"":"opacity:0.45"}">
          ...
          ${n.map((r,m)=>{const p=r.new>r.old?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;${m<n.length-1?"border-bottom:1px solid var(--rule)":""}">
              <input type="checkbox" id="caldiff_${r.idx}" checked style="flex-shrink:0;accent-color:var(--blue);width:14px;height:14px"
                data-movie-idx="${u.findIndex(l=>l.title===r.title)}" data-cat="${r.catKey}" data-old="${r.old}" data-new="${r.new}">
    ...
    `;else if(typeof x=="number"){const t=oo[x],o=Math.round(x/6*100),i=x===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;line-height:1.8;color:var(--dim);margin-bottom:28px;font-style:italic">The films you're drawn to reveal something consistent about you — a set of values, sensitivities, and hungers that show up again and again. A few questions to surface them.</div>`:"";e.innerHTML=`
      ...
      ${t.options.map(n=>`
        <div class="ob-option ${X[x]===n.key?"selected":""}" onclick="obSelectAnswer(${x}, '${n.key}', this)">
      ...
      <div class="ob-nav">
        ...
        <button class="ob-btn-primary" id="ob-next-btn" onclick="obNext()" ${X[x]?"":"disabled"}>
          ${x===5?"See my archetype →":"Next →"}
        </button>
      </div>
    `}else if(x==="reveal"){const t=io(X);L=t,L._slug||(L._slug=pe.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"user");const o=Z[t.primary],i=o.palette||"#3d5a80";e.innerHTML=`
  ...
  </div>`}function st(e){T[e]&&(T[e].checked=!T[e].checked);const t=document.getElementById("castItem_"+e),o=T[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function at(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,oe.slice(8,20).forEach(i=>{T[i.id]||(T[i.id]={actor:i,checked:!1})});const o=oe.slice(0,20);nt(o),e.textContent="+ More cast",e.disabled=!1,oe.length<=20&&(e.style.display="none")}function ao(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
  ...
  </div>`}function rt(e){W[e].checked=!W[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(W[e].checked?"checked":"unchecked")}function lt(){se=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function ct(){const e=y._allDirectors||[],t=y._allWriters||[],o=Object.values(T).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(W).filter(n=>n.checked).map(n=>n.company.name);y.title=y._tmdbDetail.title,y.director=e.join(", "),y.writer=t.join(", "),y.cast=o.join(", "),y.productionCompanies=i.join(", "),co(),de(2)}let se=null;function ro(e){se=e}function lo(e){const t=[...u].filter(s=>s.scores[e]!=null).sort((s,a)=>a.scores[e]-s.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),n=new Set;return i.filter(s=>n.has(s.title)?!1:(n.add(s.title),!0))}function co(){const e=document.getElementById("calibrationCategories");e.innerHTML=w.map(t=>{const o=lo(t.key),i=se?.[t.key]??y.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
      ...
      <div class="slider-section">
        <div class="slider-label-row">
          ...
          <div>
            ...
            <span class="slider-desc" id="sliderDesc_${t.key}" style="margin-left:8px">${Y(i)}</span>
          </div>
        </div>
    ...
    </div>`}).join(""),w.forEach(t=>{y.scores[t.key]=se?.[t.key]??y.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(s=>s.classList.remove("selected")),o.classList.add("selected");const i=y.scores[e]??50,n=Math.round((i+t)/2);document.getElementById("slider_"+e).value=n,updateSlider(e,n)};window.updateSlider=function(e,t){t=parseInt(t),y.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=Y(t)};function dt(){po(),de(3)}let H=[],j=0,ae=[];function po(){H=[],ae=[],w.forEach(e=>{const t=y.scores[e.key];if(!t)return;u.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,n)=>Math.abs(i.scores[e.key]-t)-Math.abs(n.scores[e.key]-t)).slice(0,1).forEach(i=>H.push({cat:e,film:i}))}),H=H.slice(0,6),j=0,be()}function be(){const e=document.getElementById("hthContainer");if(H.length===0||j>=H.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
      No close comparisons needed — your scores are clearly differentiated. Click Continue.
    </div>`;return}const{cat:t,film:o}=H[j],i=y.scores[t.key];e.innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
      Comparison ${j+1} of ${H.length} &nbsp;·&nbsp; ${t.label} (×${t.weight})
    </div>
    ...
    <div class="hth-row">
      <div class="hth-card" onclick="hthChoice('new', '${t.key}', ${o.scores[t.key]})">
        ...
        <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);margin-top:4px">${Y(i)}</div>
      </div>
      ...
      <div class="hth-card" onclick="hthChoice('existing', '${t.key}', ${o.scores[t.key]})">
        ...
        <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);margin-top:4px">${Y(o.scores[t.key])}</div>
      </div>
    </div>
    <div style="display:flex;justify-content:center;align-items:center;gap:24px;margin-top:4px">
      ${j>0?'<span class="hth-skip" onclick="hthUndo()">← Undo</span>':""}
      <span class="hth-skip" onclick="hthSkip()">They're equal / skip this one</span>
    </div>
  `}window.hthChoice=function(e,t,o){ae.push({idx:j,scores:{...y.scores}});const i=y.scores[t];e==="new"&&i<=o?y.scores[t]=o+1:e==="existing"&&i>=o&&(y.scores[t]=o-1),j++,be()};window.hthSkip=function(){ae.push({idx:j,scores:{...y.scores}}),j++,be()};window.hthUndo=function(){if(ae.length===0)return;const e=ae.pop();j=e.idx,y.scores=e.scores,be()};function pt(){mo(),de(4)}function mo(){const e=G(y.scores);y.total=e;const t=[...u,y].sort((i,n)=>n.total-i.total),o=t.indexOf(y)+1;document.getElementById("resultCard").innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
    ...
    <div class="result-label">${Y(e)}</div>
    <div class="result-grid">
      ${w.map(i=>`
        <div class="result-cat">
          <div class="result-cat-name">${i.label} ×${i.weight}</div>
          <div class="result-cat-val ${V(y.scores[i.key]||0)}">${y.scores[i.key]||"—"}</div>
        </div>`).join("")}
    </div>
  ...
  `}function mt(){y.total=G(y.scores),u.push({title:y.title,year:y.year,total:y.total,director:y.director,writer:y.writer,cast:y.cast,productionCompanies:y.productionCompanies||"",poster:y._tmdbDetail?.poster_path||null,overview:y._tmdbDetail?.overview||"",scores:{...y.scores}}),F(),S(()=>Promise.resolve().then(()=>ee),void 0).then(e=>e.updateStorageStatus()),y={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},T={},W={},oe=[],se=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",de(1),O(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const fo=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:ct,goToStep:tt,goToStep3:dt,goToStep4:pt,liveSearch:ot,prefillWithPrediction:ro,resetToSearch:lt,saveFilm:mt,showMoreCast:at,tmdbSelect:it,toggleCast:st,toggleCompany:rt},Symbol.toStringTag,{value:"Module"}));function yo(){if(!b){S(()=>Promise.resolve().then(()=>so),void 0).then(e=>e.launchOnboarding());return}ft()}function ft(){if(!b)return;const e=b.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function yt(e,t){const o=w.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const s=document.getElementById("awbar_"+n.key);s&&(s.style.width=Math.round(n.val/i*100)+"%")})}function uo(){if(!b||!b.archetype)return;const e=Z[b.archetype]?.weights;e&&(w.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),yt())}function vo(){const e={};w.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),b.weights=e,S(()=>Promise.resolve().then(()=>Ve),void 0).then(t=>t.saveUserLocally()),le(),O(),F(),ut()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ut(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const _=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],vt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},go={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function ho(e,t,o=220){const i=_.length,n=o/2,s=o/2,a=o*.36,r=k=>k/i*Math.PI*2-Math.PI/2,m=(k,D)=>({x:n+a*D*Math.cos(r(k)),y:s+a*D*Math.sin(r(k))}),p=[.25,.5,.75,1].map(k=>`<polygon points="${_.map(($,J)=>`${m(J,k).x},${m(J,k).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),l=_.map((k,D)=>{const $=m(D,1);return`<line x1="${n}" y1="${s}" x2="${$.x}" y2="${$.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),c=Math.max(..._.map(k=>e[k]||1)),d=`<polygon points="${_.map((k,D)=>{const $=m(D,(e[k]||1)/c);return`${$.x},${$.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let g="";if(t){const k=Math.max(..._.map($=>t[$]||1));g=`<polygon points="${_.map(($,J)=>{const Ae=m(J,(t[$]||1)/k);return`${Ae.x},${Ae.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const f=_.map((k,D)=>{const $=m(D,(e[k]||1)/c);return`<circle cx="${$.x}" cy="${$.y}" r="2.5" fill="var(--blue)"/>`}).join(""),h=22,M=_.map((k,D)=>{const $=m(D,1+h/a),J=$.x<n-5?"end":$.x>n+5?"start":"middle";return`<text x="${$.x}" y="${$.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${J}" dominant-baseline="middle">${go[k]}</text>`}).join(""),N=36;return`<svg width="${o+N*2}" height="${o+N*2}" viewBox="${-N} ${-N} ${o+N*2} ${o+N*2}" style="overflow:visible;display:block">
    ${p}${l}${g}${d}${f}${M}
  </svg>`}function xo(e){return e.length?_.map(t=>{const o=e.filter(a=>a.scores?.[t]!=null),i=o.length?o.reduce((a,r)=>a+r.scores[t],0)/o.length:null,n=i!=null?i.toFixed(1):"—",s=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);width:88px;flex-shrink:0">${vt[t]}</div>
      <div style="flex:1;height:2px;background:var(--rule);position:relative;overflow:hidden">
      ...
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:white;padding:4px 11px 3px;background:${bo(o.total)};border-radius:4px;flex-shrink:0">${s}</div>
      </div>
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function ko(e,t){const o=[...t].sort((s,a)=>a.total-s.total).slice(0,3),i=t.length?(t.reduce((s,a)=>s+a.total,0)/t.length).toFixed(1):"—",n=Z[e.archetype]||{};return`
  ...
  `}function Be(){const e=document.getElementById("profileContent");if(!e)return;const t=b;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=Z[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=u,a=_.map(p=>{const l=s.filter(c=>c.scores?.[p]!=null);return{c:p,avg:l.length?l.reduce((c,v)=>c+v.scores[p],0)/l.length:0}}),r=s.length?[...a].sort((p,l)=>l.avg-p.avg)[0]:null,m=s.length?(s.reduce((p,l)=>p+l.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin-top:24px;border-top:2px solid var(--ink)">
          ...
          <div style="padding:16px 20px;border-right:1px solid var(--rule)">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:40px;color:var(--ink);line-height:1;letter-spacing:-1px">${m}</div>
          </div>
          ${r?`<div style="padding:16px 0 16px 20px">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:32px;color:var(--blue);line-height:1;letter-spacing:-1px">${vt[r.c]}</div>
          </div>`:""}
        </div>`:""}
      </div>
  ...
  `}function gt(e){document.querySelectorAll(".screen").forEach(t=>t.classList.remove("active")),document.getElementById(e).classList.add("active"),document.querySelectorAll(".nav-btn").forEach(t=>t.classList.remove("active")),event.target.classList.add("active"),e==="analysis"&&Ke(),e==="calibration"&&Ce(),e==="explore"&&he(),e==="predict"&&Qe(),e==="profile"&&Be(),localStorage.setItem("ledger_last_screen",e)}function ze(){const e=document.getElementById("storageStatus");e&&(u.length>0?(e.textContent=`✓ ${u.length} films · saved`,e.style.color="var(--green)"):(e.textContent="no films yet",e.style.color="var(--dim)"))}function Te(){const e=b;if(!e)return;const t=document.getElementById("mastheadLeft");t.innerHTML=`<span class="profile-chip" onclick="document.getElementById('nav-profile').click()">
    <strong style="color:var(--ink);font-family:'DM Mono',monospace;font-size:11px;letter-spacing:0.5px">${e.display_name}</strong>
  </span>`}function ht(){const e=new Blob([JSON.stringify(u,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="film_rankings.json",t.click()}function xt(){confirm("Clear all your films and start fresh? This cannot be undone.")&&(localStorage.removeItem("filmRankings_v1"),localStorage.removeItem("ledger_user"),location.reload())}function bt(){const e=document.getElementById("cold-landing");e?e.style.display="flex":xe()}window.startFromLanding=function(){const e=document.getElementById("cold-landing");e&&(e.style.display="none"),xe()};async function $o(){Bt(),Ct(),Ye(),b?(ie("syncing"),Te(),le(),We(b.id).catch(()=>ie("error"))):(ie("local"),setTimeout(()=>bt(),400)),O(),ze();const e=localStorage.getItem("ledger_last_screen");if(e&&e!=="rankings"&&document.getElementById(e)){const t=document.querySelectorAll(".nav-btn");t.forEach(o=>o.classList.remove("active")),document.querySelectorAll(".screen").forEach(o=>o.classList.remove("active")),document.getElementById(e).classList.add("active"),t.forEach(o=>{o.getAttribute("onclick")?.includes(e)&&o.classList.add("active")}),e==="analysis"&&Ke(),e==="explore"&&he(),e==="profile"&&Be()}}function ie(e){const t=document.getElementById("cloudDot"),o=document.getElementById("cloudLabel");t.className="cloud-dot",e==="syncing"?(t.classList.add("syncing"),o.textContent="syncing…"):e==="synced"?(t.classList.add("synced"),o.textContent=b?b.display_name:"synced"):e==="error"?(t.classList.add("error"),o.textContent="offline"):o.textContent="local"}window.__ledger={showScreen:gt,sortBy:He,openModal:Lt,closeModal:Pt,exploreEntity:qt,renderExploreIndex:he,initPredict:Qe,predictSearch:Xe,predictSearchDebounce:Ht,predictSelectFilm:Ft,predictAddToList:Gt,startCalibration:Zt,selectCalCat:Kt,selectCalInt:Qt,applyCalibration:to,resetCalibration:Ce,launchOnboarding:xe,liveSearch:ot,tmdbSelect:it,toggleCast:st,showMoreCast:at,toggleCompany:rt,resetToSearch:lt,confirmTmdbData:ct,goToStep3:dt,goToStep4:pt,saveFilm:mt,goToStep:tt,renderProfile:Be,setViewMode:Re,showSyncPanel:yo,openArchetypeModal:ft,closeArchetypeModal:ut,previewWeight:yt,resetArchetypeWeights:uo,saveArchetypeWeights:vo,exportData:ht,resetStorage:xt,updateStorageStatus:ze,updateMastheadProfile:Te,setCloudStatus:ie};const Mo=["showScreen","sortBy","openModal","closeModal","exploreEntity","renderExploreIndex","initPredict","predictSearch","predictSearchDebounce","predictSelectFilm","predictAddToList","startCalibration","selectCalCat","selectCalInt","applyCalibration","resetCalibration","launchOnboarding","liveSearch","tmdbSelect","toggleCast","showMoreCast","toggleCompany","resetToSearch","confirmTmdbData","goToStep3","goToStep4","saveFilm","goToStep","renderProfile","setViewMode","showSyncPanel","openArchetypeModal","closeArchetypeModal","previewWeight","resetArchetypeWeights","saveArchetypeWeights","exportData","resetStorage"];Mo.forEach(e=>{window[e]=window.__ledger[e]});$o();const ee=Object.freeze(Object.defineProperty({__proto__:null,exportData:ht,resetStorage:xt,setCloudStatus:ie,showColdLanding:bt,showScreen:gt,updateMastheadProfile:Te,updateStorageStatus:ze},Symbol.toStringTag,{value:"Module"}));export{w as C,u as M,b as c};
