(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const b=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],x=null;function fe(e){x=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const bt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function I(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function V(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of bt)if(e>=t)return o;return"Unwatchable"}function J(e){let t=0,o=0;for(const i of b)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function re(){y.forEach(e=>{e.total=J(e.scores)})}function G(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function le(){if(!x||!x.weights)return;const e=x.weights;b.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),re()}let L={key:"total",dir:"desc"},Se="grid";const wt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function kt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function $t(){const{key:e,dir:t}=L;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Re(e){Se=e,q()}function He(e){L.key===e?L.dir=L.dir==="desc"?"asc":"desc":(L.key=e,L.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=L.dir==="desc"?"↓":"↑")}q()}function q(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    <div style="margin-bottom:20px">
      ...
      ${l?`<div style="display:flex;align-items:flex-start;gap:8px;margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);min-width:44px;flex-shrink:0;padding-top:5px">Wri.</span><div style="display:flex;flex-wrap:wrap;gap:4px">${l}</div></div>`:""}
      ...
      ${p?`<div style="display:flex;align-items:flex-start;gap:8px;margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);min-width:44px;flex-shrink:0;padding-top:5px">Prod.</span><div style="display:flex;flex-wrap:wrap;gap:4px">${p}</div></div>`:""}
    </div>
  ...
  `,qt(e,t,s)}async function qt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:n}=await _(async()=>{const{getEntityInsight:a}=await import("./insights-CbOcL6R3.js");return{getEntityInsight:a}},[]),s=await n(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const s=document.getElementById("explore-insight");s&&(s.style.display="none")}}function De(){const e=i=>i.length?Math.round(i.reduce((n,s)=>n+s,0)/i.length*100)/100:null,t=b.map(i=>{const n=y.map(s=>s.scores[i.key]).filter(s=>s!=null);return{...i,avg:e(n)}});function o(i){return i>=90?"#C4922A":i>=80?"#1F4A2A":i>=70?"#4A5830":i>=60?"#6B4820":"rgba(12,11,9,0.65)"}document.getElementById("analysisContent").innerHTML=`
...
Respond with this exact JSON structure:
{
  ...
  `}function Vt(){Q&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Q.title,_(()=>Promise.resolve().then(()=>mo),void 0).then(t=>{$e?.predicted_scores&&t.prefillWithPrediction($e.predicted_scores),t.liveSearch(Q.title)}))},100))}let te="all",Xe="focused",W=[],T=0,S={},A={},ne=[];const Gt={focused:15,thorough:30,deep:50},qe=8;function Jt(e){te=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Kt(e){Xe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Qt(e,t){const o=[];(e==="all"?b.map(a=>a.key):[e]).forEach(a=>{const r=y.filter(l=>l.scores[a]!=null).sort((l,c)=>l.scores[a]-c.scores[a]);for(let l=0;l<r.length-1;l++)for(let c=l+1;c<r.length;c++){const p=Math.abs(r[l].scores[a]-r[c].scores[a]);if(p<=8)o.push({a:r[l],b:r[c],catKey:a,diff:p});else break}}),o.sort((a,r)=>a.diff-r.diff);const n=new Set,s=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");n.has(r)||(n.add(r),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Xt(){const e=Gt[Xe];if(W=Qt(te,e),W.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}T=0,S={},A={},ne=[],y.forEach(t=>{A[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=te==="all"?"All categories":b.find(t=>t.key===te)?.label||te,Ce()}function Ce(){if(T>=W.length){Zt();return}const{a:e,b:t,catKey:o}=W[T],i=W.length,n=Math.round(T/i*100);document.getElementById("cal-progress-label").textContent=`${T+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=b.find(l=>l.key===o)?.label||o;A[e.title]?.[o]??e.scores[o],A[t.title]?.[o]??t.scores[o];function a(l,c){const p=l.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${l.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(ne.length===0)return;const e=ne.pop();T=e.idx,A=e.tempScores,S=e.deltas,Ce()};window.calChoose=function(e){if(ne.push({idx:T,tempScores:JSON.parse(JSON.stringify(A)),deltas:JSON.parse(JSON.stringify(S))}),e!=="skip"){const{a:t,b:o,catKey:i}=W[T],n=A[t.title]?.[i]??t.scores[i],s=A[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),r=1-a,l=e==="a"?1:0,c=1-l,p=Math.round(Math.min(100,Math.max(1,n+qe*(l-a)))),f=Math.round(Math.min(100,Math.max(1,s+qe*(c-r))));if(S[t.title]||(S[t.title]={}),S[o.title]||(S[o.title]={}),p!==n){const m=S[t.title][i]?.old??n;S[t.title][i]={old:m,new:p},A[t.title][i]=p}if(f!==s){const m=S[o.title][i]?.old??s;S[o.title][i]={old:m,new:f},A[o.title][i]=f}const w=document.getElementById(`cal-card-${e}`),g=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);w&&(w.style.opacity="1"),g&&(g.style.opacity="0.35",g.style.transform="scale(0.97)")}T++,setTimeout(()=>Ce(),e==="skip"?0:140)};function Zt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(S).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
  ...
  `}function Te(){const e=document.getElementById("profileContent");if(!e)return;const t=x;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=Z[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=y,a=C.map(c=>{const p=s.filter(f=>f.scores?.[c]!=null);return{c,avg:p.length?p.reduce((f,w)=>f+w.scores[c],0)/p.length:0}}),r=s.length?[...a].sort((c,p)=>p.avg-c.avg)[0]:null,l=s.length?(s.reduce((c,p)=>c+p.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
