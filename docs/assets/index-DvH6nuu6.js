(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const b=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],x=null;function fe(e){x=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const bt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function I(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function V(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of bt)if(e>=t)return o;return"Unwatchable"}function J(e){let t=0,o=0;for(const i of b)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function re(){y.forEach(e=>{e.total=J(e.scores)})}function G(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function le(){if(!x||!x.weights)return;const e=x.weights;b.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),re()}let L={key:"total",dir:"desc"},Se="grid";const wt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function kt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function $t(){const{key:e,dir:t}=L;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Re(e){Se=e,q()}function He(e){L.key===e?L.dir=L.dir==="desc"?"asc":"desc":(L.key=e,L.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=L.dir==="desc"?"↓":"↑")}q()}function q(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
  ...
  </div>`}function Mt(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Fe("grid"));const n=["total","rank","title"].includes(L.key)?"total":L.key,s=[...y].sort((r,l)=>l.total-r.total),a=new Map(s.map((r,l)=>[r.title,l+1]));t.innerHTML=`<div class="film-grid">
    ${e.map(r=>{const l=n==="total"?r.total:r.scores?.[n]??null,c=l!=null?n==="total"?(Math.round(l*10)/10).toFixed(1):l:"—",p=kt(l),f=r.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${r.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${y.indexOf(r)})">
  ...
  </div>`}function Et(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Fe("table"));const n=[...y].sort((a,r)=>r.total-a.total),s=new Map(n.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,l=s.get(a.title),c=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",p=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${y.indexOf(a)})">
      <div class="film-poster-cell">${p}</div>
      <div class="film-rank">${l}</div>
      ...
      ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(f=>`<div class="film-score ${r[f]?G(r[f]):""}">${r[f]??"—"}</div>`).join("")}
      <div class="film-total">${c}</div>
    </div>`}).join("")}const St=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:q,setViewMode:Re,sortBy:He},Symbol.toStringTag,{value:"Module"})),It="modulepreload",_t=function(e){return"/"+e},je={},_=function(t,o,i){let n=Promise.resolve();if(o&&o.length>0){let l=function(c){return Promise.all(c.map(p=>Promise.resolve(p).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=a?.nonce||a?.getAttribute("nonce");n=l(o.map(c=>{if(c=_t(c),c in je)return;je[c]=!0;const p=c.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${f}`))return;const w=document.createElement("link");if(w.rel=p?"stylesheet":It,p||(w.as="script"),w.crossOrigin="",w.href=c,r&&w.setAttribute("nonce",r),document.head.appendChild(w),p)return new Promise((g,m)=>{w.addEventListener("load",g),w.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return n.then(a=>{for(const r of a||[])r.status==="rejected"&&s(r.reason);return t().catch(s)})},Pe="palate_migrations_v1";function Ct(){let e;try{e=JSON.parse(localStorage.getItem(Pe)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;y.forEach(o=>{const i=I((o.cast||"").split(",").map(s=>s.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const n=I((o.productionCompanies||"").split(",").map(s=>s.trim()).filter(Boolean)).join(", ");n!==(o.productionCompanies||"")&&(o.productionCompanies=n,t++)}),t>0&&(F(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(Pe,JSON.stringify(e))}catch{}}}const Ue="filmRankings_v1";function F(){try{localStorage.setItem(Ue,JSON.stringify(y))}catch(e){console.warn("localStorage save failed:",e)}x&&(clearTimeout(F._syncTimer),F._syncTimer=setTimeout(()=>{_(()=>Promise.resolve().then(()=>Ve),void 0).then(e=>e.syncToSupabase())},2e3))}function Dt(){try{const e=localStorage.getItem(Ue);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;ue(t),console.log(`Loaded ${y.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const Bt="https://gzuuhjjedrzeqbgxhfip.supabase.co",At="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ye=window.supabase.createClient(Bt,At);async function Ie(){const e=x;if(!e)return;const{setCloudStatus:t}=await _(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>ee);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ye.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:y,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),ce()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function We(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await _(async()=>{const{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}=await Promise.resolve().then(()=>ee);return{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}},void 0),{renderRankings:n}=await _(async()=>{const{renderRankings:s}=await Promise.resolve().then(()=>St);return{renderRankings:s}},void 0);t("syncing");try{const{data:s,error:a}=await ye.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;if(s){if(fe({id:s.id,username:s.username,display_name:s.display_name,archetype:s.archetype,archetype_secondary:s.archetype_secondary,weights:s.weights,harmony_sensitivity:s.harmony_sensitivity}),s.movies&&Array.isArray(s.movies)&&s.movies.length>=y.length){const r=s.movies.map(l=>({...l,cast:I((l.cast||"").split(",").map(c=>c.trim()).filter(Boolean)).join(", "),productionCompanies:I((l.productionCompanies||"").split(",").map(c=>c.trim()).filter(Boolean)).join(", ")}));ue(r)}ce(),le(),t("synced"),o(),n(),i()}}catch(s){console.warn("Supabase load error:",s),t("error")}}function ce(){try{localStorage.setItem("ledger_user",JSON.stringify(x))}catch{}}function Ye(){try{const e=localStorage.getItem("ledger_user");e&&fe(JSON.parse(e))}catch{}}const Ve=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:We,loadUserLocally:Ye,saveUserLocally:ce,sb:ye,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),Tt=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function be(e){for(const[t,o]of Tt)if(e>=t)return o;return"Unwatchable"}let ge=null,B=!1,O={};function zt(e){ge=e,B=!1,O={},ve()}function ve(){const e=ge,t=y[e],o=[...y].sort((d,v)=>v.total-d.total),i=o.indexOf(t)+1,n=o.filter(d=>d!==t&&Math.abs(d.total-t.total)<6).slice(0,5),s={};b.forEach(d=>{const v=[...y].sort((k,E)=>(E.scores[d.key]||0)-(k.scores[d.key]||0));s[d.key]=v.indexOf(t)+1});const a=(d,v,k)=>`<span class="modal-meta-chip" onclick="exploreEntity('${v}','${k.replace(/'/g,"'")}')">${d}</span>`,r=I((t.director||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"director",d)).join(""),l=I((t.writer||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"writer",d)).join("");window.__debugCast=t.cast,window.__debugCastArr=(t.cast||"").split(",").map(d=>d.trim()).filter(Boolean),window.__debugMerged=I(window.__debugCastArr);const c=window.__debugMerged.map(d=>a(d,"actor",d)).join(""),p=I((t.productionCompanies||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"company",d)).join(""),f=t.poster?`<div style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,w=B?O:t.scores,g=B?J(O):t.total,m=b.map(d=>{const v=w[d.key],k=s[d.key];return B?`<div class="breakdown-row" style="align-items:center;gap:12px">
        ...
        <div class="breakdown-bar-wrap" style="flex:1">
          <input type="range" min="1" max="100" value="${v||50}"
            ...
            oninput="modalUpdateScore('${d.key}', this.value)">
        </div>
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${G(v||50)}" id="modal-edit-val-${d.key}">${v||50}</div>
          <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${d.key}">${be(v||50)}</div>
        </div>
      ...
      <div class="breakdown-val ${v?G(v):""}">${v??"—"}</div>
      <div class="breakdown-wt">×${d.weight}</div>
      <div class="modal-cat-rank">#${k}</div>
    ...
    <div style="margin-bottom:20px">
      ...
      ${l?`<div style="margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);margin-right:8px">Wri.</span>${l}</div>`:""}
    ...
    <div style="display:flex;align-items:baseline;gap:12px;margin-bottom:8px">
      ...
      <span style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)" id="modal-total-label">${V(g)}</span>
    </div>
    ...
    <div>${m}</div>
    ${!B&&n.length>0?`<div class="compare-section">
      <div class="compare-title">Nearby in the rankings</div>
      ${n.map(d=>{const v=(d.total-t.total).toFixed(2),k=v>0?"+":"";return`<div class="compare-film" style="cursor:pointer" onclick="closeModal();openModal(${y.indexOf(d)})">
          ...
          <div class="compare-diff ${v>0?"diff-pos":"diff-neg"}">${k}${v}</div>
        </div>`}).join("")}
    </div>`:""}
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),B||Lt(t)}window.modalEnterEdit=function(){const e=y[ge];B=!0,O={...e.scores},ve()};window.modalCancelEdit=function(){B=!1,O={},ve()};window.modalUpdateScore=function(e,t){O[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${G(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=be(parseInt(t)));const n=J(O),s=document.getElementById("modal-total-display");s&&(s.textContent=n);const a=document.getElementById("modal-total-label");a&&(a.textContent=be(n))};window.modalSaveScores=function(){const e=y[ge];e.scores={...O},e.total=J(O),B=!1,O={},re(),F(),q(),Ie().catch(t=>console.warn("sync failed",t)),ve()};async function Lt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await _(async()=>{const{getFilmInsight:n}=await import("./insights-VkB0uNYM.js");return{getFilmInsight:n}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function jt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let U="directors";function R(e){return I((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Pt(e){const t={};return y.forEach(o=>{let i=[];e==="directors"?i=R(o.director):e==="writers"?i=R(o.writer):e==="actors"?i=R(o.cast):e==="companies"?i=R(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(n=>{t[n]||(t[n]=[]),t[n].push(o)})}),t}function Ge(e){const t=Pt(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((n,s)=>n+s.total,0)/i.length).toFixed(1)),catAvgs:b.reduce((n,s)=>{const a=i.filter(r=>r.scores[s.key]!=null).map(r=>r.scores[s.key]);return n[s.key]=a.length?parseFloat((a.reduce((r,l)=>r+l,0)/a.length).toFixed(1)):null,n},{})})).sort((o,i)=>i.avg-o.avg)}function Je(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function _e(e){e&&(U=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ge(U),n=document.getElementById("explore-section");n&&(n.innerHTML=`
    <div class="explore-tabs" style="margin-bottom:24px">
      ${t.map(s=>`<button class="explore-tab ${s===U?"active":""}" onclick="renderExploreIndex('${s}')">${o[s]}</button>`).join("")}
    </div>
    ${i.length===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim);font-style:italic;padding:48px 0">Not enough data yet — add more films to see patterns.</div>`:i.map((s,a)=>{const r=s.name.replace(/'/g,"\\'");return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule);cursor:pointer" onclick="exploreEntity('${U==="companies"?"company":U==="years"?"year":U.slice(0,-1)}','${r}')" onmouseover="this.style.background='var(--cream)'" onmouseout="this.style.background=''">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:17px;color:white;padding:4px 11px 3px;background:${Je(s.avg)};border-radius:4px;flex-shrink:0">${s.avg.toFixed(1)}</div>
          </div>`}).join("")}
  `)}function Ot(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";U=i;const n=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",s=y.filter(m=>e==="director"?R(m.director).includes(t):e==="writer"?R(m.writer).includes(t):e==="actor"?R(m.cast).includes(t):e==="company"?R(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,d)=>d.total-m.total);if(s.length===0){_e();return}const a=Ge(i),r=a.findIndex(m=>m.name===t)+1,l=a.length,c=a.find(m=>m.name===t),p=c?c.avg.toFixed(1):(s.reduce((m,d)=>m+d.total,0)/s.length).toFixed(1);s[0];const f={};b.forEach(m=>{const d=a.filter(k=>k.catAvgs[m.key]!=null).sort((k,E)=>E.catAvgs[m.key]-k.catAvgs[m.key]),v=d.findIndex(k=>k.name===t)+1;f[m.key]=v>0?{rank:v,total:d.length}:null});const g=b.map(m=>{const d=s.filter(v=>v.scores[m.key]!=null).map(v=>v.scores[m.key]);return{...m,avg:d.length?parseFloat((d.reduce((v,k)=>v+k,0)/d.length).toFixed(1)):null}}).filter(m=>m.avg!=null).sort((m,d)=>d.avg-m.avg);g[0],g[g.length-1],document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:800px">
      ...
      <div style="background:var(--surface-dark);margin:-40px -56px 32px;padding:40px 56px 32px">
        ...
        <div style="display:flex;align-items:baseline;gap:20px;flex-wrap:wrap">
          ...
          <div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--on-dark-dim)">#${r} of ${l} ${i}</div>
      ...
      ${g.length>0?`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 40px;margin-bottom:32px">
          ${g.map(m=>{const d=f[m.key];return`<div style="border-bottom:1px solid var(--rule);padding:10px 0">
              <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:6px">
                <div style="font-family:'DM Mono',monospace;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:var(--dim)">${m.label}</div>
                <div style="display:flex;align-items:baseline;gap:8px">
                  ${d?`<div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim)">#${d.rank}</div>`:""}
                  <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:var(--ink)">${m.avg.toFixed(1)}</div>
                </div>
              </div>
              <div style="height:2px;background:var(--rule);border-radius:1px">
                <div style="height:2px;width:${m.avg}%;background:${Je(m.avg)};border-radius:1px"></div>
              </div>
            </div>`}).join("")}
        </div>
      `:""}
      ...
      ${s.map((m,d)=>{const v=m.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${m.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',k=m.total!=null?(Math.round(m.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${y.indexOf(m)})" style="cursor:pointer">
          ...
          ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(E=>`<div class="film-score ${m.scores[E]?G(m.scores[E]):"}"}">${m.scores[E]??"—"}</div>`).join("")}
          <div class="film-total">${k}</div>
        </div>`}).join("")}
    </div>
  `,qt(e,t,s)}async function qt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:n}=await _(async()=>{const{getEntityInsight:a}=await import("./insights-VkB0uNYM.js");return{getEntityInsight:a}},[]),s=await n(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const s=document.getElementById("explore-insight");s&&(s.style.display="none")}}function Ce(){const e=i=>i.length?Math.round(i.reduce((n,s)=>n+s,0)/i.length*100)/100:null,t=b.map(i=>{const n=y.map(s=>s.scores[i.key]).filter(s=>s!=null);return{...i,avg:e(n)}});function o(i){return i>=90?"#C4922A":i>=80?"#1F4A2A":i>=70?"#4A5830":i>=60?"#6B4820":"rgba(12,11,9,0.65)"}document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:900px">
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px 40px">
          ${t.filter(i=>i.avg!=null&&!isNaN(i.avg)).map(i=>{const n=Math.round(i.avg),s=o(i.avg);return`
            <div style="display:flex;align-items:center;gap:12px;padding:6px 0">
              <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);width:88px;flex-shrink:0">${i.label}</div>
              <div style="flex:1;height:2px;background:var(--rule);position:relative;overflow:hidden">
                <div style="position:absolute;top:0;left:0;height:100%;background:${s};width:${n}%"></div>
              </div>
              <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:var(--ink);width:36px;text-align:right;letter-spacing:-0.5px">${i.avg}</div>
            </div>`}).join("")}
        </div>
      </div>
  ...
  `,_e()}const we="f5a446a5f70a9f6a16a8ddd052c121f2",ke="https://api.themoviedb.org/3",Nt="https://ledger-proxy.noahparikhcott.workers.dev";let Oe=null,Q=null,$e=null;function Ke(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",Q=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function Rt(){clearTimeout(Oe),Oe=setTimeout(Qe,500)}async function Qe(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const n=((await(await fetch(`${ke}/search/movie?api_key=${we}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!n.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const s=new Set(y.map(a=>a.title.toLowerCase()));t.innerHTML=n.map(a=>{const r=a.release_date?.slice(0,4)||"",l=a.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${a.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',c=s.has(a.title.toLowerCase());return`<div class="tmdb-result ${c?"opacity-50":""}" onclick="${c?"":`predictSelectFilm(${a.id}, '${a.title.replace(/'/g,"\\'")}', '${r}')`}" style="${c?"opacity:0.4;cursor:default":""}">
        ${l}
    ...
    </div>`;let i={},n={};try{const[f,w]=await Promise.all([fetch(`${ke}/movie/${e}?api_key=${we}`),fetch(`${ke}/movie/${e}/credits?api_key=${we}`)]);i=await f.json(),n=await w.json()}catch{}const s=(n.crew||[]).filter(f=>f.job==="Director").map(f=>f.name).join(", "),a=(n.crew||[]).filter(f=>["Screenplay","Writer","Story"].includes(f.job)).map(f=>f.name).slice(0,2).join(", "),r=(n.cast||[]).slice(0,8).map(f=>f.name).join(", "),l=(i.genres||[]).map(f=>f.name).join(", "),c=i.overview||"",p=i.poster_path||null;Q={tmdbId:e,title:t,year:o,director:s,writer:a,cast:r,genres:l,overview:c,poster:p},await Wt(Q)}function Ft(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(a=>{const r=y.filter(p=>p.scores[a]!=null).map(p=>p.scores[a]);if(!r.length){t[a]={mean:70,std:10,min:0,max:100};return}const l=r.reduce((p,f)=>p+f,0)/r.length,c=Math.sqrt(r.reduce((p,f)=>p+(f-l)**2,0)/r.length);t[a]={mean:Math.round(l*10)/10,std:Math.round(c*10)/10,min:Math.min(...r),max:Math.max(...r)}});const o=[...y].sort((a,r)=>r.total-a.total),i=o.slice(0,10).map(a=>`${a.title} (${a.total})`).join(", "),n=o.slice(-5).map(a=>`${a.title} (${a.total})`).join(", "),s=b.map(a=>`${a.label}×${a.weight}`).join(", ");return{stats:t,top10:i,bottom5:n,weightStr:s,archetype:x?.archetype,archetypeSecondary:x?.archetype_secondary,totalFilms:y.length}}function Ut(e){const t=I((e.director||"").split(",").map(i=>i.trim()).filter(Boolean)),o=I((e.cast||"").split(",").map(i=>i.trim()).filter(Boolean));return y.filter(i=>{const n=I((i.director||"").split(",").map(a=>a.trim()).filter(Boolean)),s=I((i.cast||"").split(",").map(a=>a.trim()).filter(Boolean));return t.some(a=>n.includes(a))||o.some(a=>s.includes(a))}).sort((i,n)=>n.total-i.total).slice(0,8)}async function Wt(e){const t=Ft(),o=Ut(e),i=o.length?o.map(r=>`- ${r.title} (${r.year||""}): total=${r.total}, plot=${r.scores.plot}, execution=${r.scores.execution}, acting=${r.scores.acting}, production=${r.scores.production}, enjoyability=${r.scores.enjoyability}, rewatchability=${r.scores.rewatchability}, ending=${r.scores.ending}, uniqueness=${r.scores.uniqueness}`).join(`
`):"No direct comparisons found in rated list.",n=Object.entries(t.stats).map(([r,l])=>`${r}: mean=${l.mean}, std=${l.std}, range=${l.min}–${l.max}`).join(`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const p=((await(await fetch(Nt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:s,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),f=JSON.parse(p);$e=f,Yt(e,f,o)}catch(r){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${r.message}. Check that the proxy is running and your API key is valid.</div>`}}function Yt(e,t,o){let i=0,n=0;b.forEach(c=>{const p=t.predicted_scores[c.key];p!=null&&(i+=p*c.weight,n+=c.weight)});const s=n>0?Math.round(i/n*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,r={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",l={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-film-card">
      ...
      <div style="flex:1">
        ...
        <div style="display:flex;align-items:baseline;gap:8px">
          ...
          <div>
            <div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)">${V(s)}</div>
            <span class="predict-confidence ${r}">${l}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="predict-score-grid">
      ${b.map(c=>{const p=t.predicted_scores[c.key];return`<div class="predict-score-cell">
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(c=>{const p=(s-c.total).toFixed(1),f=p>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${y.indexOf(c)})">
  ...
  `}function Vt(){Q&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Q.title,_(()=>Promise.resolve().then(()=>mo),void 0).then(t=>{$e?.predicted_scores&&t.prefillWithPrediction($e.predicted_scores),t.liveSearch(Q.title)}))},100))}let te="all",Xe="focused",W=[],A=0,S={},T={},ne=[];const Gt={focused:15,thorough:30,deep:50},qe=8;function Jt(e){te=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Kt(e){Xe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Qt(e,t){const o=[];(e==="all"?b.map(a=>a.key):[e]).forEach(a=>{const r=y.filter(l=>l.scores[a]!=null).sort((l,c)=>l.scores[a]-c.scores[a]);for(let l=0;l<r.length-1;l++)for(let c=l+1;c<r.length;c++){const p=Math.abs(r[l].scores[a]-r[c].scores[a]);if(p<=8)o.push({a:r[l],b:r[c],catKey:a,diff:p});else break}}),o.sort((a,r)=>a.diff-r.diff);const n=new Set,s=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");n.has(r)||(n.add(r),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Xt(){const e=Gt[Xe];if(W=Qt(te,e),W.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}A=0,S={},T={},ne=[],y.forEach(t=>{T[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=te==="all"?"All categories":b.find(t=>t.key===te)?.label||te,De()}function De(){if(A>=W.length){Zt();return}const{a:e,b:t,catKey:o}=W[A],i=W.length,n=Math.round(A/i*100);document.getElementById("cal-progress-label").textContent=`${A+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=b.find(l=>l.key===o)?.label||o;T[e.title]?.[o]??e.scores[o],T[t.title]?.[o]??t.scores[o];function a(l,c){const p=l.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${l.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(ne.length===0)return;const e=ne.pop();A=e.idx,T=e.tempScores,S=e.deltas,De()};window.calChoose=function(e){if(ne.push({idx:A,tempScores:JSON.parse(JSON.stringify(T)),deltas:JSON.parse(JSON.stringify(S))}),e!=="skip"){const{a:t,b:o,catKey:i}=W[A],n=T[t.title]?.[i]??t.scores[i],s=T[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),r=1-a,l=e==="a"?1:0,c=1-l,p=Math.round(Math.min(100,Math.max(1,n+qe*(l-a)))),f=Math.round(Math.min(100,Math.max(1,s+qe*(c-r))));if(S[t.title]||(S[t.title]={}),S[o.title]||(S[o.title]={}),p!==n){const m=S[t.title][i]?.old??n;S[t.title][i]={old:m,new:p},T[t.title][i]=p}if(f!==s){const m=S[o.title][i]?.old??s;S[o.title][i]={old:m,new:f},T[o.title][i]=f}const w=document.getElementById(`cal-card-${e}`),g=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);w&&(w.style.opacity="1"),g&&(g.style.opacity="0.35",g.style.transform="scale(0.97)")}A++,setTimeout(()=>De(),e==="skip"?0:140)};function Zt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(S).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    <div style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Uncheck anything you want to keep. Nothing changes until you apply.</div>`,document.getElementById("cal-apply-btn").style.display="";const t={};b.forEach(o=>{t[o.key]=[]}),e.forEach((o,i)=>{t[o.catKey]&&t[o.catKey].push({...o,idx:i})}),document.getElementById("cal-diff-list").innerHTML=`
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ${b.map(o=>{const i=t[o.key],n=i.slice(0,3),s=i.length-3,a=i.length>0;return`<div style="padding:14px;background:var(--cream);border-radius:6px;${a?"":"opacity:0.45"}">
          ...
          ${n.map((r,l)=>{const c=r.new>r.old?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;${l<n.length-1?"border-bottom:1px solid var(--rule)":""}">
    ...
    `;else if(typeof h=="number"){const t=to[h],o=Math.round(h/6*100),i=h===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;line-height:1.8;color:var(--dim);margin-bottom:28px;font-style:italic">The films you're drawn to reveal something consistent about you — a set of values, sensitivities, and hungers that show up again and again. A few questions to surface them.</div>`:"";e.innerHTML=`
      ...
      ${t.options.map(n=>`
        <div class="ob-option ${X[h]===n.key?"selected":""}" onclick="obSelectAnswer(${h}, '${n.key}', this)">
  ...
  </div>`}function at(e){Y[e].checked=!Y[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(Y[e].checked?"checked":"unchecked")}function rt(){se=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function lt(){const e=u._allDirectors||[],t=u._allWriters||[],o=Object.values(z).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(Y).filter(n=>n.checked).map(n=>n.company.name);u.title=u._tmdbDetail.title,u.director=e.join(", "),u.writer=t.join(", "),u.cast=o.join(", "),u.productionCompanies=i.join(", "),lo(),de(2)}let se=null;function ao(e){se=e}function ro(e){const t=[...y].filter(s=>s.scores[e]!=null).sort((s,a)=>a.scores[e]-s.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),n=new Set;return i.filter(s=>n.has(s.title)?!1:(n.add(s.title),!0))}function lo(){const e=document.getElementById("calibrationCategories");e.innerHTML=b.map(t=>{const o=ro(t.key),i=se?.[t.key]??u.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
    ...
    </div>`}).join(""),b.forEach(t=>{u.scores[t.key]=se?.[t.key]??u.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(s=>s.classList.remove("selected")),o.classList.add("selected");const i=u.scores[e]??50,n=Math.round((i+t)/2);document.getElementById("slider_"+e).value=n,updateSlider(e,n)};window.updateSlider=function(e,t){t=parseInt(t),u.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=V(t)};function ct(){co(),de(3)}let H=[],P=0,ae=[];function co(){H=[],ae=[],b.forEach(e=>{const t=u.scores[e.key];if(!t)return;y.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,n)=>Math.abs(i.scores[e.key]-t)-Math.abs(n.scores[e.key]-t)).slice(0,1).forEach(i=>H.push({cat:e,film:i}))}),H=H.slice(0,6),P=0,xe()}function xe(){const e=document.getElementById("hthContainer");if(H.length===0||P>=H.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
      No close comparisons needed — your scores are clearly differentiated. Click Continue.
    </div>`;return}const{cat:t,film:o}=H[P],i=u.scores[t.key];e.innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
      Comparison ${P+1} of ${H.length} &nbsp;·&nbsp; ${t.label} (×${t.weight})
    </div>
  ...
  `}window.hthChoice=function(e,t,o){ae.push({idx:P,scores:{...u.scores}});const i=u.scores[t];e==="new"&&i<=o?u.scores[t]=o+1:e==="existing"&&i>=o&&(u.scores[t]=o-1),P++,xe()};window.hthSkip=function(){ae.push({idx:P,scores:{...u.scores}}),P++,xe()};window.hthUndo=function(){if(ae.length===0)return;const e=ae.pop();P=e.idx,u.scores=e.scores,xe()};function dt(){po(),de(4)}function po(){const e=J(u.scores);u.total=e;const t=[...y,u].sort((i,n)=>n.total-i.total),o=t.indexOf(u)+1;document.getElementById("resultCard").innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
    ...
    <div class="result-grid">
      ${b.map(i=>`
        <div class="result-cat">
          ...
          <div class="result-cat-val ${G(u.scores[i.key]||0)}">${u.scores[i.key]||"—"}</div>
        </div>`).join("")}
    </div>
  ...
  `}function pt(){u.total=J(u.scores),y.push({title:u.title,year:u.year,total:u.total,director:u.director,writer:u.writer,cast:u.cast,productionCompanies:u.productionCompanies||"",poster:u._tmdbDetail?.poster_path||null,overview:u._tmdbDetail?.overview||"",scores:{...u.scores}}),F(),_(()=>Promise.resolve().then(()=>ee),void 0).then(e=>e.updateStorageStatus()),u={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},z={},Y={},oe=[],se=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",de(1),q(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const mo=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:lt,goToStep:et,goToStep3:ct,goToStep4:dt,liveSearch:tt,prefillWithPrediction:ao,resetToSearch:rt,saveFilm:pt,showMoreCast:st,tmdbSelect:ot,toggleCast:nt,toggleCompany:at},Symbol.toStringTag,{value:"Module"}));function fo(){if(!x){_(()=>Promise.resolve().then(()=>no),void 0).then(e=>e.launchOnboarding());return}mt()}function mt(){if(!x)return;const e=x.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
    ...
    <div id="archetype-weights-form">
      ${b.map(o=>{const i=e[o.key]||1,n=Math.round(i/t*100);return`<div class="archetype-weight-row">
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function ft(e,t){const o=b.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const s=document.getElementById("awbar_"+n.key);s&&(s.style.width=Math.round(n.val/i*100)+"%")})}function uo(){if(!x||!x.archetype)return;const e=Z[x.archetype]?.weights;e&&(b.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),ft())}function yo(){const e={};b.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),x.weights=e,_(()=>Promise.resolve().then(()=>Ve),void 0).then(t=>t.saveUserLocally()),le(),q(),F(),ut()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ut(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const D=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],yt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},go={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function vo(e,t,o=220){const i=D.length,n=o/2,s=o/2,a=o*.36,r=$=>$/i*Math.PI*2-Math.PI/2,l=($,C)=>({x:n+a*C*Math.cos(r($)),y:s+a*C*Math.sin(r($))}),c=[.25,.5,.75,1].map($=>`<polygon points="${D.map((M,K)=>`${l(K,$).x},${l(K,$).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),p=D.map(($,C)=>{const M=l(C,1);return`<line x1="${n}" y1="${s}" x2="${M.x}" y2="${M.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),f=Math.max(...D.map($=>e[$]||1)),g=`<polygon points="${D.map(($,C)=>{const M=l(C,(e[$]||1)/f);return`${M.x},${M.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let m="";if(t){const $=Math.max(...D.map(M=>t[M]||1));m=`<polygon points="${D.map((M,K)=>{const Le=l(K,(t[M]||1)/$);return`${Le.x},${Le.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const d=D.map(($,C)=>{const M=l(C,(e[$]||1)/f);return`<circle cx="${M.x}" cy="${M.y}" r="2.5" fill="var(--blue)"/>`}).join(""),v=22,k=D.map(($,C)=>{const M=l(C,1+v/a),K=M.x<n-5?"end":M.x>n+5?"start":"middle";return`<text x="${M.x}" y="${M.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${K}" dominant-baseline="middle">${go[$]}</text>`}).join(""),E=36;return`<svg width="${o+E*2}" height="${o+E*2}" viewBox="${-E} ${-E} ${o+E*2} ${o+E*2}" style="overflow:visible;display:block">
    ${c}${p}${m}${g}${d}${k}
  </svg>`}function ho(e){return e.length?D.map(t=>{const o=e.filter(a=>a.scores?.[t]!=null),i=o.length?o.reduce((a,r)=>a+r.scores[t],0)/o.length:null,n=i!=null?i.toFixed(1):"—",s=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      ...
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:white;padding:4px 11px 3px;background:${xo(o.total)};border-radius:4px;flex-shrink:0">${s}</div>
      </div>
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function wo(e,t){const o=[...t].sort((s,a)=>a.total-s.total).slice(0,3),i=t.length?(t.reduce((s,a)=>s+a.total,0)/t.length).toFixed(1):"—",n=Z[e.archetype]||{};return`
  ...
  `}function Ae(){const e=document.getElementById("profileContent");if(!e)return;const t=x;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=Z[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=y,a=D.map(c=>{const p=s.filter(f=>f.scores?.[c]!=null);return{c,avg:p.length?p.reduce((f,w)=>f+w.scores[c],0)/p.length:0}}),r=s.length?[...a].sort((c,p)=>p.avg-c.avg)[0]:null,l=s.length?(s.reduce((c,p)=>c+p.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin-top:24px;border-top:2px solid var(--ink)">
          ...
          <div style="padding:16px 20px;border-right:1px solid var(--rule)">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:40px;color:var(--ink);line-height:1;letter-spacing:-1px">${l}</div>
          </div>
  ...
  `}function gt(e){document.querySelectorAll(".screen").forEach(t=>t.classList.remove("active")),document.getElementById(e).classList.add("active"),document.querySelectorAll(".nav-btn").forEach(t=>t.classList.remove("active")),event.target.classList.add("active"),e==="analysis"&&Ce(),e==="calibration"&&Be(),e==="predict"&&Ke(),e==="profile"&&Ae(),localStorage.setItem("ledger_last_screen",e)}function Te(){const e=document.getElementById("storageStatus");e&&(y.length>0?(e.textContent=`✓ ${y.length} films · saved`,e.style.color="var(--green)"):(e.textContent="no films yet",e.style.color="var(--dim)"))}function ze(){const e=x;if(!e)return;const t=document.getElementById("mastheadLeft");t.innerHTML=`<span class="profile-chip" onclick="document.getElementById('nav-profile').click()">
    <strong style="color:var(--ink);font-family:'DM Mono',monospace;font-size:11px;letter-spacing:0.5px">${e.display_name}</strong>
  </span>`}function vt(){const e=new Blob([JSON.stringify(y,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="film_rankings.json",t.click()}function ht(){confirm("Clear all your films and start fresh? This cannot be undone.")&&(localStorage.removeItem("filmRankings_v1"),localStorage.removeItem("ledger_user"),location.reload())}function xt(){const e=document.getElementById("cold-landing");e?e.style.display="flex":he()}window.startFromLanding=function(){const e=document.getElementById("cold-landing");e&&(e.style.display="none"),he()};async function ko(){Dt(),Ct(),Ye(),x?(ie("syncing"),ze(),le(),We(x.id).catch(()=>ie("error"))):(ie("local"),setTimeout(()=>xt(),400)),q(),Te();const e=localStorage.getItem("ledger_last_screen"),t=e==="explore"?"analysis":e;if(t&&t!=="rankings"&&document.getElementById(t)){const o=document.querySelectorAll(".nav-btn");o.forEach(i=>i.classList.remove("active")),document.querySelectorAll(".screen").forEach(i=>i.classList.remove("active")),document.getElementById(t).classList.add("active"),o.forEach(i=>{i.getAttribute("onclick")?.includes(t)&&i.classList.add("active")}),t==="analysis"&&Ce(),t==="profile"&&Ae()}}function ie(e){const t=document.getElementById("cloudDot"),o=document.getElementById("cloudLabel");t.className="cloud-dot",e==="syncing"?(t.classList.add("syncing"),o.textContent="syncing…"):e==="synced"?(t.classList.add("synced"),o.textContent=x?x.display_name:"synced"):e==="error"?(t.classList.add("error"),o.textContent="offline"):o.textContent="local"}window.__ledger={showScreen:gt,sortBy:He,openModal:zt,closeModal:jt,exploreEntity:Ot,renderExploreIndex:_e,renderAnalysis:Ce,initPredict:Ke,predictSearch:Qe,predictSearchDebounce:Rt,predictSelectFilm:Ht,predictAddToList:Vt,startCalibration:Xt,selectCalCat:Jt,selectCalInt:Kt,applyCalibration:eo,resetCalibration:Be,launchOnboarding:he,liveSearch:tt,tmdbSelect:ot,toggleCast:nt,showMoreCast:st,toggleCompany:at,resetToSearch:rt,confirmTmdbData:lt,goToStep3:ct,goToStep4:dt,saveFilm:pt,goToStep:et,renderProfile:Ae,setViewMode:Re,showSyncPanel:fo,openArchetypeModal:mt,closeArchetypeModal:ut,previewWeight:ft,resetArchetypeWeights:uo,saveArchetypeWeights:yo,exportData:vt,resetStorage:ht,updateStorageStatus:Te,updateMastheadProfile:ze,setCloudStatus:ie};const $o=["showScreen","sortBy","openModal","closeModal","exploreEntity","renderExploreIndex","initPredict","predictSearch","predictSearchDebounce","predictSelectFilm","predictAddToList","startCalibration","selectCalCat","selectCalInt","applyCalibration","resetCalibration","launchOnboarding","liveSearch","tmdbSelect","toggleCast","showMoreCast","toggleCompany","resetToSearch","confirmTmdbData","goToStep3","goToStep4","saveFilm","goToStep","renderProfile","setViewMode","showSyncPanel","openArchetypeModal","closeArchetypeModal","previewWeight","resetArchetypeWeights","saveArchetypeWeights","exportData","resetStorage","renderAnalysis"];$o.forEach(e=>{window[e]=window.__ledger[e]});ko();const ee=Object.freeze(Object.defineProperty({__proto__:null,exportData:vt,resetStorage:ht,setCloudStatus:ie,showColdLanding:xt,showScreen:gt,updateMastheadProfile:ze,updateStorageStatus:Te},Symbol.toStringTag,{value:"Module"}));export{b as C,y as M,x as c};
