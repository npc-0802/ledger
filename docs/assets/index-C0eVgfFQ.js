(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();const M=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let f=[],b=null;function ve(e){b=e}function pe(e){f.length=0,e.forEach(t=>f.push(t))}const It=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function D(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function K(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of It)if(e>=t)return o;return"Unwatchable"}function X(e){let t=0,o=0;for(const i of M)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function oe(){f.forEach(e=>{e.total=X(e.scores)})}function Q(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function me(){if(!b||!b.weights)return;const e=b.weights;M.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),oe()}let R={key:"total",dir:"desc"},_e="grid";const St=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Execution"},{key:"acting",label:"Acting"},{key:"production",label:"Production"},{key:"enjoyability",label:"Enjoyability"},{key:"rewatchability",label:"Rewatchability"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Uniqueness"}];function Dt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function Ct(){const{key:e,dir:t}=R;return e==="rank"||e==="total"?[...f].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...f].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...f].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Ye(e){_e=e,H()}function Ve(e){R.key===e?R.dir=R.dir==="desc"?"asc":"desc":(R.key=e,R.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=R.dir==="desc"?"↓":"↑")}H()}function H(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(f.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=f.length+" films ranked";const i=Ct();_e==="grid"?Bt(i,e,o,t):_t(i,e,o,t)}function Ge(e){const t=R.key;return`<div class="rankings-toolbar">
    ${_e==="grid"?`
    <div class="sort-pills">
      ${St.map(i=>`<button class="sort-pill${t===i.key?" active":""}" onclick="sortBy('${i.key}')">${i.label}</button>`).join("")}
    </div>`:"<div></div>"}
  ...
  </div>`}function Bt(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Ge("grid"));const n=["total","rank","title"].includes(R.key)?"total":R.key,r=[...f].sort((a,c)=>c.total-a.total),s=new Map(r.map((a,c)=>[a.title,c+1]));t.innerHTML=`<div class="film-grid">
    ${e.map(a=>{const c=n==="total"?a.total:a.scores?.[n]??null,l=c!=null?n==="total"?(Math.round(c*10)/10).toFixed(1):c:"—",d=Dt(c),p=a.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${a.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${f.indexOf(a)})">
  ...
  </div>`}function _t(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Ge("table"));const n=[...f].sort((s,a)=>a.total-s.total),r=new Map(n.map((s,a)=>[s.title,a+1]));t.innerHTML=e.map(s=>{const a=s.scores,c=r.get(s.title),l=s.total!=null?(Math.round(s.total*10)/10).toFixed(1):"—",d=s.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${s.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${f.indexOf(s)})">
      ...
      <div class="film-total">${l}</div>
    </div>`}).join("")}const zt=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:H,setViewMode:Ye,sortBy:Ve},Symbol.toStringTag,{value:"Module"})),Tt="modulepreload",Lt=function(e){return"/"+e},qe={},_=function(t,o,i){let n=Promise.resolve();if(o&&o.length>0){let c=function(l){return Promise.all(l.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),a=s?.nonce||s?.getAttribute("nonce");n=c(o.map(l=>{if(l=Lt(l),l in qe)return;qe[l]=!0;const d=l.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const k=document.createElement("link");if(k.rel=d?"stylesheet":Tt,d||(k.as="script"),k.crossOrigin="",k.href=l,a&&k.setAttribute("nonce",a),document.head.appendChild(k),d)return new Promise((h,m)=>{k.addEventListener("load",h),k.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(s){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=s,window.dispatchEvent(a),!a.defaultPrevented)throw s}return n.then(s=>{for(const a of s||[])a.status==="rejected"&&r(a.reason);return t().catch(r)})},Ne="palate_migrations_v1";function At(){let e;try{e=JSON.parse(localStorage.getItem(Ne)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;f.forEach(o=>{const i=D((o.cast||"").split(",").map(r=>r.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const n=D((o.productionCompanies||"").split(",").map(r=>r.trim()).filter(Boolean)).join(", ");n!==(o.productionCompanies||"")&&(o.productionCompanies=n,t++)}),t>0&&(F(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(Ne,JSON.stringify(e))}catch{}}}const Je="filmRankings_v1";function F(){try{localStorage.setItem(Je,JSON.stringify(f))}catch(e){console.warn("localStorage save failed:",e)}b&&(clearTimeout(F._syncTimer),F._syncTimer=setTimeout(()=>{_(()=>Promise.resolve().then(()=>Xe),void 0).then(e=>e.syncToSupabase())},2e3))}function jt(){try{const e=localStorage.getItem(Je);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;pe(t),console.log(`Loaded ${f.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const Pt="https://gzuuhjjedrzeqbgxhfip.supabase.co",Rt="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",he=window.supabase.createClient(Pt,Rt);async function xe(){const e=b;if(!e)return;const{setCloudStatus:t}=await _(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>ie);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await he.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:f,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),fe()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function Ke(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await _(async()=>{const{setCloudStatus:r,updateMastheadProfile:s,updateStorageStatus:a}=await Promise.resolve().then(()=>ie);return{setCloudStatus:r,updateMastheadProfile:s,updateStorageStatus:a}},void 0),{renderRankings:n}=await _(async()=>{const{renderRankings:r}=await Promise.resolve().then(()=>zt);return{renderRankings:r}},void 0);t("syncing");try{const{data:r,error:s}=await he.from("ledger_users").select("*").eq("id",e).single();if(s)throw s;if(r){if(ve({id:r.id,username:r.username,display_name:r.display_name,archetype:r.archetype,archetype_secondary:r.archetype_secondary,weights:r.weights,harmony_sensitivity:r.harmony_sensitivity}),r.movies&&Array.isArray(r.movies)&&r.movies.length>=f.length){const a=r.movies.map(c=>({...c,cast:D((c.cast||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", "),productionCompanies:D((c.productionCompanies||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", ")}));pe(a)}fe(),me(),t("synced"),o(),n(),i()}}catch(r){console.warn("Supabase load error:",r),t("error")}}function fe(){try{localStorage.setItem("ledger_user",JSON.stringify(b))}catch{}}function Qe(){try{const e=localStorage.getItem("ledger_user");e&&ve(JSON.parse(e))}catch{}}const Xe=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:Ke,loadUserLocally:Qe,saveUserLocally:fe,sb:he,syncToSupabase:xe},Symbol.toStringTag,{value:"Module"})),Ot="f5a446a5f70a9f6a16a8ddd052c121f2",qt=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function Ee(e){for(const[t,o]of qt)if(e>=t)return o;return"Unwatchable"}let be=null,L=!1,N={};function Nt(e){be=e,L=!1,N={},we()}function we(){const e=be,t=f[e],o=[...f].sort((u,g)=>g.total-u.total),i=o.indexOf(t)+1;o.filter(u=>u!==t&&Math.abs(u.total-t.total)<6).slice(0,5);const n={};M.forEach(u=>{const g=[...f].sort((v,x)=>(x.scores[u.key]||0)-(v.scores[u.key]||0));n[u.key]=g.indexOf(t)+1});const r=(u,g,v)=>{const x=["director","writer","actor"].includes(g),w=x?`chip-img-${g}-${v.replace(/[^a-z0-9]/gi,"").toLowerCase().slice(0,24)}`:"",E=x?`<img id="${w}" src="" alt="" style="width:20px;height:20px;border-radius:50%;object-fit:cover;flex-shrink:0;display:none">`:"";return`<span class="modal-meta-chip" style="${x?"display:inline-flex;align-items:center;gap:5px":""}" onclick="exploreEntity('${g}','${v.replace(/'/g,"'")}')">${E}${u}</span>`},s=D((t.director||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>r(u,"director",u)).join(""),a=D((t.writer||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>r(u,"writer",u)).join(""),c=D((t.cast||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>r(u,"actor",u)).join(""),l=D((t.productionCompanies||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>r(u,"company",u)).join(""),d=t.poster?`<div class="dark-grid" style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,p=L?N:t.scores,k=L?X(N):t.total,h=["plot","execution","acting","production"],m=["enjoyability","rewatchability","ending","uniqueness"];function I(u,g){const v=M.filter(E=>g.includes(E.key)),x=`<div style="font-family:'DM Mono',monospace;font-size:9px;letter-spacing:2.5px;text-transform:uppercase;color:var(--dim);opacity:0.6;padding:12px 0 6px;border-bottom:1px solid var(--rule)">${u}</div>`,w=v.map(E=>{const C=p[E.key],Et=n[E.key];return L?`<div class="breakdown-row" style="align-items:center;gap:12px">
          <div class="breakdown-cat">${E.label} <span class="breakdown-wt">×${E.weight}</span></div>
          <div class="breakdown-bar-wrap" style="flex:1">
            <input type="range" min="1" max="100" value="${C||50}"
              ...
              oninput="modalUpdateScore('${E.key}', this.value)">
          </div>
          <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
            <div class="breakdown-val ${Q(C||50)}" id="modal-edit-val-${E.key}">${C||50}</div>
            <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${E.key}">${Ee(C||50)}</div>
          </div>
        ...
        <div class="breakdown-val ${C?Q(C):""}">${C??"—"}</div>
        <div class="modal-cat-rank">#${Et}</div>
      </div>`}).join("");return x+w}const S=I("Craft",h)+I("Experience",m);document.getElementById("modalContent").innerHTML=`
    ${d}
    ...
    ${L?"":(()=>{const u=[];for(let g=-2;g<=2;g++){const v=i+g;v<1||v>o.length||u.push({film:o[v-1],slotRank:v})}return u.length?`<div class="compare-section">
        ...
        ${u.map(({film:g,slotRank:v})=>{const x=g===t,w=(Math.round(g.total*10)/10).toFixed(1);if(x)return`<div style="display:flex;align-items:center;gap:12px;padding:9px 12px;background:var(--ink);margin:2px 0">
            ...
            </div>`;const E=(g.total-t.total).toFixed(1),C=E>0?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:12px;padding:8px 12px;border-bottom:1px solid var(--rule);cursor:pointer" onclick="closeModal();openModal(${f.indexOf(g)})">
            ...
            <span style="font-family:'DM Mono',monospace;font-size:10px;font-weight:600;color:${C};min-width:36px;text-align:right">${E>0?"+":""}${E}</span>
          </div>`}).join("")}
      </div>`:""})()}
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),L||(Ft(t),Ht(t))}async function Ht(e){[...D((e.director||"").split(",").map(o=>o.trim()).filter(Boolean)).map(o=>({name:o,type:"director"})),...D((e.writer||"").split(",").map(o=>o.trim()).filter(Boolean)).map(o=>({name:o,type:"writer"})),...D((e.cast||"").split(",").map(o=>o.trim()).filter(Boolean)).map(o=>({name:o,type:"actor"}))].forEach(({name:o,type:i})=>{const n=`chip-img-${i}-${o.replace(/[^a-z0-9]/gi,"").toLowerCase().slice(0,24)}`;fetch(`https://api.themoviedb.org/3/search/person?api_key=${Ot}&query=${encodeURIComponent(o)}&language=en-US`).then(r=>r.json()).then(r=>{const s=r.results?.[0]?.profile_path;if(!s)return;const a=document.getElementById(n);a&&(a.src=`https://image.tmdb.org/t/p/w92${s}`,a.style.display="block")}).catch(()=>{})})}window.modalEnterEdit=function(){const e=f[be];L=!0,N={...e.scores},we()};window.modalCancelEdit=function(){L=!1,N={},we()};window.modalUpdateScore=function(e,t){N[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${Q(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=Ee(parseInt(t)));const n=X(N),r=document.getElementById("modal-total-display");r&&(r.textContent=n);const s=document.getElementById("modal-total-label");s&&(s.textContent=Ee(n))};window.modalSaveScores=function(){const e=f[be];e.scores={...N},e.total=X(N),L=!1,N={},oe(),F(),H(),xe().catch(t=>console.warn("sync failed",t)),we()};async function Ft(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await _(async()=>{const{getFilmInsight:n}=await import("./insights-DaczUnG2.js");return{getFilmInsight:n}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function Ut(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}const ue="f5a446a5f70a9f6a16a8ddd052c121f2",He=["director","writer","actor"];let z="directors";function W(e){return D((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Wt(e){const t={};return f.forEach(o=>{let i=[];e==="directors"?i=W(o.director):e==="writers"?i=W(o.writer):e==="actors"?i=W(o.cast):e==="companies"?i=W(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(n=>{t[n]||(t[n]=[]),t[n].push(o)})}),t}function Ze(e){const t=Wt(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((n,r)=>n+r.total,0)/i.length).toFixed(1)),catAvgs:M.reduce((n,r)=>{const s=i.filter(a=>a.scores[r.key]!=null).map(a=>a.scores[r.key]);return n[r.key]=s.length?parseFloat((s.reduce((a,c)=>a+c,0)/s.length).toFixed(1)):null,n},{})})).sort((o,i)=>i.avg-o.avg)}function et(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function ze(e){e&&(z=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ze(z),n=document.getElementById("explore-section");n&&(n.innerHTML=`
    <div class="explore-tabs" style="margin-bottom:24px">
      ${t.map(r=>`<button class="explore-tab ${r===z?"active":""}" onclick="renderExploreIndex('${r}')">${o[r]}</button>`).join("")}
    </div>
    ${i.length===0?`<div style="border:1.5px dashed var(--rule-dark);padding:40px 32px;text-align:center;margin:8px 0">
          ...
          <div style="font-family:'DM Sans',sans-serif;font-size:13px;color:var(--dim);font-weight:300">Rate at least two films from the same ${z==="companies"?"company":z.slice(0,-1)} to map this territory.</div>
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:17px;color:white;padding:4px 11px 3px;background:${et(r.avg)};border-radius:4px;flex-shrink:0">${r.avg.toFixed(1)}</div>
          </div>`}).join("")}
  `,i.length>0&&z!=="years"&&Vt(z,i))}function Yt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";z=i;const n=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",r=f.filter(m=>e==="director"?W(m.director).includes(t):e==="writer"?W(m.writer).includes(t):e==="actor"?W(m.cast).includes(t):e==="company"?W(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,I)=>I.total-m.total);if(r.length===0){ze();return}const s=Ze(i),a=s.findIndex(m=>m.name===t)+1,c=s.length,l=s.find(m=>m.name===t),d=l?l.avg.toFixed(1):(r.reduce((m,I)=>m+I.total,0)/r.length).toFixed(1);r[0];const p={};M.forEach(m=>{const I=s.filter(u=>u.catAvgs[m.key]!=null).sort((u,g)=>g.catAvgs[m.key]-u.catAvgs[m.key]),S=I.findIndex(u=>u.name===t)+1;p[m.key]=S>0?{rank:S,total:I.length}:null});const k=M.map(m=>{const I=r.filter(S=>S.scores[m.key]!=null).map(S=>S.scores[m.key]);return{...m,avg:I.length?parseFloat((I.reduce((S,u)=>S+u,0)/I.length).toFixed(1)):null}}),h=k.filter(m=>m.avg!=null).sort((m,I)=>I.avg-m.avg);h[0],h[h.length-1],document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:800px">
      ...
      <div class="dark-grid" style="background:var(--surface-dark);margin:-40px -56px 32px;padding:40px 56px 32px">
        ...
        <div style="display:flex;align-items:flex-end;gap:20px">
          ${He.includes(e)||e==="company"?'<img id="explore-person-img" src="" alt="" style="width:72px;height:72px;object-fit:cover;border-radius:50%;display:none;flex-shrink:0;border:2px solid rgba(255,255,255,0.12)">':""}
          <div>
      ...
      ${h.length>0?(()=>{const m=["plot","execution","acting","production"],I=["enjoyability","rewatchability","ending","uniqueness"];function S(u,g){const v=k.filter(x=>g.includes(x.key)&&x.avg!=null);return v.length?`<div style="margin-bottom:28px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 40px">
              ${v.map(x=>{const w=p[x.key];return`<div style="border-bottom:1px solid var(--rule);padding:10px 0">
                  ...
                  <div style="height:2px;background:var(--rule);border-radius:1px">
                    <div style="height:2px;width:${x.avg}%;background:${et(x.avg)};border-radius:1px"></div>
                  </div>
                </div>`}).join("")}
            </div>
      ...
      ${r.map((m,I)=>{const S=m.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${m.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',u=m.total!=null?(Math.round(m.total*10)/10).toFixed(1):"—";return`
  ...
  `,Kt(e,t,r),He.includes(e)?Gt(t):e==="company"&&Jt(t)}async function Vt(e,t){const o=["directors","writers","actors"].includes(e);t.forEach((i,n)=>{(o?fetch(`https://api.themoviedb.org/3/search/person?api_key=${ue}&query=${encodeURIComponent(i.name)}&language=en-US`).then(s=>s.json()).then(s=>s.results?.[0]?.profile_path?`https://image.tmdb.org/t/p/w185${s.results[0].profile_path}`:null):fetch(`https://api.themoviedb.org/3/search/company?api_key=${ue}&query=${encodeURIComponent(i.name)}`).then(s=>s.json()).then(s=>s.results?.[0]?.logo_path?`https://image.tmdb.org/t/p/w185${s.results[0].logo_path}`:null)).then(s=>{if(!s)return;const a=document.getElementById(`explore-list-img-${n}`);a&&(a.src=s,a.style.display="block")}).catch(()=>{})})}async function Gt(e){try{const i=(await(await fetch(`https://api.themoviedb.org/3/search/person?api_key=${ue}&query=${encodeURIComponent(e)}&language=en-US`)).json()).results?.[0];if(!i?.profile_path)return;const n=document.getElementById("explore-person-img");if(!n)return;n.src=`https://image.tmdb.org/t/p/w185${i.profile_path}`,n.style.display="block"}catch{}}async function Jt(e){try{const i=(await(await fetch(`https://api.themoviedb.org/3/search/company?api_key=${ue}&query=${encodeURIComponent(e)}`)).json()).results?.[0];if(!i?.logo_path)return;const n=document.getElementById("explore-person-img");if(!n)return;n.src=`https://image.tmdb.org/t/p/w185${i.logo_path}`,n.style.display="block",n.style.borderRadius="4px",n.style.background="white",n.style.padding="6px",n.style.objectFit="contain"}catch{}}async function Kt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:n}=await _(async()=>{const{getEntityInsight:s}=await import("./insights-DaczUnG2.js");return{getEntityInsight:s}},[]),r=await n(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const r=document.getElementById("explore-insight");r&&(r.style.display="none")}}function Te(){const e=i=>i.length?Math.round(i.reduce((n,r)=>n+r,0)/i.length*100)/100:null,t=M.map(i=>{const n=f.map(r=>r.scores[i.key]).filter(r=>r!=null);return{...i,avg:e(n)}});function o(i){return i>=90?"#C4922A":i>=80?"#1F4A2A":i>=70?"#4A5830":i>=60?"#6B4820":"rgba(12,11,9,0.65)"}document.getElementById("analysisContent").innerHTML=`
  ...
  `,ze()}const Ie="f5a446a5f70a9f6a16a8ddd052c121f2",Se="https://api.themoviedb.org/3",Qt="https://ledger-proxy.noahparikhcott.workers.dev";let Fe=null,Z=null,De=null;function tt(){if(f.length<10){const i=10-f.length;if(document.getElementById("predict-result").innerHTML="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-search").value="",document.getElementById("predict-search")?.closest(".screen")||document.getElementById("predict"),!document.getElementById("predict-lock-state")){const r=document.getElementById("predict-search")?.parentElement;r&&(r.style.display="none");const s=document.createElement("div");s.id="predict-lock-state",s.style.cssText="padding:48px 0;text-align:center;max-width:440px;margin:0 auto",s.innerHTML=`
      ...
      </div>`}).join("")}catch{t.innerHTML='<div class="tmdb-error">Search failed — check connection.</div>'}}async function Zt(e,t,o){document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-search").value=t,document.getElementById("predict-result").innerHTML=`
    ...
    </div>`;let i={},n={};try{const[p,k]=await Promise.all([fetch(`${Se}/movie/${e}?api_key=${Ie}`),fetch(`${Se}/movie/${e}/credits?api_key=${Ie}`)]);i=await p.json(),n=await k.json()}catch{}const r=(n.crew||[]).filter(p=>p.job==="Director").map(p=>p.name).join(", "),s=(n.crew||[]).filter(p=>["Screenplay","Writer","Story"].includes(p.job)).map(p=>p.name).slice(0,2).join(", "),a=(n.cast||[]).slice(0,8).map(p=>p.name).join(", "),c=(i.genres||[]).map(p=>p.name).join(", "),l=i.overview||"",d=i.poster_path||null;Z={tmdbId:e,title:t,year:o,director:r,writer:s,cast:a,genres:c,overview:l,poster:d},await oo(Z)}function eo(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(s=>{const a=f.filter(d=>d.scores[s]!=null).map(d=>d.scores[s]);if(!a.length){t[s]={mean:70,std:10,min:0,max:100};return}const c=a.reduce((d,p)=>d+p,0)/a.length,l=Math.sqrt(a.reduce((d,p)=>d+(p-c)**2,0)/a.length);t[s]={mean:Math.round(c*10)/10,std:Math.round(l*10)/10,min:Math.min(...a),max:Math.max(...a)}});const o=[...f].sort((s,a)=>a.total-s.total),i=o.slice(0,10).map(s=>`${s.title} (${s.total})`).join(", "),n=o.slice(-5).map(s=>`${s.title} (${s.total})`).join(", "),r=M.map(s=>`${s.label}×${s.weight}`).join(", ");return{stats:t,top10:i,bottom5:n,weightStr:r,archetype:b?.archetype,archetypeSecondary:b?.archetype_secondary,totalFilms:f.length}}function to(e){const t=D((e.director||"").split(",").map(i=>i.trim()).filter(Boolean)),o=D((e.cast||"").split(",").map(i=>i.trim()).filter(Boolean));return f.filter(i=>{const n=D((i.director||"").split(",").map(s=>s.trim()).filter(Boolean)),r=D((i.cast||"").split(",").map(s=>s.trim()).filter(Boolean));return t.some(s=>n.includes(s))||o.some(s=>r.includes(s))}).sort((i,n)=>n.total-i.total).slice(0,8)}async function oo(e){const t=eo(),o=to(e),i=o.length?o.map(a=>`- ${a.title} (${a.year||""}): total=${a.total}, plot=${a.scores.plot}, execution=${a.scores.execution}, acting=${a.scores.acting}, production=${a.scores.production}, enjoyability=${a.scores.enjoyability}, rewatchability=${a.scores.rewatchability}, ending=${a.scores.ending}, uniqueness=${a.scores.uniqueness}`).join(`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const d=((await(await fetch(Qt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:r,messages:[{role:"user",content:s}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),p=JSON.parse(d);De=p,io(e,p,o)}catch(a){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${a.message}. Check that the proxy is running and your API key is valid.</div>`}}function io(e,t,o){let i=0,n=0;M.forEach(l=>{const d=t.predicted_scores[l.key];d!=null&&(i+=d*l.weight,n+=l.weight)});const r=n>0?Math.round(i/n*100)/100:0,s=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,a={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",c={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(l=>{const d=(r-l.total).toFixed(1),p=d>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${f.indexOf(l)})">
  ...
  `}function no(){Z&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Z.title,_(()=>Promise.resolve().then(()=>Mo),void 0).then(t=>{De?.predicted_scores&&t.prefillWithPrediction(De.predicted_scores),t.liveSearch(Z.title)}))},100))}let ne="all",it="focused",G=[],A=0,B={},j={},le=[];const ro={focused:15,thorough:30,deep:50},Ue=8;function so(e){ne=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function ao(e){it=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function lo(e,t){const o=[];(e==="all"?M.map(s=>s.key):[e]).forEach(s=>{const a=f.filter(c=>c.scores[s]!=null).sort((c,l)=>c.scores[s]-l.scores[s]);for(let c=0;c<a.length-1;c++)for(let l=c+1;l<a.length;l++){const d=Math.abs(a[c].scores[s]-a[l].scores[s]);if(d<=8)o.push({a:a[c],b:a[l],catKey:s,diff:d});else break}}),o.sort((s,a)=>s.diff-a.diff);const n=new Set,r=[];for(const s of o){const a=[s.a.title,s.b.title,s.catKey].join("|");n.has(a)||(n.add(a),r.push(s))}return r.sort(()=>Math.random()-.5).slice(0,t)}function co(){const e=ro[it];if(G=lo(ne,e),G.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}A=0,B={},j={},le=[],f.forEach(t=>{j[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=ne==="all"?"All categories":M.find(t=>t.key===ne)?.label||ne,Le()}function Le(){if(A>=G.length){po();return}const{a:e,b:t,catKey:o}=G[A],i=G.length,n=Math.round(A/i*100);document.getElementById("cal-progress-label").textContent=`${A+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const r=M.find(l=>l.key===o)?.label||o;j[e.title]?.[o]??e.scores[o],j[t.title]?.[o]??t.scores[o];function s(l,d){const p=l.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${l.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(le.length===0)return;const e=le.pop();A=e.idx,j=e.tempScores,B=e.deltas,Le()};window.calChoose=function(e){if(le.push({idx:A,tempScores:JSON.parse(JSON.stringify(j)),deltas:JSON.parse(JSON.stringify(B))}),e!=="skip"){const{a:t,b:o,catKey:i}=G[A],n=j[t.title]?.[i]??t.scores[i],r=j[o.title]?.[i]??o.scores[i],s=1/(1+Math.pow(10,(r-n)/40)),a=1-s,c=e==="a"?1:0,l=1-c,d=Math.round(Math.min(100,Math.max(1,n+Ue*(c-s)))),p=Math.round(Math.min(100,Math.max(1,r+Ue*(l-a))));if(B[t.title]||(B[t.title]={}),B[o.title]||(B[o.title]={}),d!==n){const m=B[t.title][i]?.old??n;B[t.title][i]={old:m,new:d},j[t.title][i]=d}if(p!==r){const m=B[o.title][i]?.old??r;B[o.title][i]={old:m,new:p},j[o.title][i]=p}const k=document.getElementById(`cal-card-${e}`),h=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);k&&(k.style.opacity="1"),h&&(h.style.opacity="0.35",h.style.transform="scale(0.97)")}A++,setTimeout(()=>Le(),e==="skip"?0:140)};function po(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(B).flatMap(([o,i])=>Object.entries(i).map(([n,{old:r,new:s}])=>({title:o,catKey:n,old:r,new:s}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ${M.map(o=>{const i=t[o.key],n=i.slice(0,3),r=i.length-3,s=i.length>0;return`<div style="padding:14px;background:var(--cream);border-radius:6px;${s?"":"opacity:0.45"}">
          ...
          ${n.map((a,c)=>{const l=a.new>a.old?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;${c<n.length-1?"border-bottom:1px solid var(--rule)":""}">
              <input type="checkbox" id="caldiff_${a.idx}" checked style="flex-shrink:0;accent-color:var(--blue);width:14px;height:14px"
                data-movie-idx="${f.findIndex(d=>d.title===a.title)}" data-cat="${a.catKey}" data-old="${a.old}" data-new="${a.new}">
    ...
    `}else if($==="reveal"){const t=uo(ee);O=t,O._slug||(O._slug=ge.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"user");const o=V[t.primary],i=o.palette||"#3d5a80";e.innerHTML=`
...
`),o=t[0].split(",").map(i=>i.replace(/^"|"$/g,"").trim());return t.slice(1).map(i=>{const n=[];let r="",s=!1;for(const a of i)a==='"'?s=!s:a===","&&!s?(n.push(r.trim()),r=""):r+=a;return n.push(r.trim()),Object.fromEntries(o.map((a,c)=>[a,n[c]||""]))})}function nt(e){const t=new FileReader;t.onload=o=>{try{const n=yo(o.target.result).filter(s=>s.Name&&s.Rating&&parseFloat(s.Rating)>0).map(s=>{const a=parseFloat(s.Rating),c=Math.round(a*20);return{title:s.Name,year:parseInt(s.Year)||null,total:c,scores:{},director:"",writer:"",cast:"",productionCompanies:"",poster:null,overview:""}});if(n.length===0)throw new Error("No rated films found");te=n,document.getElementById("ob-import-status").textContent=`✓ ${n.length} films ready to import`,document.getElementById("ob-import-status").style.color="var(--green)";const r=document.getElementById("ob-import-drop-lb");r&&(r.style.borderColor="var(--green)",r.innerHTML=`<div style="font-family:'DM Mono',monospace;font-size:13px;color:var(--green)">${e.name}</div><div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--green);margin-top:4px">${n.length} films ready to import</div>`),document.getElementById("ob-import-btn").disabled=!1}catch{document.getElementById("ob-import-status").textContent="Couldn't parse that file — make sure it's ratings.csv from Letterboxd.",document.getElementById("ob-import-status").style.color="var(--red)"}},t.readAsText(e)}window.obHandleImportDrop=function(e){e.preventDefault(),document.getElementById("ob-import-drop").style.borderColor="var(--rule-dark)";const t=e.dataTransfer.files[0];t&&$e(t)};window.obHandleImportFile=function(e){const t=e.files[0];t&&$e(t)};function $e(e){const t=new FileReader;t.onload=o=>{try{const i=JSON.parse(o.target.result);if(!Array.isArray(i)||i.length===0)throw new Error("invalid");if(!i[0].scores||!i[0].title)throw new Error("invalid");te=i,document.getElementById("ob-import-status").textContent=`✓ ${i.length} films ready to import`,document.getElementById("ob-import-status").style.color="var(--green)",document.getElementById("ob-import-drop").style.borderColor="var(--green)",document.getElementById("ob-import-drop").innerHTML=`<div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--green)">${e.name}</div>`,document.getElementById("ob-import-btn").disabled=!1}catch{document.getElementById("ob-import-status").textContent="That doesn't look like a valid Palate Map JSON file.",document.getElementById("ob-import-status").style.color="var(--red)"}},t.readAsText(e)}window.obConfirmImport=function(){te&&(pe(te),$=0,U())};window.obLookupUser=async function(){const e=document.getElementById("ob-returning-btn"),t=document.getElementById("ob-returning-error"),o=document.getElementById("ob-returning-field")?.value?.trim().toLowerCase();if(o){e.disabled=!0,e.textContent="Looking up…",t.style.display="none";try{const{data:i,error:n}=await he.from("ledger_users").select("*").eq("username",o).single();if(n||!i)throw new Error("not found");ve({id:i.id,username:i.username,display_name:i.display_name,archetype:i.archetype,archetype_secondary:i.archetype_secondary,weights:i.weights,harmony_sensitivity:i.harmony_sensitivity}),i.movies&&Array.isArray(i.movies)&&i.movies.length>0&&pe(i.movies),fe(),F(),me(),oe(),document.getElementById("onboarding-overlay").style.display="none";const r=await _(()=>Promise.resolve().then(()=>ie),void 0);r.updateMastheadProfile(),r.setCloudStatus("synced"),r.updateStorageStatus(),H()}catch{e.disabled=!1,e.textContent="Restore profile →",t.style.display="block"}}};window.obSelectAnswer=function(e,t,o){ee[e]=t,o.closest(".ob-card").querySelectorAll(".ob-option").forEach(n=>n.classList.remove("selected")),o.classList.add("selected");const i=document.getElementById("ob-next-btn");i&&(i.disabled=!1)};window.obBack=function(){typeof $=="number"&&$>0?($--,U()):($="name",U())};window.obNext=function(){ee[$]&&($<5?($++,U()):($="reveal",U()))};window.obFinishFromReveal=function(){if(!O)return;const e=V[O.primary];go(O.primary,O.secondary||"",e.weights,O.harmonySensitivity)};function uo(e){const t={};Object.keys(V).forEach(n=>t[n]=0),e[0]==="A"&&(t.Formalist+=2,t.Sensualist+=1,t.Completionist+=1),e[0]==="C"&&(t.Visceralist+=2,t.Atmospherist+=1),e[0]==="D"&&(t.Revisionist+=3),e[0]==="B"&&(t.Narrativist+=1,t.Humanist+=1),e[1]==="A"&&(t.Absolutist+=3,t.Narrativist+=2),e[1]==="C"&&(t.Visceralist+=2,t.Atmospherist+=2),e[1]==="D"&&(t.Completionist+=1,t.Revisionist+=1),e[1]==="B"&&(t.Humanist+=1,t.Formalist+=1),e[2]==="A"&&(t.Atmospherist+=3),e[2]==="C"&&(t.Formalist+=2,t.Absolutist+=2),e[2]==="D"&&(t.Completionist+=2,t.Revisionist-=1),e[2]==="B"&&(t.Narrativist+=1),e[3]==="A"&&(t.Atmospherist+=2,t.Revisionist+=2),e[3]==="C"&&(t.Completionist+=3),e[3]==="D"&&(t.Atmospherist+=1),e[3]==="B"&&(t.Sensualist+=1),e[4]==="A"&&(t.Humanist+=3,t.Visceralist+=1),e[4]==="D"&&(t.Sensualist+=3),e[4]==="C"&&(t.Formalist+=1,t.Completionist+=1),e[4]==="B"&&(t.Narrativist+=1,t.Absolutist+=1);let o=.3;e[5]==="A"&&(t.Visceralist+=1,o=0),e[5]==="C"&&(t.Absolutist+=1,o=1),e[5]==="B"&&(o=.4);const i=Object.entries(t).sort((n,r)=>r[1]-n[1]);return{primary:i[0][0],secondary:i[1][1]>0?i[1][0]:null,harmonySensitivity:o}}async function go(e,t,o,i){const n=crypto.randomUUID(),r=O._slug||ge.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"user";ve({id:n,username:r,display_name:ge,archetype:e,archetype_secondary:t,weights:o,harmony_sensitivity:i}),me(),oe(),document.getElementById("onboarding-overlay").style.display="none";const s=await _(()=>Promise.resolve().then(()=>ie),void 0);s.updateMastheadProfile(),s.updateStorageStatus(),s.setCloudStatus("syncing"),H(),fe(),xe().catch(a=>console.warn("Initial sync failed:",a))}const vo=Object.freeze(Object.defineProperty({__proto__:null,launchOnboarding:ke},Symbol.toStringTag,{value:"Module"})),Ce="f5a446a5f70a9f6a16a8ddd052c121f2",Be="https://api.themoviedb.org/3";let y={title:"",year:null,director:"",writer:"",cast:"",scores:{}},se=[],P={},J={};function rt(e){ye(e)}function ye(e){for(let t=1;t<=4;t++){const o=document.getElementById("sn"+t),i=document.getElementById("sl"+t);t<e?(o.className="step-num done",o.textContent="✓"):t===e?(o.className="step-num active",o.textContent=t,i.className="step-label active"):(o.className="step-num",o.textContent=t,i.className="step-label")}document.querySelectorAll(".step-panel").forEach((t,o)=>{t.classList.toggle("active",o+1===e)})}let We=null;function st(e){clearTimeout(We);const t=document.getElementById("tmdb-results");if(e.trim().length<2){t.innerHTML="";return}document.getElementById("searchSpinner").style.display="inline",We=setTimeout(async()=>{try{const i=await(await fetch(`${Be}/search/movie?api_key=${Ce}&query=${encodeURIComponent(e.trim())}&include_adult=false`)).json();if(document.getElementById("searchSpinner").style.display="none",!i.results||i.results.length===0){t.innerHTML='<div class="tmdb-loading">No results yet…</div>';return}const n=i.results.slice(0,6);t.innerHTML=n.map(r=>{const s=r.release_date?r.release_date.slice(0,4):"?",a=r.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${r.poster_path}" alt="">`:'<div class="tmdb-result-poster-placeholder">NO IMG</div>',c=(r.overview||"").slice(0,100)+((r.overview||"").length>100?"…":"");return`<div class="tmdb-result" onclick="tmdbSelect(${r.id}, '${r.title.replace(/'/g,"\\'").replace(/"/g,'\\"')}')">
      ...
      </div>`,document.getElementById("curate-directors").textContent=c.join(", ")||"Unknown",document.getElementById("curate-writers").textContent=l.join(", ")||"Unknown",lt(p),ho(k),document.getElementById("tmdb-search-phase").style.display="none",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-curation-phase").style.display="block"}catch{document.getElementById("tmdb-results").innerHTML='<div class="tmdb-error">Failed to load film details. Try again.</div>'}}function lt(e){const t=document.getElementById("curate-cast");t.innerHTML=`<div class="cast-grid">
  ...
  </div>`}function ct(e){P[e]&&(P[e].checked=!P[e].checked);const t=document.getElementById("castItem_"+e),o=P[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function dt(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,se.slice(8,20).forEach(i=>{P[i.id]||(P[i.id]={actor:i,checked:!1})});const o=se.slice(0,20);lt(o),e.textContent="+ More cast",e.disabled=!1,se.length<=20&&(e.style.display="none")}function ho(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
  ...
  </div>`}function pt(e){J[e].checked=!J[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(J[e].checked?"checked":"unchecked")}function mt(){ce=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function ft(){const e=y._allDirectors||[],t=y._allWriters||[],o=Object.values(P).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(J).filter(n=>n.checked).map(n=>n.company.name);y.title=y._tmdbDetail.title,y.director=e.join(", "),y.writer=t.join(", "),y.cast=o.join(", "),y.productionCompanies=i.join(", "),wo(),ye(2)}let ce=null;function xo(e){ce=e}function bo(e){const t=[...f].filter(r=>r.scores[e]!=null).sort((r,s)=>s.scores[e]-r.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),n=new Set;return i.filter(r=>n.has(r.title)?!1:(n.add(r.title),!0))}function wo(){const e=document.getElementById("calibrationCategories");e.innerHTML=M.map(t=>{const o=bo(t.key),i=ce?.[t.key]??y.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
    ...
    </div>`}).join(""),M.forEach(t=>{y.scores[t.key]=ce?.[t.key]??y.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(r=>r.classList.remove("selected")),o.classList.add("selected");const i=y.scores[e]??50,n=Math.round((i+t)/2);document.getElementById("slider_"+e).value=n,updateSlider(e,n)};window.updateSlider=function(e,t){t=parseInt(t),y.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=K(t)};function yt(){ko(),ye(3)}let Y=[],q=0,de=[];function ko(){Y=[],de=[],M.forEach(e=>{const t=y.scores[e.key];if(!t)return;f.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,n)=>Math.abs(i.scores[e.key]-t)-Math.abs(n.scores[e.key]-t)).slice(0,1).forEach(i=>Y.push({cat:e,film:i}))}),Y=Y.slice(0,6),q=0,Me()}function Me(){const e=document.getElementById("hthContainer");if(Y.length===0||q>=Y.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
  ...
  `}window.hthChoice=function(e,t,o){de.push({idx:q,scores:{...y.scores}});const i=y.scores[t];e==="new"&&i<=o?y.scores[t]=o+1:e==="existing"&&i>=o&&(y.scores[t]=o-1),q++,Me()};window.hthSkip=function(){de.push({idx:q,scores:{...y.scores}}),q++,Me()};window.hthUndo=function(){if(de.length===0)return;const e=de.pop();q=e.idx,y.scores=e.scores,Me()};function ut(){$o(),ye(4)}function $o(){const e=X(y.scores);y.total=e;const t=[...f,y].sort((i,n)=>n.total-i.total),o=t.indexOf(y)+1;document.getElementById("resultCard").innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
  ...
  `}function gt(){y.total=X(y.scores),f.push({title:y.title,year:y.year,total:y.total,director:y.director,writer:y.writer,cast:y.cast,productionCompanies:y.productionCompanies||"",poster:y._tmdbDetail?.poster_path||null,overview:y._tmdbDetail?.overview||"",scores:{...y.scores}}),F(),_(()=>Promise.resolve().then(()=>ie),void 0).then(e=>e.updateStorageStatus()),y={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},P={},J={},se=[],ce=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",ye(1),H(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const Mo=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:ft,goToStep:rt,goToStep3:yt,goToStep4:ut,liveSearch:st,prefillWithPrediction:xo,resetToSearch:mt,saveFilm:gt,showMoreCast:dt,tmdbSelect:at,toggleCast:ct,toggleCompany:pt},Symbol.toStringTag,{value:"Module"}));function Eo(){if(!b){_(()=>Promise.resolve().then(()=>vo),void 0).then(e=>e.launchOnboarding());return}vt()}function vt(){if(!b)return;const e=b.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function ht(e,t){const o=M.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const r=document.getElementById("awbar_"+n.key);r&&(r.style.width=Math.round(n.val/i*100)+"%")})}function Io(){if(!b||!b.archetype)return;const e=V[b.archetype]?.weights;e&&(M.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),ht())}function So(e){const t=M.map(r=>r.key),o=r=>{const s=Math.sqrt(t.reduce((a,c)=>a+(r[c]||1)**2,0));return t.map(a=>(r[a]||1)/s)},i=o(e),n=Object.entries(V).map(([r,s])=>{const a=o(s.weights),c=i.reduce((l,d,p)=>l+d*a[p],0);return{name:r,sim:c}}).sort((r,s)=>s.sim-r.sim);return{primary:n[0].name,secondary:n[1].name}}function Do(){const e={};M.forEach(i=>{const n=parseFloat(document.getElementById("awval_"+i.key)?.value);e[i.key]=isNaN(n)||n<1?1:Math.min(5,n)});const t=b.archetype,o=So(e);b.weights=e,b.archetype=o.primary,b.archetype_secondary=o.secondary,_(()=>Promise.resolve().then(()=>Xe),void 0).then(i=>{i.saveUserLocally(),i.syncToSupabase().catch(()=>{})}),me(),H(),F(),xt(),o.primary!==t&&Co(t,o.primary)}function Co(e,t){const o=document.getElementById("archetype-shift-toast");o&&o.remove();const i=document.createElement("div");i.id="archetype-shift-toast",i.innerHTML=`
  ...
  `,document.body.appendChild(i),setTimeout(()=>{i.style.transition="opacity 0.4s",i.style.opacity="0",setTimeout(()=>i.remove(),400)},4e3)}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function xt(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}let re=null;const T=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],je={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},Bo={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function _o(e,t,o=220){const i=T.length,n=o/2,r=o/2,s=o*.36,a=v=>v/i*Math.PI*2-Math.PI/2,c=(v,x)=>({x:n+s*x*Math.cos(a(v)),y:r+s*x*Math.sin(a(v))}),l=[.25,.5,.75,1].map(v=>`<polygon points="${T.map((w,E)=>`${c(E,v).x},${c(E,v).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),d=T.map((v,x)=>{const w=c(x,1);return`<line x1="${n}" y1="${r}" x2="${w.x}" y2="${w.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),p=Math.max(...T.map(v=>e[v]||1)),h=`<polygon points="${T.map((v,x)=>{const w=c(x,(e[v]||1)/p);return`${w.x},${w.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let m="";if(t){const v=Math.max(...T.map(w=>t[w]||1));m=`<polygon points="${T.map((w,E)=>{const C=c(E,(t[w]||1)/v);return`${C.x},${C.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const I=T.map((v,x)=>{const w=c(x,(e[v]||1)/p);return`<circle cx="${w.x}" cy="${w.y}" r="2.5" fill="var(--blue)"/>`}).join(""),S=22,u=T.map((v,x)=>{const w=c(x,1+S/s),E=w.x<n-5?"end":w.x>n+5?"start":"middle";return`<text x="${w.x}" y="${w.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${E}" dominant-baseline="middle">${Bo[v]}</text>`}).join(""),g=36;return`<svg width="${o+g*2}" height="${o+g*2}" viewBox="${-g} ${-g} ${o+g*2} ${o+g*2}" style="overflow:visible;display:block">
    ${l}${d}${m}${h}${I}${u}
  </svg>`}function zo(e){return e.length?T.map(t=>{const o=e.filter(s=>s.scores?.[t]!=null),i=o.length?o.reduce((s,a)=>s+a.scores[t],0)/o.length:null,n=i!=null?i.toFixed(1):"—",r=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);width:88px;flex-shrink:0">${je[t]}</div>
      ...
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:white;padding:4px 11px 3px;background:${To(o.total)};border-radius:4px;flex-shrink:0">${r}</div>
      </div>
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function Ao(e,t){const o=V[e.archetype]||{},i=t.length?(t.reduce((c,l)=>c+l.total,0)/t.length).toFixed(1):"—",n=T.map(c=>{const l=t.filter(d=>d.scores?.[c]!=null);return{c,avg:l.length?l.reduce((d,p)=>d+p.scores[c],0)/l.length:0}}),r=t.length?[...n].sort((c,l)=>l.avg-c.avg)[0]:null,s=o.quote||"",a=o.palette||"#3d5a80";return`
    <div style="width:320px;height:440px;flex-shrink:0;border:1px solid var(--ink);background:var(--paper);overflow:hidden;display:flex;flex-direction:column;justify-content:space-between;box-sizing:border-box">
      ...
      <div style="padding:0 28px 24px">
        <div style="border-top:1px solid var(--rule);padding-top:14px;display:flex;justify-content:space-between;font-family:'DM Mono',monospace;font-size:9px;color:var(--dim)">
          ...
          ${r?`<span>best: ${je[r.c]}</span>`:`<span>avg ${i}</span>`}
          <span>palatemap.com</span>
        </div>
      </div>
    </div>
  `}function jo(e,t){const o=[...t].sort((r,s)=>s.total-r.total).slice(0,3),i=t.length?(t.reduce((r,s)=>r+s.total,0)/t.length).toFixed(1):"—",n=V[e.archetype]||{};return`
...
`),o=t[0].split(",").map(i=>i.replace(/^"|"$/g,"").trim());return t.slice(1).map(i=>{const n=[];let r="",s=!1;for(const a of i)a==='"'?s=!s:a===","&&!s?(n.push(r.trim()),r=""):r+=a;return n.push(r.trim()),Object.fromEntries(o.map((a,c)=>[a,n[c]||""]))})}window.profileHandleLetterboxdDrop=function(e){e.preventDefault();const t=document.getElementById("profile-import-drop");t&&(t.style.borderColor="var(--rule-dark)");const o=e.dataTransfer.files[0];o&&bt(o)};window.profileHandleLetterboxdFile=function(e){const t=e.files[0];t&&bt(t)};function bt(e){const t=new FileReader;t.onload=o=>{try{const n=Po(o.target.result).filter(d=>d.Name&&d.Rating&&parseFloat(d.Rating)>0).map(d=>({title:d.Name,year:parseInt(d.Year)||null,total:Math.round(parseFloat(d.Rating)*20),scores:{},director:"",writer:"",cast:"",productionCompanies:"",poster:null,overview:""}));if(n.length===0)throw new Error("No rated films found");const r=new Set(f.map(d=>`${d.title.toLowerCase().trim()}|${d.year||""}`)),s=n.filter(d=>!r.has(`${d.title.toLowerCase().trim()}|${d.year||""}`)),a=n.length-s.length;re=s;const c=document.getElementById("profile-import-status"),l=document.getElementById("profile-import-btn");if(s.length===0)c&&(c.textContent=`All ${a} film${a!==1?"s":""} already exist — nothing to import.`,c.style.color="var(--dim)"),l&&(l.disabled=!0);else{c&&(c.textContent=`${s.length} new film${s.length!==1?"s":""} found${a?` · ${a} already rated (skipped)`:""}`,c.style.color="var(--green)");const d=document.getElementById("profile-import-drop");d&&(d.style.borderColor="var(--green)",d.innerHTML=`<div style="font-family:'DM Mono',monospace;font-size:12px;color:var(--green)">${e.name}</div><div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--green);margin-top:3px">${s.length} films ready</div>`),l&&(l.disabled=!1,l.textContent=`Add ${s.length} film${s.length!==1?"s":""} →`)}}catch{const n=document.getElementById("profile-import-status");n&&(n.textContent="Couldn't parse that file — make sure it's ratings.csv from Letterboxd.",n.style.color="var(--red)")}},t.readAsText(e)}window.profileConfirmImport=async function(){if(!re||re.length===0)return;const e=[...f,...re];pe(e),oe(),F(),re=null,xe().catch(()=>{}),window.showScreen?.("calibrate")};function Pe(){const e=document.getElementById("profileContent");if(!e)return;const t=b;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=V[t.archetype]||{},i=t.weights||{},n=o.weights||null,r=f,s=T.map(l=>{const d=r.filter(p=>p.scores?.[l]!=null);return{c:l,avg:d.length?d.reduce((p,k)=>p+k.scores[l],0)/d.length:0}}),a=r.length?[...s].sort((l,d)=>d.avg-l.avg)[0]:null,c=r.length?(r.reduce((l,d)=>l+d.total,0)/r.length).toFixed(1):"—";e.innerHTML=`
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin-top:24px;border-top:2px solid var(--ink)">
          ...
          ${a?`<div style="padding:16px 0 16px 20px">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:32px;color:var(--blue);line-height:1;letter-spacing:-1px">${je[a.c]}</div>
          </div>`:""}
        </div>`:""}
      </div>
  ...
  `}function wt(e){document.querySelectorAll(".screen").forEach(t=>t.classList.remove("active")),document.getElementById(e).classList.add("active"),document.querySelectorAll(".nav-btn, .nav-mobile-btn").forEach(t=>{t.classList.toggle("active",t.getAttribute("onclick")?.includes(`'${e}'`))}),e==="analysis"&&Te(),e==="calibration"&&Ae(),e==="predict"&&tt(),e==="profile"&&Pe(),localStorage.setItem("ledger_last_screen",e)}function Re(){const e=document.getElementById("storageStatus");e&&(f.length>0?(e.textContent=`✓ ${f.length} films · saved`,e.style.color="var(--green)"):(e.textContent="no films yet",e.style.color="var(--dim)"))}function Oe(){const e=b;if(!e)return;const t=document.getElementById("mastheadLeft");t.innerHTML=`<span class="profile-chip" onclick="document.getElementById('nav-profile').click()">
    <strong style="color:var(--ink);font-family:'DM Mono',monospace;font-size:11px;letter-spacing:0.5px">${e.display_name}</strong>
  </span>`}function kt(){const e=new Blob([JSON.stringify(f,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="film_rankings.json",t.click()}function $t(){confirm("Clear all your films and start fresh? This cannot be undone.")&&(localStorage.removeItem("filmRankings_v1"),localStorage.removeItem("ledger_user"),location.reload())}function Mt(){const e=document.getElementById("cold-landing");e?e.style.display="flex":ke()}window.startFromLanding=function(){const e=document.getElementById("cold-landing");e&&(e.style.display="none"),ke()};async function Ro(){jt(),At(),Qe(),b?(ae("syncing"),Oe(),me(),Ke(b.id).catch(()=>ae("error"))):(ae("local"),setTimeout(()=>Mt(),400)),H(),Re();const e=localStorage.getItem("ledger_last_screen"),t=e==="explore"?"analysis":e;if(t&&t!=="rankings"&&document.getElementById(t)){const o=document.querySelectorAll(".nav-btn");o.forEach(i=>i.classList.remove("active")),document.querySelectorAll(".screen").forEach(i=>i.classList.remove("active")),document.getElementById(t).classList.add("active"),o.forEach(i=>{i.getAttribute("onclick")?.includes(t)&&i.classList.add("active")}),t==="analysis"&&Te(),t==="profile"&&Pe()}}function ae(e){const t=document.getElementById("cloudDot"),o=document.getElementById("cloudLabel");t.className="cloud-dot",e==="syncing"?(t.classList.add("syncing"),o.textContent="syncing…"):e==="synced"?(t.classList.add("synced"),o.textContent=b?b.display_name:"synced"):e==="error"?(t.classList.add("error"),o.textContent="offline"):o.textContent="local"}window.__ledger={showScreen:wt,sortBy:Ve,openModal:Nt,closeModal:Ut,exploreEntity:Yt,renderExploreIndex:ze,renderAnalysis:Te,initPredict:tt,predictSearch:ot,predictSearchDebounce:Xt,predictSelectFilm:Zt,predictAddToList:no,startCalibration:co,selectCalCat:so,selectCalInt:ao,applyCalibration:mo,resetCalibration:Ae,launchOnboarding:ke,liveSearch:st,tmdbSelect:at,toggleCast:ct,showMoreCast:dt,toggleCompany:pt,resetToSearch:mt,confirmTmdbData:ft,goToStep3:yt,goToStep4:ut,saveFilm:gt,goToStep:rt,renderProfile:Pe,setViewMode:Ye,showSyncPanel:Eo,openArchetypeModal:vt,closeArchetypeModal:xt,previewWeight:ht,resetArchetypeWeights:Io,saveArchetypeWeights:Do,exportData:kt,resetStorage:$t,updateStorageStatus:Re,updateMastheadProfile:Oe,setCloudStatus:ae};const Oo=["showScreen","sortBy","openModal","closeModal","exploreEntity","renderExploreIndex","initPredict","predictSearch","predictSearchDebounce","predictSelectFilm","predictAddToList","startCalibration","selectCalCat","selectCalInt","applyCalibration","resetCalibration","launchOnboarding","liveSearch","tmdbSelect","toggleCast","showMoreCast","toggleCompany","resetToSearch","confirmTmdbData","goToStep3","goToStep4","saveFilm","goToStep","renderProfile","setViewMode","showSyncPanel","openArchetypeModal","closeArchetypeModal","previewWeight","resetArchetypeWeights","saveArchetypeWeights","exportData","resetStorage","renderAnalysis"];Oo.forEach(e=>{window[e]=window.__ledger[e]});Ro();const ie=Object.freeze(Object.defineProperty({__proto__:null,exportData:kt,resetStorage:$t,setCloudStatus:ae,showColdLanding:Mt,showScreen:wt,updateMastheadProfile:Oe,updateStorageStatus:Re},Symbol.toStringTag,{value:"Module"}));export{M as C,f as M,b as c};
