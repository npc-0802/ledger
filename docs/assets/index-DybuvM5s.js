(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function o(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=o(a);fetch(a.href,n)}})();const M=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],$=null;function ye(e){$=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const wt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function _(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function J(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of wt)if(e>=t)return o;return"Unwatchable"}function Q(e){let t=0,o=0;for(const i of M)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function le(){y.forEach(e=>{e.total=Q(e.scores)})}function K(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function ce(){if(!$||!$.weights)return;const e=$.weights;M.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),le()}let P={key:"total",dir:"desc"},De="grid";const kt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Execution"},{key:"acting",label:"Acting"},{key:"production",label:"Production"},{key:"enjoyability",label:"Enjoyability"},{key:"rewatchability",label:"Rewatchability"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Uniqueness"}];function $t(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function Mt(){const{key:e,dir:t}=P;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function He(e){De=e,N()}function Fe(e){P.key===e?P.dir=P.dir==="desc"?"asc":"desc":(P.key=e,P.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=P.dir==="desc"?"↓":"↑")}N()}function N(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=y.length+" films ranked";const i=Mt();De==="grid"?Et(i,e,o,t):St(i,e,o,t)}function Ue(e){const t=P.key;return`<div class="rankings-toolbar">
    ${De==="grid"?`
  ...
  </div>`}function Et(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Ue("grid"));const a=["total","rank","title"].includes(P.key)?"total":P.key,n=[...y].sort((r,c)=>c.total-r.total),s=new Map(n.map((r,c)=>[r.title,c+1]));t.innerHTML=`<div class="film-grid">
    ${e.map(r=>{const c=a==="total"?r.total:r.scores?.[a]??null,l=c!=null?a==="total"?(Math.round(c*10)/10).toFixed(1):c:"—",d=$t(c),p=r.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${r.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${y.indexOf(r)})">
        <div class="film-card-poster-wrap">
          ${p}
          <div class="film-card-rank">${s.get(r.title)}</div>
  ...
  </div>`}function St(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Ue("table"));const a=[...y].sort((s,r)=>r.total-s.total),n=new Map(a.map((s,r)=>[s.title,r+1]));t.innerHTML=e.map(s=>{const r=s.scores,c=n.get(s.title),l=s.total!=null?(Math.round(s.total*10)/10).toFixed(1):"—",d=s.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${s.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${y.indexOf(s)})">
      ...
      <div class="film-total">${l}</div>
    </div>`}).join("")}const Dt=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:N,setViewMode:He,sortBy:Fe},Symbol.toStringTag,{value:"Module"})),It="modulepreload",Ct=function(e){return"/"+e},Pe={},B=function(t,o,i){let a=Promise.resolve();if(o&&o.length>0){let c=function(l){return Promise.all(l.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),r=s?.nonce||s?.getAttribute("nonce");a=c(o.map(l=>{if(l=Ct(l),l in Pe)return;Pe[l]=!0;const d=l.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const x=document.createElement("link");if(x.rel=d?"stylesheet":It,d||(x.as="script"),x.crossOrigin="",x.href=l,r&&x.setAttribute("nonce",r),document.head.appendChild(x),d)return new Promise((h,m)=>{x.addEventListener("load",h),x.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(s){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=s,window.dispatchEvent(r),!r.defaultPrevented)throw s}return a.then(s=>{for(const r of s||[])r.status==="rejected"&&n(r.reason);return t().catch(n)})},Oe="palate_migrations_v1";function _t(){let e;try{e=JSON.parse(localStorage.getItem(Oe)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;y.forEach(o=>{const i=_((o.cast||"").split(",").map(n=>n.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const a=_((o.productionCompanies||"").split(",").map(n=>n.trim()).filter(Boolean)).join(", ");a!==(o.productionCompanies||"")&&(o.productionCompanies=a,t++)}),t>0&&(Y(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(Oe,JSON.stringify(e))}catch{}}}const We="filmRankings_v1";function Y(){try{localStorage.setItem(We,JSON.stringify(y))}catch(e){console.warn("localStorage save failed:",e)}$&&(clearTimeout(Y._syncTimer),Y._syncTimer=setTimeout(()=>{B(()=>Promise.resolve().then(()=>Ge),void 0).then(e=>e.syncToSupabase())},2e3))}function Bt(){try{const e=localStorage.getItem(We);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;ue(t),console.log(`Loaded ${y.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const zt="https://gzuuhjjedrzeqbgxhfip.supabase.co",Tt="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ge=window.supabase.createClient(zt,Tt);async function Ie(){const e=$;if(!e)return;const{setCloudStatus:t}=await B(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>te);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ge.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:y,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),de()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function Ye(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await B(async()=>{const{setCloudStatus:n,updateMastheadProfile:s,updateStorageStatus:r}=await Promise.resolve().then(()=>te);return{setCloudStatus:n,updateMastheadProfile:s,updateStorageStatus:r}},void 0),{renderRankings:a}=await B(async()=>{const{renderRankings:n}=await Promise.resolve().then(()=>Dt);return{renderRankings:n}},void 0);t("syncing");try{const{data:n,error:s}=await ge.from("ledger_users").select("*").eq("id",e).single();if(s)throw s;if(n){if(ye({id:n.id,username:n.username,display_name:n.display_name,archetype:n.archetype,archetype_secondary:n.archetype_secondary,weights:n.weights,harmony_sensitivity:n.harmony_sensitivity}),n.movies&&Array.isArray(n.movies)&&n.movies.length>=y.length){const r=n.movies.map(c=>({...c,cast:_((c.cast||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", "),productionCompanies:_((c.productionCompanies||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", ")}));ue(r)}de(),ce(),t("synced"),o(),a(),i()}}catch(n){console.warn("Supabase load error:",n),t("error")}}function de(){try{localStorage.setItem("ledger_user",JSON.stringify($))}catch{}}function Ve(){try{const e=localStorage.getItem("ledger_user");e&&ye(JSON.parse(e))}catch{}}const Ge=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:Ye,loadUserLocally:Ve,saveUserLocally:de,sb:ge,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),At=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function we(e){for(const[t,o]of At)if(e>=t)return o;return"Unwatchable"}let ve=null,T=!1,R={};function Lt(e){ve=e,T=!1,R={},he()}function he(){const e=ve,t=y[e],o=[...y].sort((u,g)=>g.total-u.total),i=o.indexOf(t)+1;o.filter(u=>u!==t&&Math.abs(u.total-t.total)<6).slice(0,5);const a={};M.forEach(u=>{const g=[...y].sort((v,b)=>(b.scores[u.key]||0)-(v.scores[u.key]||0));a[u.key]=g.indexOf(t)+1});const n=(u,g,v)=>`<span class="modal-meta-chip" onclick="exploreEntity('${g}','${v.replace(/'/g,"'")}')">${u}</span>`,s=_((t.director||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"director",u)).join(""),r=_((t.writer||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"writer",u)).join(""),c=_((t.cast||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"actor",u)).join(""),l=_((t.productionCompanies||"").split(",").map(u=>u.trim()).filter(Boolean)).map(u=>n(u,"company",u)).join(""),d=t.poster?`<div class="dark-grid" style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,p=T?R:t.scores,x=T?Q(R):t.total,h=["plot","execution","acting","production"],m=["enjoyability","rewatchability","ending","uniqueness"];function E(u,g){const v=M.filter(S=>g.includes(S.key)),b=`<div style="font-family:'DM Mono',monospace;font-size:9px;letter-spacing:2.5px;text-transform:uppercase;color:var(--dim);opacity:0.6;padding:12px 0 6px;border-bottom:1px solid var(--rule)">${u}</div>`,w=v.map(S=>{const I=p[S.key],bt=a[S.key];return T?`<div class="breakdown-row" style="align-items:center;gap:12px">
  ...
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),T||jt(t)}window.modalEnterEdit=function(){const e=y[ve];T=!0,R={...e.scores},he()};window.modalCancelEdit=function(){T=!1,R={},he()};window.modalUpdateScore=function(e,t){R[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${K(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=we(parseInt(t)));const a=Q(R),n=document.getElementById("modal-total-display");n&&(n.textContent=a);const s=document.getElementById("modal-total-label");s&&(s.textContent=we(a))};window.modalSaveScores=function(){const e=y[ve];e.scores={...R},e.total=Q(R),T=!1,R={},le(),Y(),N(),Ie().catch(t=>console.warn("sync failed",t)),he()};async function jt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await B(async()=>{const{getFilmInsight:a}=await import("./insights-BfFJtwHm.js");return{getFilmInsight:a}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function Pt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let H="directors";function U(e){return _((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Ot(e){const t={};return y.forEach(o=>{let i=[];e==="directors"?i=U(o.director):e==="writers"?i=U(o.writer):e==="actors"?i=U(o.cast):e==="companies"?i=U(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(a=>{t[a]||(t[a]=[]),t[a].push(o)})}),t}function Je(e){const t=Ot(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((a,n)=>a+n.total,0)/i.length).toFixed(1)),catAvgs:M.reduce((a,n)=>{const s=i.filter(r=>r.scores[n.key]!=null).map(r=>r.scores[n.key]);return a[n.key]=s.length?parseFloat((s.reduce((r,c)=>r+c,0)/s.length).toFixed(1)):null,a},{})})).sort((o,i)=>i.avg-o.avg)}function Ke(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function Ce(e){e&&(H=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Je(H),a=document.getElementById("explore-section");a&&(a.innerHTML=`
    ...
    ${i.length===0?`<div style="border:1.5px dashed var(--rule-dark);padding:40px 32px;text-align:center;margin:8px 0">
        ...
        </div>`:i.map((n,s)=>{const r=n.name.replace(/'/g,"\\'");return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule);cursor:pointer" onclick="exploreEntity('${H==="companies"?"company":H==="years"?"year":H.slice(0,-1)}','${r}')" onmouseover="this.style.background='var(--cream)'" onmouseout="this.style.background=''">
  ...
  `)}function qt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";H=i;const a=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",n=y.filter(m=>e==="director"?U(m.director).includes(t):e==="writer"?U(m.writer).includes(t):e==="actor"?U(m.cast).includes(t):e==="company"?U(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,E)=>E.total-m.total);if(n.length===0){Ce();return}const s=Je(i),r=s.findIndex(m=>m.name===t)+1,c=s.length,l=s.find(m=>m.name===t),d=l?l.avg.toFixed(1):(n.reduce((m,E)=>m+E.total,0)/n.length).toFixed(1);n[0];const p={};M.forEach(m=>{const E=s.filter(u=>u.catAvgs[m.key]!=null).sort((u,g)=>g.catAvgs[m.key]-u.catAvgs[m.key]),D=E.findIndex(u=>u.name===t)+1;p[m.key]=D>0?{rank:D,total:E.length}:null});const x=M.map(m=>{const E=n.filter(D=>D.scores[m.key]!=null).map(D=>D.scores[m.key]);return{...m,avg:E.length?parseFloat((E.reduce((D,u)=>D+u,0)/E.length).toFixed(1)):null}}),h=x.filter(m=>m.avg!=null).sort((m,E)=>E.avg-m.avg);h[0],h[h.length-1],document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:800px">
      ...
      <div class="dark-grid" style="background:var(--surface-dark);margin:-40px -56px 32px;padding:40px 56px 32px">
        <div style="font-family:'DM Mono',monospace;font-size:10px;letter-spacing:2px;text-transform:uppercase;color:var(--on-dark-dim);margin-bottom:14px">
          ${a} &nbsp;·&nbsp; <span onclick="renderAnalysis()" style="cursor:pointer;text-decoration:underline;text-underline-offset:2px">← all ${i}</span>
        </div>
  ...
  `,Rt(e,t,n)}async function Rt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:a}=await B(async()=>{const{getEntityInsight:s}=await import("./insights-BfFJtwHm.js");return{getEntityInsight:s}},[]),n=await a(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const n=document.getElementById("explore-insight");n&&(n.style.display="none")}}function _e(){const e=i=>i.length?Math.round(i.reduce((a,n)=>a+n,0)/i.length*100)/100:null,t=M.map(i=>{const a=y.map(n=>n.scores[i.key]).filter(n=>n!=null);return{...i,avg:e(a)}});function o(i){return i>=90?"#C4922A":i>=80?"#1F4A2A":i>=70?"#4A5830":i>=60?"#6B4820":"rgba(12,11,9,0.65)"}document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:900px">
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        ${(()=>{const i=["plot","execution","acting","production"],a=["enjoyability","rewatchability","ending","uniqueness"],n=t.filter(l=>l.avg!=null&&!isNaN(l.avg)),s=n.filter(l=>i.includes(l.key)),r=n.filter(l=>a.includes(l.key));function c(l,d){return d.length?`
              ...
              </div>`:""}return c("Craft",s)+c("Experience",r)})()}
      </div>
  ...
  `,Ce()}const ke="f5a446a5f70a9f6a16a8ddd052c121f2",$e="https://api.themoviedb.org/3",Nt="https://ledger-proxy.noahparikhcott.workers.dev";let qe=null,Z=null,Me=null;function Qe(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",Z=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function Ht(){clearTimeout(qe),qe=setTimeout(Xe,500)}async function Xe(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const a=((await(await fetch(`${$e}/search/movie?api_key=${ke}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!a.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const n=new Set(y.map(s=>s.title.toLowerCase()));t.innerHTML=a.map(s=>{const r=s.release_date?.slice(0,4)||"",c=s.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${s.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',l=n.has(s.title.toLowerCase());return`<div class="tmdb-result ${l?"opacity-50":""}" onclick="${l?"":`predictSelectFilm(${s.id}, '${s.title.replace(/'/g,"\\'")}', '${r}')`}" style="${l?"opacity:0.4;cursor:default":""}">
    ...
    </div>`;let i={},a={};try{const[p,x]=await Promise.all([fetch(`${$e}/movie/${e}?api_key=${ke}`),fetch(`${$e}/movie/${e}/credits?api_key=${ke}`)]);i=await p.json(),a=await x.json()}catch{}const n=(a.crew||[]).filter(p=>p.job==="Director").map(p=>p.name).join(", "),s=(a.crew||[]).filter(p=>["Screenplay","Writer","Story"].includes(p.job)).map(p=>p.name).slice(0,2).join(", "),r=(a.cast||[]).slice(0,8).map(p=>p.name).join(", "),c=(i.genres||[]).map(p=>p.name).join(", "),l=i.overview||"",d=i.poster_path||null;Z={tmdbId:e,title:t,year:o,director:n,writer:s,cast:r,genres:c,overview:l,poster:d},await Yt(Z)}function Ut(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(s=>{const r=y.filter(d=>d.scores[s]!=null).map(d=>d.scores[s]);if(!r.length){t[s]={mean:70,std:10,min:0,max:100};return}const c=r.reduce((d,p)=>d+p,0)/r.length,l=Math.sqrt(r.reduce((d,p)=>d+(p-c)**2,0)/r.length);t[s]={mean:Math.round(c*10)/10,std:Math.round(l*10)/10,min:Math.min(...r),max:Math.max(...r)}});const o=[...y].sort((s,r)=>r.total-s.total),i=o.slice(0,10).map(s=>`${s.title} (${s.total})`).join(", "),a=o.slice(-5).map(s=>`${s.title} (${s.total})`).join(", "),n=M.map(s=>`${s.label}×${s.weight}`).join(", ");return{stats:t,top10:i,bottom5:a,weightStr:n,archetype:$?.archetype,archetypeSecondary:$?.archetype_secondary,totalFilms:y.length}}function Wt(e){const t=_((e.director||"").split(",").map(i=>i.trim()).filter(Boolean)),o=_((e.cast||"").split(",").map(i=>i.trim()).filter(Boolean));return y.filter(i=>{const a=_((i.director||"").split(",").map(s=>s.trim()).filter(Boolean)),n=_((i.cast||"").split(",").map(s=>s.trim()).filter(Boolean));return t.some(s=>a.includes(s))||o.some(s=>n.includes(s))}).sort((i,a)=>a.total-i.total).slice(0,8)}async function Yt(e){const t=Ut(),o=Wt(e),i=o.length?o.map(r=>`- ${r.title} (${r.year||""}): total=${r.total}, plot=${r.scores.plot}, execution=${r.scores.execution}, acting=${r.scores.acting}, production=${r.scores.production}, enjoyability=${r.scores.enjoyability}, rewatchability=${r.scores.rewatchability}, ending=${r.scores.ending}, uniqueness=${r.scores.uniqueness}`).join(`
`):"No direct comparisons found in rated list.",a=Object.entries(t.stats).map(([r,c])=>`${r}: mean=${c.mean}, std=${c.std}, range=${c.min}–${c.max}`).join(`
`),n="You are a precise film taste prediction engine. Your job is to predict how a specific user would score an unrated film, based on their detailed rating history and taste profile. You must respond ONLY with valid JSON — no preamble, no markdown, no explanation outside the JSON.",s=`USER TASTE PROFILE:
...
Respond with this exact JSON structure:
{
...
}`;try{const d=((await(await fetch(Nt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:n,messages:[{role:"user",content:s}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),p=JSON.parse(d);Me=p,Vt(e,p,o)}catch(r){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${r.message}. Check that the proxy is running and your API key is valid.</div>`}}function Vt(e,t,o){let i=0,a=0;M.forEach(l=>{const d=t.predicted_scores[l.key];d!=null&&(i+=d*l.weight,a+=l.weight)});const n=a>0?Math.round(i/a*100)/100:0,s=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,r={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",c={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
  ...
  `}function Gt(){Z&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Z.title,B(()=>Promise.resolve().then(()=>fo),void 0).then(t=>{Me?.predicted_scores&&t.prefillWithPrediction(Me.predicted_scores),t.liveSearch(Z.title)}))},100))}let oe="all",Ze="focused",V=[],A=0,C={},L={},ae=[];const Jt={focused:15,thorough:30,deep:50},Re=8;function Kt(e){oe=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Qt(e){Ze=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Xt(e,t){const o=[];(e==="all"?M.map(s=>s.key):[e]).forEach(s=>{const r=y.filter(c=>c.scores[s]!=null).sort((c,l)=>c.scores[s]-l.scores[s]);for(let c=0;c<r.length-1;c++)for(let l=c+1;l<r.length;l++){const d=Math.abs(r[c].scores[s]-r[l].scores[s]);if(d<=8)o.push({a:r[c],b:r[l],catKey:s,diff:d});else break}}),o.sort((s,r)=>s.diff-r.diff);const a=new Set,n=[];for(const s of o){const r=[s.a.title,s.b.title,s.catKey].join("|");a.has(r)||(a.add(r),n.push(s))}return n.sort(()=>Math.random()-.5).slice(0,t)}function Zt(){const e=Jt[Ze];if(V=Xt(oe,e),V.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}A=0,C={},L={},ae=[],y.forEach(t=>{L[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=oe==="all"?"All categories":M.find(t=>t.key===oe)?.label||oe,Be()}function Be(){if(A>=V.length){eo();return}const{a:e,b:t,catKey:o}=V[A],i=V.length,a=Math.round(A/i*100);document.getElementById("cal-progress-label").textContent=`${A+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=a+"%";const n=M.find(c=>c.key===o)?.label||o;L[e.title]?.[o]??e.scores[o],L[t.title]?.[o]??t.scores[o];function s(c,l){const d=c.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${c.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
      <div class="cal-film-card" id="cal-card-${l}" onclick="calChoose('${l}')">
        <div style="aspect-ratio:2/3;overflow:hidden;background:var(--cream);position:relative;margin-bottom:12px">
          ${d}
        </div>
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-size:15px;font-weight:700;line-height:1.3;color:var(--ink);margin-bottom:4px">${c.title}</div>
        <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim)">${c.year||""}</div>
  ...
  `}window.undoCalChoice=function(){if(ae.length===0)return;const e=ae.pop();A=e.idx,L=e.tempScores,C=e.deltas,Be()};window.calChoose=function(e){if(ae.push({idx:A,tempScores:JSON.parse(JSON.stringify(L)),deltas:JSON.parse(JSON.stringify(C))}),e!=="skip"){const{a:t,b:o,catKey:i}=V[A],a=L[t.title]?.[i]??t.scores[i],n=L[o.title]?.[i]??o.scores[i],s=1/(1+Math.pow(10,(n-a)/40)),r=1-s,c=e==="a"?1:0,l=1-c,d=Math.round(Math.min(100,Math.max(1,a+Re*(c-s)))),p=Math.round(Math.min(100,Math.max(1,n+Re*(l-r))));if(C[t.title]||(C[t.title]={}),C[o.title]||(C[o.title]={}),d!==a){const m=C[t.title][i]?.old??a;C[t.title][i]={old:m,new:d},L[t.title][i]=d}if(p!==n){const m=C[o.title][i]?.old??n;C[o.title][i]={old:m,new:p},L[o.title][i]=p}const x=document.getElementById(`cal-card-${e}`),h=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);x&&(x.style.opacity="1"),h&&(h.style.opacity="0.35",h.style.transform="scale(0.97)")}A++,setTimeout(()=>Be(),e==="skip"?0:140)};function eo(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(C).flatMap(([o,i])=>Object.entries(i).map(([a,{old:n,new:s}])=>({title:o,catKey:a,old:n,new:s}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ${M.map(o=>{const i=t[o.key],a=i.slice(0,3),n=i.length-3,s=i.length>0;return`<div style="padding:14px;background:var(--cream);border-radius:6px;${s?"":"opacity:0.45"}">
          ...
          ${a.map((r,c)=>{const l=r.new>r.old?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;${c<a.length-1?"border-bottom:1px solid var(--rule)":""}">
    ...
    `;else if(typeof k=="number"){const t=oo[k],o=Math.round(k/6*100),i=k===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;line-height:1.8;color:var(--dim);margin-bottom:28px;font-style:italic">The films you're drawn to reveal something consistent about you — a set of values, sensitivities, and hungers that show up again and again. A few questions to surface them.</div>`:"";e.innerHTML=`
      ...
      ${t.options.map(a=>`
        <div class="ob-option ${ee[k]===a.key?"selected":""}" onclick="obSelectAnswer(${k}, '${a.key}', this)">
          <span class="ob-option-key">${a.key}</span>
          <span class="ob-option-text">${a.text}</span>
        </div>`).join("")}
      <div class="ob-nav">
  ...
  </div>`}function at(e){j[e]&&(j[e].checked=!j[e].checked);const t=document.getElementById("castItem_"+e),o=j[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function st(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,ie.slice(8,20).forEach(i=>{j[i.id]||(j[i.id]={actor:i,checked:!1})});const o=ie.slice(0,20);nt(o),e.textContent="+ More cast",e.disabled=!1,ie.length<=20&&(e.style.display="none")}function so(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
    ...
    ${e.length===0?'<span style="font-size:13px;color:var(--dim)">None listed</span>':""}
  </div>`}function rt(e){G[e].checked=!G[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(G[e].checked?"checked":"unchecked")}function lt(){se=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function ct(){const e=f._allDirectors||[],t=f._allWriters||[],o=Object.values(j).filter(a=>a.checked).map(a=>a.actor.name),i=Object.values(G).filter(a=>a.checked).map(a=>a.company.name);f.title=f._tmdbDetail.title,f.director=e.join(", "),f.writer=t.join(", "),f.cast=o.join(", "),f.productionCompanies=i.join(", "),co(),pe(2)}let se=null;function ro(e){se=e}function lo(e){const t=[...y].filter(n=>n.scores[e]!=null).sort((n,s)=>s.scores[e]-n.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),a=new Set;return i.filter(n=>a.has(n.title)?!1:(a.add(n.title),!0))}function co(){const e=document.getElementById("calibrationCategories");e.innerHTML=M.map(t=>{const o=lo(t.key),i=se?.[t.key]??f.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
      ...
      <div class="anchor-row">
        ${o.map(a=>`
          <div class="anchor-film" onclick="selectAnchor('${t.key}', ${a.scores[t.key]}, this)">
            <div class="anchor-film-title">${a.title}</div>
            <div class="anchor-film-score">${t.label}: ${a.scores[t.key]}</div>
          </div>`).join("")}
      </div>`:""}
    ...
    </div>`}).join(""),M.forEach(t=>{f.scores[t.key]=se?.[t.key]??f.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(n=>n.classList.remove("selected")),o.classList.add("selected");const i=f.scores[e]??50,a=Math.round((i+t)/2);document.getElementById("slider_"+e).value=a,updateSlider(e,a)};window.updateSlider=function(e,t){t=parseInt(t),f.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=J(t)};function dt(){po(),pe(3)}let W=[],q=0,re=[];function po(){W=[],re=[],M.forEach(e=>{const t=f.scores[e.key];if(!t)return;y.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,a)=>Math.abs(i.scores[e.key]-t)-Math.abs(a.scores[e.key]-t)).slice(0,1).forEach(i=>W.push({cat:e,film:i}))}),W=W.slice(0,6),q=0,be()}function be(){const e=document.getElementById("hthContainer");if(W.length===0||q>=W.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
      No close comparisons needed — your scores are clearly differentiated. Click Continue.
    </div>`;return}const{cat:t,film:o}=W[q],i=f.scores[t.key];e.innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
      Comparison ${q+1} of ${W.length} &nbsp;·&nbsp; ${t.label} (×${t.weight})
    </div>
  ...
  `}window.hthChoice=function(e,t,o){re.push({idx:q,scores:{...f.scores}});const i=f.scores[t];e==="new"&&i<=o?f.scores[t]=o+1:e==="existing"&&i>=o&&(f.scores[t]=o-1),q++,be()};window.hthSkip=function(){re.push({idx:q,scores:{...f.scores}}),q++,be()};window.hthUndo=function(){if(re.length===0)return;const e=re.pop();q=e.idx,f.scores=e.scores,be()};function pt(){mo(),pe(4)}function mo(){const e=Q(f.scores);f.total=e;const t=[...y,f].sort((i,a)=>a.total-i.total),o=t.indexOf(f)+1;document.getElementById("resultCard").innerHTML=`
    ...
    <div style="margin-top:24px;padding-top:16px;border-top:1px solid var(--rule)">
      ...
      ${[-2,-1,0,1,2].map(i=>{const a=o+i;if(a<1||a>t.length)return"";const n=t[a-1],s=n===f,r=s?e:n.total,c=(Math.round(r*10)/10).toFixed(1);if(s)return`<div style="display:flex;align-items:center;gap:12px;padding:9px 12px;background:var(--ink);margin:2px 0">
            <span style="font-family:'DM Mono',monospace;font-size:10px;color:rgba(255,255,255,0.45);min-width:20px;text-align:right">${a}</span>
          ...
          <span style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);min-width:20px;text-align:right">${a}</span>
  ...
  `}function mt(){f.total=Q(f.scores),y.push({title:f.title,year:f.year,total:f.total,director:f.director,writer:f.writer,cast:f.cast,productionCompanies:f.productionCompanies||"",poster:f._tmdbDetail?.poster_path||null,overview:f._tmdbDetail?.overview||"",scores:{...f.scores}}),Y(),B(()=>Promise.resolve().then(()=>te),void 0).then(e=>e.updateStorageStatus()),f={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},j={},G={},ie=[],se=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",pe(1),N(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const fo=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:ct,goToStep:tt,goToStep3:dt,goToStep4:pt,liveSearch:ot,prefillWithPrediction:ro,resetToSearch:lt,saveFilm:mt,showMoreCast:st,tmdbSelect:it,toggleCast:at,toggleCompany:rt},Symbol.toStringTag,{value:"Module"}));function yo(){if(!$){B(()=>Promise.resolve().then(()=>ao),void 0).then(e=>e.launchOnboarding());return}ft()}function ft(){if(!$)return;const e=$.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
    ...
    <div id="archetype-weights-form">
      ${M.map(o=>{const i=e[o.key]||1,a=Math.round(i/t*100);return`<div class="archetype-weight-row">
          <div class="archetype-weight-label">${o.label}</div>
          <div class="archetype-weight-bar-wrap"><div class="archetype-weight-bar" id="awbar_${o.key}" style="width:${a}%"></div></div>
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function yt(e,t){const o=M.map(a=>({key:a.key,val:parseFloat(document.getElementById("awval_"+a.key)?.value)||1})),i=Math.max(...o.map(a=>a.val));o.forEach(a=>{const n=document.getElementById("awbar_"+a.key);n&&(n.style.width=Math.round(a.val/i*100)+"%")})}function uo(){if(!$||!$.archetype)return;const e=X[$.archetype]?.weights;e&&(M.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),yt())}function go(){const e={};M.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),$.weights=e,B(()=>Promise.resolve().then(()=>Ge),void 0).then(t=>t.saveUserLocally()),ce(),N(),Y(),ut()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ut(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const z=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],Te={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},vo={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function ho(e,t,o=220){const i=z.length,a=o/2,n=o/2,s=o*.36,r=v=>v/i*Math.PI*2-Math.PI/2,c=(v,b)=>({x:a+s*b*Math.cos(r(v)),y:n+s*b*Math.sin(r(v))}),l=[.25,.5,.75,1].map(v=>`<polygon points="${z.map((w,S)=>`${c(S,v).x},${c(S,v).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),d=z.map((v,b)=>{const w=c(b,1);return`<line x1="${a}" y1="${n}" x2="${w.x}" y2="${w.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),p=Math.max(...z.map(v=>e[v]||1)),h=`<polygon points="${z.map((v,b)=>{const w=c(b,(e[v]||1)/p);return`${w.x},${w.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let m="";if(t){const v=Math.max(...z.map(w=>t[w]||1));m=`<polygon points="${z.map((w,S)=>{const I=c(S,(t[w]||1)/v);return`${I.x},${I.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const E=z.map((v,b)=>{const w=c(b,(e[v]||1)/p);return`<circle cx="${w.x}" cy="${w.y}" r="2.5" fill="var(--blue)"/>`}).join(""),D=22,u=z.map((v,b)=>{const w=c(b,1+D/s),S=w.x<a-5?"end":w.x>a+5?"start":"middle";return`<text x="${w.x}" y="${w.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${S}" dominant-baseline="middle">${vo[v]}</text>`}).join(""),g=36;return`<svg width="${o+g*2}" height="${o+g*2}" viewBox="${-g} ${-g} ${o+g*2} ${o+g*2}" style="overflow:visible;display:block">
    ${l}${d}${m}${h}${E}${u}
  </svg>`}function xo(e){return e.length?z.map(t=>{const o=e.filter(s=>s.scores?.[t]!=null),i=o.length?o.reduce((s,r)=>s+r.scores[t],0)/o.length:null,a=i!=null?i.toFixed(1):"—",n=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      ...
      <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--ink);width:28px;text-align:right">${a}</div>
    </div>`}).join(""):`<p style="font-family:'DM Mono',monospace;font-size:11px;color:var(--dim)">No films rated yet.</p>`}function bo(e){return e==null?"rgba(12,11,9,0.65)":e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.65)"}function wo(e){const t=[...e].sort((o,i)=>i.total-o.total).slice(0,5);return t.length?t.map((o,i)=>{const a=o.poster?`<img style="width:34px;height:51px;object-fit:cover;display:block;flex-shrink:0" src="https://image.tmdb.org/t/p/w92${o.poster}" alt="" loading="lazy">`:'<div style="width:34px;height:51px;background:var(--cream);flex-shrink:0"></div>',n=o.total!=null?(Math.round(o.total*10)/10).toFixed(1):"—";return`
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="display:flex;align-items:center;justify-content:center;padding:4px 6px 4px 0;height:63px;flex-shrink:0">${a}</div>
    ...
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function ko(e,t){const o=X[e.archetype]||{},i=t.length?(t.reduce((c,l)=>c+l.total,0)/t.length).toFixed(1):"—",a=z.map(c=>{const l=t.filter(d=>d.scores?.[c]!=null);return{c,avg:l.length?l.reduce((d,p)=>d+p.scores[c],0)/l.length:0}}),n=t.length?[...a].sort((c,l)=>l.avg-c.avg)[0]:null,s=o.quote||"",r=o.palette||"#3d5a80";return`
    <div style="width:320px;border:1px solid var(--ink);background:var(--paper);overflow:hidden;display:flex;flex-direction:column;justify-content:space-between;min-height:400px">
      <div style="padding:28px 28px 0">
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(22px,4vw,28px);line-height:1.25;color:var(--ink);letter-spacing:-0.5px;margin-bottom:24px">${s}</div>
  ...
  `}function $o(e,t){const o=[...t].sort((n,s)=>s.total-n.total).slice(0,3),i=t.length?(t.reduce((n,s)=>n+s.total,0)/t.length).toFixed(1):"—",a=X[e.archetype]||{};return`
    <div style="width:320px;border:1px solid var(--ink);background:var(--paper);overflow:hidden">
      <div style="background:var(--surface-dark);padding:20px 24px 20px;border-bottom:3px solid ${a.palette||"#3d5a80"}">
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:22px;color:${a.palette||"var(--on-dark)"};margin-bottom:4px">${e.archetype}</div>
      ...
      <div style="padding:16px 24px">
        <div style="font-family:'DM Sans',sans-serif;font-size:11px;line-height:1.65;color:var(--dim);margin-bottom:12px">${a.description||""}</div>
  ...
  `}function Ae(){const e=document.getElementById("profileContent");if(!e)return;const t=$;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=X[t.archetype]||{},i=t.weights||{},a=o.weights||null,n=y,s=z.map(l=>{const d=n.filter(p=>p.scores?.[l]!=null);return{c:l,avg:d.length?d.reduce((p,x)=>p+x.scores[l],0)/d.length:0}}),r=n.length?[...s].sort((l,d)=>d.avg-l.avg)[0]:null,c=n.length?(n.reduce((l,d)=>l+d.total,0)/n.length).toFixed(1):"—";e.innerHTML=`
