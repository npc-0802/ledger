(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const w=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let u=[],b=null;function me(e){b=e}function fe(e){u.length=0,e.forEach(t=>u.push(t))}const xt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function be(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function U(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of xt)if(e>=t)return o;return"Unwatchable"}function V(e){let t=0,o=0;for(const i of w)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function ae(){u.forEach(e=>{e.total=V(e.scores)})}function W(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function re(){if(!b||!b.weights)return;const e=b.weights;w.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),ae()}let T={key:"total",dir:"desc"},De="grid";const bt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function wt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function kt(){const{key:e,dir:t}=T;return e==="rank"||e==="total"?[...u].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...u].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...u].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function qe(e){De=e,P()}function Re(e){T.key===e?T.dir=T.dir==="desc"?"asc":"desc":(T.key=e,T.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=T.dir==="desc"?"↓":"↑")}P()}function P(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(u.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=u.length+" films ranked";const i=kt();De==="grid"?$t(i,e,o,t):Mt(i,e,o,t)}function Ne(e){const t=T.key;return`<div class="rankings-toolbar">
    ${De==="grid"?`
  ...
  </div>`}function $t(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Ne("grid"));const n=["total","rank","title"].includes(T.key)?"total":T.key;t.innerHTML=`<div class="film-grid">
    ${e.map((s,a)=>{const r=n==="total"?s.total:s.scores?.[n]??null,m=r!=null?n==="total"?(Math.round(r*10)/10).toFixed(1):r:"—",p=wt(r),l=s.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${s.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${u.indexOf(s)})">
  ...
  </div>`}function Mt(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Ne("table"));const n=[...u].sort((a,r)=>r.total-a.total),s=new Map(n.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,m=s.get(a.title),p=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",l=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${u.indexOf(a)})">
      ...
      ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(c=>`<div class="film-score ${r[c]?W(r[c]):""}">${r[c]??"—"}</div>`).join("")}
      <div class="film-total">${p}</div>
    </div>`}).join("")}const Et=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:P,setViewMode:qe,sortBy:Re},Symbol.toStringTag,{value:"Module"})),St="modulepreload",Dt=function(e){return"/"+e},Le={},S=function(t,o,i){let n=Promise.resolve();if(o&&o.length>0){let m=function(p){return Promise.all(p.map(l=>Promise.resolve(l).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=a?.nonce||a?.getAttribute("nonce");n=m(o.map(p=>{if(p=Dt(p),p in Le)return;Le[p]=!0;const l=p.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${c}`))return;const v=document.createElement("link");if(v.rel=l?"stylesheet":St,l||(v.as="script"),v.crossOrigin="",v.href=p,r&&v.setAttribute("nonce",r),document.head.appendChild(v),l)return new Promise((d,g)=>{v.addEventListener("load",d),v.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return n.then(a=>{for(const r of a||[])r.status==="rejected"&&s(r.reason);return t().catch(s)})},He="filmRankings_v1";function Y(){try{localStorage.setItem(He,JSON.stringify(u))}catch(e){console.warn("localStorage save failed:",e)}b&&(clearTimeout(Y._syncTimer),Y._syncTimer=setTimeout(()=>{S(()=>Promise.resolve().then(()=>We),void 0).then(e=>e.syncToSupabase())},2e3))}function It(){try{const e=localStorage.getItem(He);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;fe(t),console.log(`Loaded ${u.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const Ct="https://gzuuhjjedrzeqbgxhfip.supabase.co",_t="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ye=window.supabase.createClient(Ct,_t);async function Ie(){const e=b;if(!e)return;const{setCloudStatus:t}=await S(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>Z);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ye.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:u,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),le()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function Fe(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await S(async()=>{const{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}=await Promise.resolve().then(()=>Z);return{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}},void 0),{renderRankings:n}=await S(async()=>{const{renderRankings:s}=await Promise.resolve().then(()=>Et);return{renderRankings:s}},void 0);t("syncing");try{const{data:s,error:a}=await ye.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;s&&(me({id:s.id,username:s.username,display_name:s.display_name,archetype:s.archetype,archetype_secondary:s.archetype_secondary,weights:s.weights,harmony_sensitivity:s.harmony_sensitivity}),s.movies&&Array.isArray(s.movies)&&s.movies.length>=u.length&&fe(s.movies),le(),re(),t("synced"),o(),n(),i())}catch(s){console.warn("Supabase load error:",s),t("error")}}function le(){try{localStorage.setItem("ledger_user",JSON.stringify(b))}catch{}}function Ue(){try{const e=localStorage.getItem("ledger_user");e&&me(JSON.parse(e))}catch{}}const We=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:Fe,loadUserLocally:Ue,saveUserLocally:le,sb:ye,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),Bt=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function we(e){for(const[t,o]of Bt)if(e>=t)return o;return"Unwatchable"}let ue=null,C=!1,j={};function zt(e){ue=e,C=!1,j={},ve()}function ve(){const e=ue,t=u[e],o=[...u].sort((f,h)=>h.total-f.total),i=o.indexOf(t)+1,n=o.filter(f=>f!==t&&Math.abs(f.total-t.total)<6).slice(0,5),s={};w.forEach(f=>{const h=[...u].sort((M,q)=>(q.scores[f.key]||0)-(M.scores[f.key]||0));s[f.key]=h.indexOf(t)+1});const a=(f,h,M)=>`<span class="modal-meta-chip" onclick="exploreEntity('${h}','${M.replace(/'/g,"'")}')">${f}</span>`,r=(t.director||"").split(",").map(f=>f.trim()).filter(Boolean).map(f=>a(f,"director",f)).join(""),m=(t.writer||"").split(",").map(f=>f.trim()).filter(Boolean).map(f=>a(f,"writer",f)).join(""),p=be((t.cast||"").split(",").map(f=>f.trim()).filter(Boolean)).map(f=>a(f,"actor",f)).join(""),l=be((t.productionCompanies||"").split(",").map(f=>f.trim()).filter(Boolean)).map(f=>a(f,"company",f)).join(""),c=t.poster?`<div style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,v=C?j:t.scores,d=C?V(j):t.total,g=w.map(f=>{const h=v[f.key],M=s[f.key];return C?`<div class="breakdown-row" style="align-items:center;gap:12px">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${W(h||50)}" id="modal-edit-val-${f.key}">${h||50}</div>
      ...
      <div class="breakdown-val ${h?W(h):""}">${h??"—"}</div>
      <div class="breakdown-wt">×${f.weight}</div>
    ...
    <div style="display:flex;align-items:baseline;gap:12px;margin-bottom:8px">
      ...
      <span style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)" id="modal-total-label">${U(d)}</span>
    </div>
  ...
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),C||Tt(t)}window.modalEnterEdit=function(){const e=u[ue];C=!0,j={...e.scores},ve()};window.modalCancelEdit=function(){C=!1,j={},ve()};window.modalUpdateScore=function(e,t){j[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${W(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=we(parseInt(t)));const n=V(j),s=document.getElementById("modal-total-display");s&&(s.textContent=n);const a=document.getElementById("modal-total-label");a&&(a.textContent=we(n))};window.modalSaveScores=function(){const e=u[ue];e.scores={...j},e.total=V(j),C=!1,j={},ae(),Y(),P(),Ie().catch(t=>console.warn("sync failed",t)),ve()};async function Tt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await S(async()=>{const{getFilmInsight:n}=await import("./insights-HZxE3pGO.js");return{getFilmInsight:n}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function At(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let J="directors";function R(e){return be((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Lt(e){const t={};return u.forEach(o=>{let i=[];e==="directors"?i=R(o.director):e==="writers"?i=R(o.writer):e==="actors"?i=R(o.cast):e==="companies"?i=R(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(n=>{t[n]||(t[n]=[]),t[n].push(o)})}),t}function Ye(e){const t=Lt(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((n,s)=>n+s.total,0)/i.length).toFixed(1)),catAvgs:w.reduce((n,s)=>{const a=i.filter(r=>r.scores[s.key]!=null).map(r=>r.scores[s.key]);return n[s.key]=a.length?parseFloat((a.reduce((r,m)=>r+m,0)/a.length).toFixed(1)):null,n},{})})).sort((o,i)=>i.avg-o.avg)}function Ve(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function ge(e){e&&(J=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ye(J);document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:800px">
      ...
      <div class="explore-tabs">
        ${t.map(n=>`<button class="explore-tab ${n===J?"active":""}" onclick="renderExploreIndex('${n}')">${o[n]}</button>`).join("")}
      </div>

      <div style="height:28px"></div>
      ${i.length===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim);font-style:italic;padding:48px 0">Not enough data yet — add more films to see patterns.</div>`:i.map((n,s)=>{const a=n.name.replace(/'/g,"\\'");return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule);cursor:pointer" onclick="exploreEntity('${J==="companies"?"company":J==="years"?"year":J.slice(0,-1)}','${a}')" onmouseover="this.style.background='var(--cream)'" onmouseout="this.style.background=''">
  ...
  `}function jt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(d=>d.classList.remove("active")),document.getElementById("explore").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(d=>d.classList.remove("active")),document.querySelectorAll(".nav-btn")[1].classList.add("active"),window.scrollTo(0,0),document.getElementById("exploreContent").scrollTop=0;const o=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies",i=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",n=u.filter(d=>e==="director"?R(d.director).includes(t):e==="writer"?R(d.writer).includes(t):e==="actor"?R(d.cast).includes(t):e==="company"?R(d.productionCompanies).includes(t):e==="year"?String(d.year)===t:!1).sort((d,g)=>g.total-d.total);if(n.length===0){ge();return}const s=Ye(o),a=s.findIndex(d=>d.name===t)+1,r=s.length,m=s.find(d=>d.name===t),p=m?m.avg.toFixed(1):(n.reduce((d,g)=>d+g.total,0)/n.length).toFixed(1);n[0];const l={};w.forEach(d=>{const g=s.filter(h=>h.catAvgs[d.key]!=null).sort((h,M)=>M.catAvgs[d.key]-h.catAvgs[d.key]),f=g.findIndex(h=>h.name===t)+1;l[d.key]=f>0?{rank:f,total:g.length}:null});const v=w.map(d=>{const g=n.filter(f=>f.scores[d.key]!=null).map(f=>f.scores[d.key]);return{...d,avg:g.length?parseFloat((g.reduce((f,h)=>f+h,0)/g.length).toFixed(1)):null}}).filter(d=>d.avg!=null).sort((d,g)=>g.avg-d.avg);v[0],v[v.length-1],document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:800px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 40px;margin-bottom:32px">
          ${v.map(d=>{const g=l[d.key];return`<div style="border-bottom:1px solid var(--rule);padding:10px 0">
              ...
              <div style="height:2px;background:var(--rule);border-radius:1px">
                <div style="height:2px;width:${d.avg}%;background:${Ve(d.avg)};border-radius:1px"></div>
              </div>
            </div>`}).join("")}
        </div>
      `:""}
      ...
      ${n.map((d,g)=>{const f=d.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${d.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',h=d.total!=null?(Math.round(d.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${u.indexOf(d)})" style="cursor:pointer">
          ...
          ${["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"].map(M=>`<div class="film-score ${d.scores[M]?W(d.scores[M]):"}"}">${d.scores[M]??"—"}</div>`).join("")}
          <div class="film-total">${h}</div>
        </div>`}).join("")}
    </div>
  `,Pt(e,t,n)}async function Pt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:n}=await S(async()=>{const{getEntityInsight:a}=await import("./insights-HZxE3pGO.js");return{getEntityInsight:a}},[]),s=await n(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
  ...
  `}const ke="f5a446a5f70a9f6a16a8ddd052c121f2",$e="https://api.themoviedb.org/3",Ot="https://ledger-proxy.noahparikhcott.workers.dev";let je=null,K=null,Me=null;function Je(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",K=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function qt(){clearTimeout(je),je=setTimeout(Ke,500)}async function Ke(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const n=((await(await fetch(`${$e}/search/movie?api_key=${ke}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!n.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const s=new Set(u.map(a=>a.title.toLowerCase()));t.innerHTML=n.map(a=>{const r=a.release_date?.slice(0,4)||"",m=a.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${a.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',p=s.has(a.title.toLowerCase());return`<div class="tmdb-result ${p?"opacity-50":""}" onclick="${p?"":`predictSelectFilm(${a.id}, '${a.title.replace(/'/g,"\\'")}', '${r}')`}" style="${p?"opacity:0.4;cursor:default":""}">
      ...
      </div>`}).join("")}catch{t.innerHTML='<div class="tmdb-error">Search failed — check connection.</div>'}}async function Rt(e,t,o){document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-search").value=t,document.getElementById("predict-result").innerHTML=`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const l=((await(await fetch(Ot,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:s,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),c=JSON.parse(l);Me=c,Ut(e,c,o)}catch(r){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${r.message}. Check that the proxy is running and your API key is valid.</div>`}}function Ut(e,t,o){let i=0,n=0;w.forEach(p=>{const l=t.predicted_scores[p.key];l!=null&&(i+=l*p.weight,n+=p.weight)});const s=n>0?Math.round(i/n*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,r={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",m={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-score-grid">
      ${w.map(p=>{const l=t.predicted_scores[p.key];return`<div class="predict-score-cell">
          ...
          <div class="predict-score-cell-val ${l?W(l):""}">${l??"—"}</div>
        </div>`}).join("")}
    </div>
  ...
  `}function Wt(){K&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=K.title,S(()=>Promise.resolve().then(()=>co),void 0).then(t=>{Me?.predicted_scores&&t.prefillWithPrediction(Me.predicted_scores),t.liveSearch(K.title)}))},100))}let ee="all",Qe="focused",H=[],_=0,E={},B={},ie=[];const Yt={focused:15,thorough:30,deep:50},Pe=8;function Vt(e){ee=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Gt(e){Qe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Jt(e,t){const o=[];(e==="all"?w.map(a=>a.key):[e]).forEach(a=>{const r=u.filter(m=>m.scores[a]!=null).sort((m,p)=>m.scores[a]-p.scores[a]);for(let m=0;m<r.length-1;m++)for(let p=m+1;p<r.length;p++){const l=Math.abs(r[m].scores[a]-r[p].scores[a]);if(l<=8)o.push({a:r[m],b:r[p],catKey:a,diff:l});else break}}),o.sort((a,r)=>a.diff-r.diff);const n=new Set,s=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");n.has(r)||(n.add(r),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Kt(){const e=Yt[Qe];if(H=Jt(ee,e),H.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}_=0,E={},B={},ie=[],u.forEach(t=>{B[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=ee==="all"?"All categories":w.find(t=>t.key===ee)?.label||ee,Ce()}function Ce(){if(_>=H.length){Qt();return}const{a:e,b:t,catKey:o}=H[_],i=H.length,n=Math.round(_/i*100);document.getElementById("cal-progress-label").textContent=`${_+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=w.find(m=>m.key===o)?.label||o;B[e.title]?.[o]??e.scores[o],B[t.title]?.[o]??t.scores[o];function a(m,p){const l=m.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${m.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
    ...
    <div style="text-align:center;margin-top:24px;display:flex;justify-content:center;align-items:center;gap:24px">
      ${_>0?`<span style="font-family:'DM Mono',monospace;font-size:11px;color:var(--dim);cursor:pointer;text-decoration:underline;text-underline-offset:2px" onclick="undoCalChoice()">← Undo</span>`:""}
  ...
  `}window.undoCalChoice=function(){if(ie.length===0)return;const e=ie.pop();_=e.idx,B=e.tempScores,E=e.deltas,Ce()};window.calChoose=function(e){if(ie.push({idx:_,tempScores:JSON.parse(JSON.stringify(B)),deltas:JSON.parse(JSON.stringify(E))}),e!=="skip"){const{a:t,b:o,catKey:i}=H[_],n=B[t.title]?.[i]??t.scores[i],s=B[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),r=1-a,m=e==="a"?1:0,p=1-m,l=Math.round(Math.min(100,Math.max(1,n+Pe*(m-a)))),c=Math.round(Math.min(100,Math.max(1,s+Pe*(p-r))));if(E[t.title]||(E[t.title]={}),E[o.title]||(E[o.title]={}),l!==n){const g=E[t.title][i]?.old??n;E[t.title][i]={old:g,new:l},B[t.title][i]=l}if(c!==s){const g=E[o.title][i]?.old??s;E[o.title][i]={old:g,new:c},B[o.title][i]=c}const v=document.getElementById(`cal-card-${e}`),d=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);v&&(v.style.opacity="1"),d&&(d.style.opacity="0.35",d.style.transform="scale(0.97)")}_++,setTimeout(()=>Ce(),e==="skip"?0:140)};function Qt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(E).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    `;else if(typeof x=="number"){const t=Zt[x],o=Math.round(x/6*100),i=x===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;line-height:1.8;color:var(--dim);margin-bottom:28px;font-style:italic">The films you're drawn to reveal something consistent about you — a set of values, sensitivities, and hungers that show up again and again. A few questions to surface them.</div>`:"";e.innerHTML=`
      ...
      ${t.options.map(n=>`
        <div class="ob-option ${Q[x]===n.key?"selected":""}" onclick="obSelectAnswer(${x}, '${n.key}', this)">
      ...
      <div class="ob-nav">
        ...
        <button class="ob-btn-primary" id="ob-next-btn" onclick="obNext()" ${Q[x]?"":"disabled"}>
          ${x===5?"See my archetype →":"Next →"}
        </button>
      </div>
    `}else if(x==="reveal"){const t=eo(Q);A=t,A._slug||(A._slug=de.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||"user");const o=X[t.primary],i=o.palette||"#3d5a80";e.innerHTML=`
  ...
  </div>`}function it(e){z[e]&&(z[e].checked=!z[e].checked);const t=document.getElementById("castItem_"+e),o=z[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function nt(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,te.slice(8,20).forEach(i=>{z[i.id]||(z[i.id]={actor:i,checked:!1})});const o=te.slice(0,20);ot(o),e.textContent="+ More cast",e.disabled=!1,te.length<=20&&(e.style.display="none")}function io(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
  ...
  </div>`}function st(e){F[e].checked=!F[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(F[e].checked?"checked":"unchecked")}function at(){ne=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function rt(){const e=y._allDirectors||[],t=y._allWriters||[],o=Object.values(z).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(F).filter(n=>n.checked).map(n=>n.company.name);y.title=y._tmdbDetail.title,y.director=e.join(", "),y.writer=t.join(", "),y.cast=o.join(", "),y.productionCompanies=i.join(", "),ao(),ce(2)}let ne=null;function no(e){ne=e}function so(e){const t=[...u].filter(s=>s.scores[e]!=null).sort((s,a)=>a.scores[e]-s.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),n=new Set;return i.filter(s=>n.has(s.title)?!1:(n.add(s.title),!0))}function ao(){const e=document.getElementById("calibrationCategories");e.innerHTML=w.map(t=>{const o=so(t.key),i=ne?.[t.key]??y.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
    ...
    </div>`}).join(""),w.forEach(t=>{y.scores[t.key]=ne?.[t.key]??y.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(s=>s.classList.remove("selected")),o.classList.add("selected");const i=y.scores[e]??50,n=Math.round((i+t)/2);document.getElementById("slider_"+e).value=n,updateSlider(e,n)};window.updateSlider=function(e,t){t=parseInt(t),y.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=U(t)};function lt(){ro(),ce(3)}let N=[],L=0,se=[];function ro(){N=[],se=[],w.forEach(e=>{const t=y.scores[e.key];if(!t)return;u.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,n)=>Math.abs(i.scores[e.key]-t)-Math.abs(n.scores[e.key]-t)).slice(0,1).forEach(i=>N.push({cat:e,film:i}))}),N=N.slice(0,6),L=0,xe()}function xe(){const e=document.getElementById("hthContainer");if(N.length===0||L>=N.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
      No close comparisons needed — your scores are clearly differentiated. Click Continue.
    </div>`;return}const{cat:t,film:o}=N[L],i=y.scores[t.key];e.innerHTML=`
  ...
  `}window.hthChoice=function(e,t,o){se.push({idx:L,scores:{...y.scores}});const i=y.scores[t];e==="new"&&i<=o?y.scores[t]=o+1:e==="existing"&&i>=o&&(y.scores[t]=o-1),L++,xe()};window.hthSkip=function(){se.push({idx:L,scores:{...y.scores}}),L++,xe()};window.hthUndo=function(){if(se.length===0)return;const e=se.pop();L=e.idx,y.scores=e.scores,xe()};function ct(){lo(),ce(4)}function lo(){const e=V(y.scores);y.total=e;const t=[...u,y].sort((i,n)=>n.total-i.total),o=t.indexOf(y)+1;document.getElementById("resultCard").innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
    ...
    <div class="result-grid">
      ${w.map(i=>`
        <div class="result-cat">
          ...
          <div class="result-cat-val ${W(y.scores[i.key]||0)}">${y.scores[i.key]||"—"}</div>
        </div>`).join("")}
    </div>
  ...
  `}function dt(){y.total=V(y.scores),u.push({title:y.title,year:y.year,total:y.total,director:y.director,writer:y.writer,cast:y.cast,productionCompanies:y.productionCompanies||"",poster:y._tmdbDetail?.poster_path||null,overview:y._tmdbDetail?.overview||"",scores:{...y.scores}}),Y(),S(()=>Promise.resolve().then(()=>Z),void 0).then(e=>e.updateStorageStatus()),y={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},z={},F={},te=[],ne=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",ce(1),P(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const co=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:rt,goToStep:Ze,goToStep3:lt,goToStep4:ct,liveSearch:et,prefillWithPrediction:no,resetToSearch:at,saveFilm:dt,showMoreCast:nt,tmdbSelect:tt,toggleCast:it,toggleCompany:st},Symbol.toStringTag,{value:"Module"}));function po(){if(!b){S(()=>Promise.resolve().then(()=>oo),void 0).then(e=>e.launchOnboarding());return}pt()}function pt(){if(!b)return;const e=b.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function mt(e,t){const o=w.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const s=document.getElementById("awbar_"+n.key);s&&(s.style.width=Math.round(n.val/i*100)+"%")})}function mo(){if(!b||!b.archetype)return;const e=X[b.archetype]?.weights;e&&(w.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),mt())}function fo(){const e={};w.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),b.weights=e,S(()=>Promise.resolve().then(()=>We),void 0).then(t=>t.saveUserLocally()),re(),P(),Y(),ft()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ft(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const I=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],yt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},yo={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function uo(e,t,o=220){const i=I.length,n=o/2,s=o/2,a=o*.36,r=k=>k/i*Math.PI*2-Math.PI/2,m=(k,D)=>({x:n+a*D*Math.cos(r(k)),y:s+a*D*Math.sin(r(k))}),p=[.25,.5,.75,1].map(k=>`<polygon points="${I.map(($,G)=>`${m(G,k).x},${m(G,k).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),l=I.map((k,D)=>{const $=m(D,1);return`<line x1="${n}" y1="${s}" x2="${$.x}" y2="${$.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),c=Math.max(...I.map(k=>e[k]||1)),d=`<polygon points="${I.map((k,D)=>{const $=m(D,(e[k]||1)/c);return`${$.x},${$.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let g="";if(t){const k=Math.max(...I.map($=>t[$]||1));g=`<polygon points="${I.map(($,G)=>{const Ae=m(G,(t[$]||1)/k);return`${Ae.x},${Ae.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const f=I.map((k,D)=>{const $=m(D,(e[k]||1)/c);return`<circle cx="${$.x}" cy="${$.y}" r="2.5" fill="var(--blue)"/>`}).join(""),h=22,M=I.map((k,D)=>{const $=m(D,1+h/a),G=$.x<n-5?"end":$.x>n+5?"start":"middle";return`<text x="${$.x}" y="${$.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${G}" dominant-baseline="middle">${yo[k]}</text>`}).join(""),q=36;return`<svg width="${o+q*2}" height="${o+q*2}" viewBox="${-q} ${-q} ${o+q*2} ${o+q*2}" style="overflow:visible;display:block">
    ${p}${l}${g}${d}${f}${M}
  </svg>`}function vo(e){return e.length?I.map(t=>{const o=e.filter(a=>a.scores?.[t]!=null),i=o.length?o.reduce((a,r)=>a+r.scores[t],0)/o.length:null,n=i!=null?i.toFixed(1):"—",s=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      ...
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:white;padding:4px 11px 3px;background:${go(o.total)};border-radius:4px;flex-shrink:0">${s}</div>
      </div>
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function xo(e,t){const o=[...t].sort((s,a)=>a.total-s.total).slice(0,3),i=t.length?(t.reduce((s,a)=>s+a.total,0)/t.length).toFixed(1):"—",n=X[e.archetype]||{};return`
  ...
  `}function Be(){const e=document.getElementById("profileContent");if(!e)return;const t=b;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=X[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=u,a=I.map(p=>{const l=s.filter(c=>c.scores?.[p]!=null);return{c:p,avg:l.length?l.reduce((c,v)=>c+v.scores[p],0)/l.length:0}}),r=s.length?[...a].sort((p,l)=>l.avg-p.avg)[0]:null,m=s.length?(s.reduce((p,l)=>p+l.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin-top:24px;border-top:2px solid var(--ink)">
          ...
          ${r?`<div style="padding:16px 0 16px 20px">
            ...
            <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:32px;color:var(--blue);line-height:1;letter-spacing:-1px">${yt[r.c]}</div>
          </div>`:""}
        </div>`:""}
      </div>
  ...
  </span>`}function vt(){const e=new Blob([JSON.stringify(u,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download="film_rankings.json",t.click()}function gt(){confirm("Clear all your films and start fresh? This cannot be undone.")&&(localStorage.removeItem("filmRankings_v1"),localStorage.removeItem("ledger_user"),location.reload())}function ht(){const e=document.getElementById("cold-landing");e?e.style.display="flex":he()}window.startFromLanding=function(){const e=document.getElementById("cold-landing");e&&(e.style.display="none"),he()};async function bo(){It(),Ue(),b?(oe("syncing"),Te(),re(),Fe(b.id).catch(()=>oe("error"))):(oe("local"),setTimeout(()=>ht(),400)),P(),ze();const e=localStorage.getItem("ledger_last_screen");if(e&&e!=="rankings"&&document.getElementById(e)){const t=document.querySelectorAll(".nav-btn");t.forEach(o=>o.classList.remove("active")),document.querySelectorAll(".screen").forEach(o=>o.classList.remove("active")),document.getElementById(e).classList.add("active"),t.forEach(o=>{o.getAttribute("onclick")?.includes(e)&&o.classList.add("active")}),e==="analysis"&&Ge(),e==="explore"&&ge(),e==="profile"&&Be()}}function oe(e){const t=document.getElementById("cloudDot"),o=document.getElementById("cloudLabel");t.className="cloud-dot",e==="syncing"?(t.classList.add("syncing"),o.textContent="syncing…"):e==="synced"?(t.classList.add("synced"),o.textContent=b?b.display_name:"synced"):e==="error"?(t.classList.add("error"),o.textContent="offline"):o.textContent="local"}window.__ledger={showScreen:ut,sortBy:Re,openModal:zt,closeModal:At,exploreEntity:jt,renderExploreIndex:ge,initPredict:Je,predictSearch:Ke,predictSearchDebounce:qt,predictSelectFilm:Rt,predictAddToList:Wt,startCalibration:Kt,selectCalCat:Vt,selectCalInt:Gt,applyCalibration:Xt,resetCalibration:_e,launchOnboarding:he,liveSearch:et,tmdbSelect:tt,toggleCast:it,showMoreCast:nt,toggleCompany:st,resetToSearch:at,confirmTmdbData:rt,goToStep3:lt,goToStep4:ct,saveFilm:dt,goToStep:Ze,renderProfile:Be,setViewMode:qe,showSyncPanel:po,openArchetypeModal:pt,closeArchetypeModal:ft,previewWeight:mt,resetArchetypeWeights:mo,saveArchetypeWeights:fo,exportData:vt,resetStorage:gt,updateStorageStatus:ze,updateMastheadProfile:Te,setCloudStatus:oe};const wo=["showScreen","sortBy","openModal","closeModal","exploreEntity","renderExploreIndex","initPredict","predictSearch","predictSearchDebounce","predictSelectFilm","predictAddToList","startCalibration","selectCalCat","selectCalInt","applyCalibration","resetCalibration","launchOnboarding","liveSearch","tmdbSelect","toggleCast","showMoreCast","toggleCompany","resetToSearch","confirmTmdbData","goToStep3","goToStep4","saveFilm","goToStep","renderProfile","setViewMode","showSyncPanel","openArchetypeModal","closeArchetypeModal","previewWeight","resetArchetypeWeights","saveArchetypeWeights","exportData","resetStorage"];wo.forEach(e=>{window[e]=window.__ledger[e]});bo();const Z=Object.freeze(Object.defineProperty({__proto__:null,exportData:vt,resetStorage:gt,setCloudStatus:oe,showColdLanding:ht,showScreen:ut,updateMastheadProfile:Te,updateStorageStatus:ze},Symbol.toStringTag,{value:"Module"}));export{w as C,u as M,b as c};
