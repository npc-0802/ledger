...
async function _applyUserData(data) {
  ...
  setCurrentUser({
    ...
    // Quiz v2 fields: prefer Supabase data, fall back to local state (columns may not exist yet)
    quiz_weights: data.quiz_weights || prev.quiz_weights || null,
    quiz_answers: data.quiz_answers || prev.quiz_answers || null,
    archetype_key: data.archetype_key || prev.archetype_key || null,
